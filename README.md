...
------------ | ------------- | ------------- | -------------
*AWSS3Api* | [**getSignedS3URL**](docs/AWSS3Api.md#getSignedS3URL) | **GET** /amazon/s3/signedposturl | Get a signed S3 URL
...
*GamificationTriviaApi* | [**getQuestionTags1**](docs/GamificationTriviaApi.md#getQuestionTags1) | **GET** /trivia/tags | List and search tags by the beginning of the string
...
*InvoicesApi* | [**listFulFillmentStatuses**](docs/InvoicesApi.md#listFulFillmentStatuses) | **GET** /invoices/fulfillment-statuses | Lists available fulfillment statuses
*InvoicesApi* | [**listPaymentStatuses**](docs/InvoicesApi.md#listPaymentStatuses) | **GET** /invoices/payment-statuses | Lists available payment statuses
...
*LocationsApi* | [**getCities**](docs/LocationsApi.md#getCities) | **GET** /location/countries/{country_code_iso3}/states/{state_code}/cities | Get a list of a state&#39;s cities
*LocationsApi* | [**getCountries1**](docs/LocationsApi.md#getCountries1) | **GET** /location/countries | Get a list of countries
*LocationsApi* | [**getCountries2**](docs/LocationsApi.md#getCountries2) | **GET** /location/countries/{country_code_iso3}/states | Get a list of a country&#39;s states
...
*StoreShoppingCartsApi* | [**getCountries**](docs/StoreShoppingCartsApi.md#getCountries) | **GET** /carts/{id}/countries | Get the list of available shipping countries per vendor
...
*UsersInventoryApi* | [**getUserInventory1**](docs/UsersInventoryApi.md#getUserInventory1) | **GET** /users/{id}/inventory | List the user inventory entries for a given user
...
*UsersInventoryApi* | [**getUserInventoryLog1**](docs/UsersInventoryApi.md#getUserInventoryLog1) | **PUT** /users/{user_id}/inventory/{id}/expires | Set the expiration date
...
*UtilMaintenanceApi* | [**updateMaintenance**](docs/UtilMaintenanceApi.md#updateMaintenance) | **POST** /maintenance | Set current maintenance info
*UtilMaintenanceApi* | [**updateMaintenance1**](docs/UtilMaintenanceApi.md#updateMaintenance1) | **PUT** /maintenance | Set current maintenance info
