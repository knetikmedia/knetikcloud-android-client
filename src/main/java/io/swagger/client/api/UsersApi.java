...
public class UsersApi {
  ...
  * 
   ...
   * @return void
  */
  public void updateUserTemplate (String id, TemplateResource userTemplateResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = userTemplateResource;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateUserTemplate (String id, TemplateResource userTemplateResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = userTemplateResource;
