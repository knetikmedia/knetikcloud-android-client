...
public class ReportingRevenueApi {
  ...
  */
  public PageResourceRevenueCountryReportResource executiveRevenueCountrySalesUsingGET (String currencyCode, Long startDate, Long endDate, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void executiveRevenueCountrySalesUsingGET (String currencyCode, Long startDate, Long endDate, Integer size, Integer page, final Response.Listener<PageResourceRevenueCountryReportResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public PageResourceRevenueProductReportResource executiveRevenueProductSalesUsingGET (String currencyCode, Long startDate, Long endDate, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'currencyCode' is set
    if (currencyCode == null) {
   ...
   * @param currencyCode The code for a currency to get sales data for   * @param startDate The start of the time range to aggregate, unix timestamp in seconds. Default is beginning of time   * @param endDate The end of the time range to aggregate, unix timestamp in seconds. Default is end of time   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1
  */
  public void executiveRevenueProductSalesUsingGET (String currencyCode, Long startDate, Long endDate, Integer size, Integer page, final Response.Listener<PageResourceRevenueProductReportResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
