...
public class DevicesApi {
  ...
  * 
   ...
   * @return void
  */
  public void updateDevice (DeviceResource device, Integer id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = device;
    // verify the required parameter 'device' is set
    if (device == null) {
  ...
  */
  public void updateDevice (DeviceResource device, Integer id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = device;
