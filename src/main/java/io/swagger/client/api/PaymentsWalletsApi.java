...
public class PaymentsWalletsApi {
  ...
  */
  public PageWalletTotalResponse getWalletTotalsUsingGET () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (PageWalletTotalResponse) ApiInvoker.deserialize(localVarResponse, "", PageWalletTotalResponse.class);
      } else {
         return null;
      }
  ...
  */
  public void getWalletTotalsUsingGET (final Response.Listener<PageWalletTotalResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageWalletTotalResponse) ApiInvoker.deserialize(localVarResponse,  "", PageWalletTotalResponse.class));
  ...
  */
  public PageSimpleWallet getWalletsUsingGET1 (Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PageSimpleWallet) ApiInvoker.deserialize(localVarResponse, "", PageSimpleWallet.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void getWalletsUsingGET1 (Integer size, Integer page, String order, final Response.Listener<PageSimpleWallet> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageSimpleWallet) ApiInvoker.deserialize(localVarResponse,  "", PageSimpleWallet.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public PageWalletTransactionResource transactionHistoryUsingGET (Integer filterInvoice, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PageWalletTransactionResource) ApiInvoker.deserialize(localVarResponse, "", PageWalletTransactionResource.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void transactionHistoryUsingGET (Integer filterInvoice, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order, final Response.Listener<PageWalletTransactionResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageWalletTransactionResource) ApiInvoker.deserialize(localVarResponse,  "", PageWalletTransactionResource.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * 
   ...
   * @return PageWalletTransactionResource
  */
  public PageWalletTransactionResource userTransactionHistoryUsingGET (Integer userId, String currencyCode, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'userId' is set
    if (userId == null) {
  ...
  */
  public void userTransactionHistoryUsingGET (Integer userId, String currencyCode, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer size, Integer page, String order, final Response.Listener<PageWalletTransactionResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
