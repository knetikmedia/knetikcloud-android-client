...
public class UsersInventoryApi {
  ...
  */
  public EntitlementItem createEntitlementItem (EntitlementItem entitlementItem) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param entitlementItem The entitlement item object
  */
  public void createEntitlementItem (EntitlementItem entitlementItem, final Response.Listener<EntitlementItem> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = entitlementItem;
  ...
  */
  public PageResourceUserInventoryResource getUserInventory1 (Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getUserInventory1",
        new ApiException(400, "Missing the required parameter 'id' when calling getUserInventory1"));
    }
  ...
  */
  public void getUserInventory1 (Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, final Response.Listener<PageResourceUserInventoryResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Will change the current grace period for a subscription but not the bill date (possibly even ending before having the chance to re-bill)
   ...
   * @return void
  */
  public void getUserInventoryLog1 (Integer userId, Integer id, Long timestamp) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = timestamp;
    // verify the required parameter 'userId' is set
    if (userId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'userId' when calling getUserInventoryLog1",
        new ApiException(400, "Missing the required parameter 'userId' when calling getUserInventoryLog1"));
    }
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getUserInventoryLog1",
        new ApiException(400, "Missing the required parameter 'id' when calling getUserInventoryLog1"));
    }
  ...
  */
  public void getUserInventoryLog1 (Integer userId, Integer id, Long timestamp, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = timestamp;
  ...
  * 
   ...
   * @return PageResourceUserInventoryResource
  */
  public PageResourceUserInventoryResource getUsersInventory (Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getUsersInventory (Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate, final Response.Listener<PageResourceUserInventoryResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return void
  */
  public void updateEntitlementItem (Integer entitlementId, EntitlementItem entitlementItem) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = entitlementItem;
    // verify the required parameter 'entitlementId' is set
    if (entitlementId == null) {
  ...
  */
  public void updateEntitlementItem (Integer entitlementId, EntitlementItem entitlementItem, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = entitlementItem;
  ...
  * 
   ...
   * @return void
  */
  public void updateEntitlementTemplate (String id, ItemTemplateResource template) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = template;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateEntitlementTemplate (String id, ItemTemplateResource template, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = template;
