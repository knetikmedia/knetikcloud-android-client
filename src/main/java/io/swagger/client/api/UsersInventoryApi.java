...
public class UsersInventoryApi {
  ...
  */
  public PageResourceEntitlementItem getCurrenciesUsingGET1 (Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getCurrenciesUsingGET1 (Integer size, Integer page, String order, final Response.Listener<PageResourceEntitlementItem> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public PageResourceItemTemplateResource getEntitlementTemplatesUsingGET (Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
   ...
   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1   * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
  */
  public void getEntitlementTemplatesUsingGET (Integer size, Integer page, String order, final Response.Listener<PageResourceItemTemplateResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public PageResourceUserInventoryResource getInventoryListUsingGET (Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getInventoryListUsingGET (Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate, final Response.Listener<PageResourceUserInventoryResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return PageResourceUserInventoryResource
  */
  public PageResourceUserInventoryResource getUserInventoryListUsingGET (Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void getUserInventoryListUsingGET (Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, final Response.Listener<PageResourceUserInventoryResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public PageResourceUserItemLogResource getUserInventoryLogUsingGET (String userId, Integer id, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'userId' is set
    if (userId == null) {
  ...
  */
  public void getUserInventoryLogUsingGET (String userId, Integer id, Integer size, Integer page, final Response.Listener<PageResourceUserItemLogResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return void
  */
  public void grantEntitlementUsingPOST (Integer userId, EntitlementGrantRequest grantRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = grantRequest;
    // verify the required parameter 'userId' is set
    if (userId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'userId' when calling grantEntitlementUsingPOST",
        new ApiException(400, "Missing the required parameter 'userId' when calling grantEntitlementUsingPOST"));
    }
    // verify the required parameter 'grantRequest' is set
    if (grantRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'grantRequest' when calling grantEntitlementUsingPOST",
        new ApiException(400, "Missing the required parameter 'grantRequest' when calling grantEntitlementUsingPOST"));
    }
  ...
  */
  public void grantEntitlementUsingPOST (Integer userId, EntitlementGrantRequest grantRequest, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = grantRequest;
