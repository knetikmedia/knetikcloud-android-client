...
public class UsersInventoryApi {
  ...
  */
  public PageResourceUserInventoryResource getUserInventories (Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void getUserInventories (Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, final Response.Listener<PageResourceUserInventoryResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
