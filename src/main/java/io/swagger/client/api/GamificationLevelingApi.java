...
public class GamificationLevelingApi {
  ...
  * 
   ...
   * @return void
  */
  public void updateLevel (String name, LevelingResource newLevel) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void updateLevel (String name, LevelingResource newLevel, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = newLevel;
