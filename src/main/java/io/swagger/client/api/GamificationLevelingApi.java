...
public class GamificationLevelingApi {
  ...
  * If no progress record yet exists for the user, it will be created. Otherwise it will be updated. If progress meets or exceeds the level&#39;s max_value it will be marked as earned and a BRE event will be triggered for the &lt;code&gt;BreAchievementEarnedTrigger&lt;/code&gt;.
   ...
   * @return void
  */
  public void updateUserLevel (Integer userId, String name, Integer progress) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = progress;
    // verify the required parameter 'userId' is set
    if (userId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'userId' when calling updateUserLevel",
        new ApiException(400, "Missing the required parameter 'userId' when calling updateUserLevel"));
    }
    // verify the required parameter 'name' is set
    if (name == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'name' when calling updateUserLevel",
        new ApiException(400, "Missing the required parameter 'name' when calling updateUserLevel"));
    }
  ...
  */
  public void updateUserLevel (Integer userId, String name, Integer progress, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = progress;
