...
public class CampaignsChallengesApi {
  ...
  * 
   ...
   * @return void
  */
  public void updateChallengeActivity (Long activityId, Long challengeId, ChallengeActivityResource challengeActivityResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = challengeActivityResource;
    // verify the required parameter 'activityId' is set
    if (activityId == null) {
  ...
  */
  public void updateChallengeActivity (Long activityId, Long challengeId, ChallengeActivityResource challengeActivityResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = challengeActivityResource;
  ...
  * 
   ...
   * @return void
  */
  public void updateChallengeTemplate (String id, TemplateResource challengeTemplateResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = challengeTemplateResource;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateChallengeTemplate (String id, TemplateResource challengeTemplateResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = challengeTemplateResource;
