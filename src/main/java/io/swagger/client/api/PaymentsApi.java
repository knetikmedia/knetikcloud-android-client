...
public class PaymentsApi {
  ...
  * 
   ...
   * @return void
  */
  public void updatePaymentMethod (Integer userId, Integer id, PaymentMethodResource paymentMethod) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = paymentMethod;
    // verify the required parameter 'userId' is set
    if (userId == null) {
  ...
  */
  public void updatePaymentMethod (Integer userId, Integer id, PaymentMethodResource paymentMethod, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = paymentMethod;
