...
public class MediaModerationApi {
  ...
  * 
   ...
   * @return void
  */
  public void getModerationReport (Long id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param id The flag report id
  */
  public void getModerationReport (Long id, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
