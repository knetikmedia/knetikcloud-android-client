...
public class StoreBundlesApi {
  ...
  * The SKU for the bundle itself must be unique and there can only be one SKU.  Extra notes for price_override:  The price of all the items (multiplied by the quantity) must equal the price of the bundle.  With individual prices set, items will be processed individually and can be refunded as such.  However, if all prices are set to null, the price of the bundle will be used and will be treated as one item.
   ...
   * @return BundleItem
  */
  public BundleItem createBundleItem (BundleItem bundleItem) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param bundleItem The bundle item object
  */
  public void createBundleItem (BundleItem bundleItem, final Response.Listener<BundleItem> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = bundleItem;
  ...
  * 
   ...
   * @return void
  */
  public void updateBundleItem (Integer id, BundleItem bundleItem) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = bundleItem;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateBundleItem (Integer id, BundleItem bundleItem, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = bundleItem;
  ...
  * 
   ...
   * @return void
  */
  public void updateBundleTemplate (String id, ItemTemplateResource bundleTemplateResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = bundleTemplateResource;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateBundleTemplate (String id, ItemTemplateResource bundleTemplateResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = bundleTemplateResource;
