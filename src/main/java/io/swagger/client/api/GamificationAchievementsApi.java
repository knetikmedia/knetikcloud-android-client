...
public class GamificationAchievementsApi {
  ...
  */
  public PageResourceUserAchievementGroupResource getUserAchievementsProgress (Integer userId, Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'userId' is set
    if (userId == null) {
  ...
  */
  public void getUserAchievementsProgress (Integer userId, Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, final Response.Listener<PageResourceUserAchievementGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Assets will not be filled in on the resources returned. Use &#39;Get single achievement progress for user&#39; to retrieve the full resource with assets for a given user as needed.
   ...
   * @return PageResourceUserAchievementGroupResource
  */
  public PageResourceUserAchievementGroupResource getUsersAchievementProgress (String achievementName, Boolean filterAchievementDerived, String filterAchievementTagset, Boolean filterAchievementHidden, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'achievementName' is set
    if (achievementName == null) {
  ...
  */
  public void getUsersAchievementProgress (String achievementName, Boolean filterAchievementDerived, String filterAchievementTagset, Boolean filterAchievementHidden, Integer size, Integer page, final Response.Listener<PageResourceUserAchievementGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Assets will not be filled in on the resources returned. Use &#39;Get single achievement progress for user&#39; to retrieve the full resource with assets for a given user as needed.
   ...
   * @return PageResourceUserAchievementGroupResource
  */
  public PageResourceUserAchievementGroupResource getUsersAchievementsProgress (Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getUsersAchievementsProgress (Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, final Response.Listener<PageResourceUserAchievementGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * The existing generated rule, if any, will be deleted. A new rule will be created if a trigger event name is specified in the new version.
   ...
   * @return void
  */
  public void updateAchievement (String name, AchievementDefinitionResource achievement) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = achievement;
    // verify the required parameter 'name' is set
    if (name == null) {
  ...
  */
  public void updateAchievement (String name, AchievementDefinitionResource achievement, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = achievement;
  ...
  * If no progress record yet exists for the user, it will be created. Otherwise it will be updated. If progress meets or exceeds the achievement&#39;s max_value it will be marked as earned and a BRE event will be triggered for the &lt;code&gt;BreAchievementEarnedTrigger&lt;/code&gt;.
   ...
   * @return UserAchievementGroupResource
  */
  public UserAchievementGroupResource updateAchievementProgress (Integer userId, String achievementName, AchievementProgressUpdateRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = request;
    // verify the required parameter 'userId' is set
    if (userId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'userId' when calling updateAchievementProgress",
        new ApiException(400, "Missing the required parameter 'userId' when calling updateAchievementProgress"));
    }
    // verify the required parameter 'achievementName' is set
    if (achievementName == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'achievementName' when calling updateAchievementProgress",
        new ApiException(400, "Missing the required parameter 'achievementName' when calling updateAchievementProgress"));
    }
  ...
  */
  public void updateAchievementProgress (Integer userId, String achievementName, AchievementProgressUpdateRequest request, final Response.Listener<UserAchievementGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
  ...
  * 
   ...
   * @return void
  */
  public void updateAchievementTemplate (String id, TemplateResource template) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = template;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateAchievementTemplate (String id, TemplateResource template, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = template;
