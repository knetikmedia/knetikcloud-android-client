...
public class GamificationAchievementsApi {
  ...
  */
  public PageTemplateResource getAchievementTemplatesUsingGET (Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getAchievementTemplatesUsingGET (Integer size, Integer page, String order, final Response.Listener<PageTemplateResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public PageAchievementDefinitionResource getAchievementsUsingGET (String filterTagset, String filterName, Boolean filterHidden, Boolean filterDerived, Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PageAchievementDefinitionResource) ApiInvoker.deserialize(localVarResponse, "", PageAchievementDefinitionResource.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void getAchievementsUsingGET (String filterTagset, String filterName, Boolean filterHidden, Boolean filterDerived, Integer size, Integer page, String order, final Response.Listener<PageAchievementDefinitionResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageAchievementDefinitionResource) ApiInvoker.deserialize(localVarResponse,  "", PageAchievementDefinitionResource.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public PageUserAchievementGroupResource getAllUserProgressForAchievementUsingGET (String achievementName, Boolean filterAchievementDerived, String filterAchievementTagset, Boolean filterAchievementHidden, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PageUserAchievementGroupResource) ApiInvoker.deserialize(localVarResponse, "", PageUserAchievementGroupResource.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void getAllUserProgressForAchievementUsingGET (String achievementName, Boolean filterAchievementDerived, String filterAchievementTagset, Boolean filterAchievementHidden, Integer size, Integer page, final Response.Listener<PageUserAchievementGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageUserAchievementGroupResource) ApiInvoker.deserialize(localVarResponse,  "", PageUserAchievementGroupResource.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Assets will not be filled in on the resources returned. Use &#39;Get single achievement progress for user&#39; to retrieve the full resource with assets for a given user as needed.
   ...
   * @return PageUserAchievementGroupResource
  */
  public PageUserAchievementGroupResource getAllUserProgressUsingGET (Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getAllUserProgressUsingGET (Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, final Response.Listener<PageUserAchievementGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Assets will not be filled in on the resources returned. Use &#39;Get a single poll&#39; to retrieve the full resource with assets for a given item as needed.
   ...
   * @return PageUserAchievementGroupResource
  */
  public PageUserAchievementGroupResource getUserProgressUsingGET (Integer userId, Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'userId' is set
    if (userId == null) {
  ...
  */
  public void getUserProgressUsingGET (Integer userId, Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, final Response.Listener<PageUserAchievementGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
