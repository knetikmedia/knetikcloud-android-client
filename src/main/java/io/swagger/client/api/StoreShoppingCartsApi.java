...
public class StoreShoppingCartsApi {
  ...
  */
  public SampleCountriesResponse getCountries (String id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getCountries",
        new ApiException(400, "Missing the required parameter 'id' when calling getCountries"));
    }
   ...
   * @param id The id of the cart
  */
  public void getCountries (String id, final Response.Listener<SampleCountriesResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
