...
public class PaymentsStripeApi {
  ...
  */
  public PaymentMethodResource createCustomerUsingPOST (StripeCreatePaymentMethod request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param request The request to create a Stripe customer with payment info
  */
  public void createCustomerUsingPOST (StripeCreatePaymentMethod request, final Response.Listener<PaymentMethodResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
