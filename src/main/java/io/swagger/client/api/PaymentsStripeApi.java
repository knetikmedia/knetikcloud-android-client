...
public class PaymentsStripeApi {
  ...
  */
  public PaymentMethodResource createCustomerUsingPOST1 (StripeCreatePaymentMethod request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param request The request to create a Stripe customer with payment info
  */
  public void createCustomerUsingPOST1 (StripeCreatePaymentMethod request, final Response.Listener<PaymentMethodResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
  ...
  * 
   ...
   * @return void
  */
  public void payInvoiceUsingPOST1 (StripePaymentRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = request;
   ...
   * @param request The request to pay an invoice
  */
  public void payInvoiceUsingPOST1 (StripePaymentRequest request, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
