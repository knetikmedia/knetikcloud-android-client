...
public class AuthClientsApi {
  ...
  * 
   ...
   * @return void
  */
  public void updateClient (String clientKey, ClientResource clientResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = clientResource;
    // verify the required parameter 'clientKey' is set
    if (clientKey == null) {
  ...
  */
  public void updateClient (String clientKey, ClientResource clientResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = clientResource;
