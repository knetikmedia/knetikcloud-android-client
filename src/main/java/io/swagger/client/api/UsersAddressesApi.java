...
public class UsersAddressesApi {
  ...
  * 
   ...
   * @return void
  */
  public void updateAddress (String userId, Integer id, SavedAddressResource savedAddressResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = savedAddressResource;
    // verify the required parameter 'userId' is set
    if (userId == null) {
  ...
  */
  public void updateAddress (String userId, Integer id, SavedAddressResource savedAddressResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = savedAddressResource;
