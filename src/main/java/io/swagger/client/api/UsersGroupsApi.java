...
public class UsersGroupsApi {
  ...
  * 
   ...
   * @return void
  */
  public void updateGroupTemplate (String id, TemplateResource groupTemplateResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = groupTemplateResource;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateGroupTemplate (String id, TemplateResource groupTemplateResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = groupTemplateResource;
  ...
  */
  public PageResourceGroupResource updateGroups (Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
   ...
   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1   * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
  */
  public void updateGroups (Integer size, Integer page, String order, final Response.Listener<PageResourceGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
