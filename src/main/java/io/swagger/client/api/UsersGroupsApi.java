...
public class UsersGroupsApi {
  ...
  */
  public PageResourceGroupResource updateGroups (String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
   ...
   * List and search groups
   * 
   * @param filterName Filter for groups whose name starts with provided string   * @param filterUniqueName Filter for groups whose unique_name starts with provided string   * @param filterParent Filter for groups whose parent equals provided string   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1   * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
  */
  public void updateGroups (String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order, final Response.Listener<PageResourceGroupResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
