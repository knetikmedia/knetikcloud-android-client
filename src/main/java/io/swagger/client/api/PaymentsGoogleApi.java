...
public class PaymentsGoogleApi {
  ...
  * Mark an invoice paid with Google. Verifies signature from Google and treats the developerPayload field inside the json payload as the id of the invoice to pay. Returns the transaction ID if successful.
   ...
   * @return Integer
  */
  public Integer handlePaymentUsingPOST (GooglePaymentRequest request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param request The request for paying an invoice through a Google in-app payment
  */
  public void handlePaymentUsingPOST (GooglePaymentRequest request, final Response.Listener<Integer> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = request;
