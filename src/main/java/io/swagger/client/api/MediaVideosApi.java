...
public class MediaVideosApi {
  ...
  * 
   ...
   * @return void
  */
  public void addVideoFlag (Long videoId, String reason) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void addVideoFlag (Long videoId, String reason, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = reason;
