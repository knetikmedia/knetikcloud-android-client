...
public class MediaVideosApi {
  ...
  */
  public PageCommentResource getCommentsUsingGET1 (Integer videoId, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'videoId' is set
    if (videoId == null) {
  ...
  */
  public void getCommentsUsingGET1 (Integer videoId, Integer size, Integer page, final Response.Listener<PageCommentResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public PageDispositionResource getDispositionsUsingGET1 (Integer videoId, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'videoId' is set
    if (videoId == null) {
   ...
   * @param videoId The video id   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1
  */
  public void getDispositionsUsingGET1 (Integer videoId, Integer size, Integer page, final Response.Listener<PageDispositionResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public PageVideoRelationshipResource getRelatedUsingGET (Long videoId, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'videoId' is set
    if (videoId == null) {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PageVideoRelationshipResource) ApiInvoker.deserialize(localVarResponse, "", PageVideoRelationshipResource.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param videoId The video id   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1
  */
  public void getRelatedUsingGET (Long videoId, Integer size, Integer page, final Response.Listener<PageVideoRelationshipResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageVideoRelationshipResource) ApiInvoker.deserialize(localVarResponse,  "", PageVideoRelationshipResource.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public PageVideoResource getUserVideosUsingGET (Integer userId, Boolean excludeFlagged, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PageVideoResource) ApiInvoker.deserialize(localVarResponse, "", PageVideoResource.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void getUserVideosUsingGET (Integer userId, Boolean excludeFlagged, Integer size, Integer page, final Response.Listener<PageVideoResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageVideoResource) ApiInvoker.deserialize(localVarResponse,  "", PageVideoResource.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public void searchVideosUsingGET (Boolean excludeFlagged, String filterVideosByUploader, String filterCategory, String filterTagset, String filterVideosByName, String filterVideosByContributor, String filterVideosByAuthor, Boolean filterHasAuthor, Boolean filterHasUploader, String filterRelatedTo, Boolean filterFriends, String filterDisposition, Integer size, Integer page, String order, final Response.Listener<PageVideoResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
