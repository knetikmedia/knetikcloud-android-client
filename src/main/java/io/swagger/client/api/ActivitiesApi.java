...
public class ActivitiesApi {
  ...
  */
  public PageResourceBareActivityResource getActivities (Boolean filterTemplate, Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getActivities (Boolean filterTemplate, Integer size, Integer page, String order, final Response.Listener<PageResourceBareActivityResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return void
  */
  public void updateActivity (Long id, ActivityResource activityResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = activityResource;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateActivity (Long id, ActivityResource activityResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = activityResource;
