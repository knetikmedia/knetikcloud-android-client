...
public class StoreSalesApi {
  ...
  */
  public PageCatalogSale getCatalogSalesUsingGET (Integer size, Integer page, String order) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (PageCatalogSale) ApiInvoker.deserialize(localVarResponse, "", PageCatalogSale.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void getCatalogSalesUsingGET (Integer size, Integer page, String order, final Response.Listener<PageCatalogSale> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PageCatalogSale) ApiInvoker.deserialize(localVarResponse,  "", PageCatalogSale.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
