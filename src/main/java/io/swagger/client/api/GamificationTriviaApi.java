...
public class GamificationTriviaApi {
  ...
  */
  public Collectionstring getQuestionTags1 (String filterSearch, String filterCategory, Long filterImportId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getQuestionTags1 (String filterSearch, String filterCategory, Long filterImportId, final Response.Listener<Collectionstring> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return void
  */
  public void updateQuestionTemplate (String id, QuestionTemplateResource questionTemplateResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = questionTemplateResource;
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  */
  public void updateQuestionTemplate (String id, QuestionTemplateResource questionTemplateResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = questionTemplateResource;
