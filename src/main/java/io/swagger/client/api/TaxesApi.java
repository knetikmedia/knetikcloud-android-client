...
public class TaxesApi {
  ...
  * 
   ...
   * @return void
  */
  public void createCountryTax (CountryTaxResource taxResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param taxResource The tax object
  */
  public void createCountryTax (CountryTaxResource taxResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = taxResource;
  ...
  * 
   ...
   * @return void
  */
  public void createStateTax (String countryCodeIso3, StateTaxResource taxResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = taxResource;
  ...
  */
  public void createStateTax (String countryCodeIso3, StateTaxResource taxResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = taxResource;
  ...
  * 
   ...
   * @return void
  */
  public void updateCountryTax (String countryCodeIso3, CountryTaxResource taxResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = taxResource;
    // verify the required parameter 'countryCodeIso3' is set
    if (countryCodeIso3 == null) {
   ...
   * @param countryCodeIso3 The iso3 code of the country   * @param taxResource The tax object
  */
  public void updateCountryTax (String countryCodeIso3, CountryTaxResource taxResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = taxResource;
  ...
  * 
   ...
   * @return void
  */
  public void updateStateTax (String countryCodeIso3, String stateCode, StateTaxResource taxResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = taxResource;
    // verify the required parameter 'countryCodeIso3' is set
    if (countryCodeIso3 == null) {
  ...
  */
  public void updateStateTax (String countryCodeIso3, String stateCode, StateTaxResource taxResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = taxResource;
