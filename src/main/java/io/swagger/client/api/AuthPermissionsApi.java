...
public class AuthPermissionsApi {
  ...
  * 
   ...
   * @return void
  */
  public void updatePermission (String permission, PermissionResource permissionResource) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = permissionResource;
    // verify the required parameter 'permission' is set
    if (permission == null) {
  ...
  */
  public void updatePermission (String permission, PermissionResource permissionResource, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = permissionResource;
