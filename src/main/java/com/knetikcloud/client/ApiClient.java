...
import com.knetikcloud.client.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("OAuth2".equals(authName)) {
        auth = new OAuth(OAuthFlow.implicit, "/oauth/token", "", "global");
      } else {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://sandbox.knetikcloud.com";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
