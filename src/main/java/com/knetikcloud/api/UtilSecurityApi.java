...
public class UtilSecurityApi {
     ...
     */
    public com.squareup.okhttp.Call getUserLocationLogCall(Integer userId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getUserLocationLogValidateBeforeCall(Integer userId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getUserLocationLogCall(userId, size, page, order, progressListener, progressRequestListener);
        return call;
    ...
    public PageResourceLocationLogResource getUserLocationLog(Integer userId, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceLocationLogResource> resp = getUserLocationLogWithHttpInfo(userId, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceLocationLogResource> getUserLocationLogWithHttpInfo(Integer userId, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getUserLocationLogValidateBeforeCall(userId, size, page, order, null, null);
     ...
     */
    public com.squareup.okhttp.Call getUserLocationLogAsync(Integer userId, Integer size, Integer page, String order, final ApiCallback<PageResourceLocationLogResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserLocationLogValidateBeforeCall(userId, size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceLocationLogResource>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getUserTokenDetailsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
