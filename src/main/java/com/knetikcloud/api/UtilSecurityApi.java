...
public class UtilSecurityApi {
    ...
    private com.squareup.okhttp.Call getUserLocationLogCall(Integer userId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
