...
public class UtilBatchApi {
     ...
     */
    public com.squareup.okhttp.Call getBatchCall(String token, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getBatchValidateBeforeCall(String token, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBatchCall(token, progressListener, progressRequestListener);
        return call;
    ...
    public List<BatchReturn> getBatch(String token) throws ApiException {
        ApiResponse<List<BatchReturn>> resp = getBatchWithHttpInfo(token);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BatchReturn>> getBatchWithHttpInfo(String token) throws ApiException {
        com.squareup.okhttp.Call call = getBatchValidateBeforeCall(token, null, null);
     ...
     */
    public com.squareup.okhttp.Call getBatchAsync(String token, final ApiCallback<List<BatchReturn>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBatchValidateBeforeCall(token, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<BatchReturn>>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call sendBatchCall(Batch batch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
