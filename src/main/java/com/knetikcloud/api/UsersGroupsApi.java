...
public class UsersGroupsApi {
  ...
  */
  public GroupMemberResource addMemberToGroup (String uniqueName, GroupMemberResource user) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Adds a new member to the group
   * 
   * @param uniqueName The group unique name   * @param user The id and status for a user to add to the group
  */
  ...
  */
  public List<GroupMemberResource> addMembersToGroup (String uniqueName, List<GroupMemberResource> users) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // create path and map variables
    String path = "/users/groups/{unique_name}/members/batch-add".replaceAll("\\{" + "unique_name" + "\\}", apiInvoker.escapeString(uniqueName.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (List<GroupMemberResource>) ApiInvoker.deserialize(localVarResponse, "array", GroupMemberResource.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Adds multiple members to the group
   * 
   * @param uniqueName The group unique name   * @param users The id and status for a list of users to add to the group
  */
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<GroupMemberResource>) ApiInvoker.deserialize(localVarResponse,  "array", GroupMemberResource.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
