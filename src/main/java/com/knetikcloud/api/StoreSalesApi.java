...
public class StoreSalesApi {
  ...
  public CatalogSale createCatalogSale(CatalogSale catalogSale) throws ApiException {
    ...
    GenericType<CatalogSale> localVarReturnType = new GenericType<CatalogSale>() {};
  ...
  public void deleteCatalogSale(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteCatalogSale");
    }
  ...
  public CatalogSale getCatalogSale(Integer id) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getCatalogSale");
    }
  ...
  public PageResourceCatalogSale getCatalogSales(Integer size, Integer page, String order) throws ApiException {
    ...
    GenericType<PageResourceCatalogSale> localVarReturnType = new GenericType<PageResourceCatalogSale>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
  /**
   * Update a sale
  ...
  public CatalogSale updateCatalogSale(Integer id, CatalogSale catalogSale) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateCatalogSale");
    }
