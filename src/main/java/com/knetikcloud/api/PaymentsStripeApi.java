...
@Component("com.knetikcloud.api.PaymentsStripeApi")
public class PaymentsStripeApi {
     ...
     */
    public PaymentMethodResource createStripePaymentMethod(StripeCreatePaymentMethod request) throws RestClientException {
        Object postBody = request;
        
        String path = UriComponentsBuilder.fromPath("/payment/provider/stripe/payment-methods").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void payStripeInvoice(StripePaymentRequest request) throws RestClientException {
        Object postBody = request;
        
        String path = UriComponentsBuilder.fromPath("/payment/provider/stripe/payments").build().toUriString();
