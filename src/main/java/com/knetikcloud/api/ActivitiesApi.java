...
public class ActivitiesApi {
    ...
    private com.squareup.okhttp.Call createActivityCall(RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createActivityValidateBeforeCall(RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc createActivity(RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource) throws ApiException {
        ApiResponse<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> resp = createActivityWithHttpInfo(activityResource);
        return resp.getData();
    }
     ...
     * 
     * @param activityResource The activity resource object (optional)
     * @return ApiResponse&lt;RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> createActivityWithHttpInfo(RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource) throws ApiException {
        com.squareup.okhttp.Call call = createActivityValidateBeforeCall(activityResource, null, null);
        Type localVarReturnType = new TypeToken<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call createActivityAsync(RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource, final ApiCallback<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call createActivityOccurrenceCall(Boolean test, AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings activityOccurrenceResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createActivityOccurrenceValidateBeforeCall(Boolean test, AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings activityOccurrenceResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings createActivityOccurrence(Boolean test, AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings activityOccurrenceResource) throws ApiException {
        ApiResponse<AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings> resp = createActivityOccurrenceWithHttpInfo(test, activityOccurrenceResource);
        return resp.getData();
    }
     ...
     * @param test if true, indicates that the occurrence should NOT be created. This can be used to test for eligibility and valid settings (optional, default to false)
     * @param activityOccurrenceResource The activity occurrence object (optional)
     * @return ApiResponse&lt;AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings> createActivityOccurrenceWithHttpInfo(Boolean test, AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings activityOccurrenceResource) throws ApiException {
        com.squareup.okhttp.Call call = createActivityOccurrenceValidateBeforeCall(test, activityOccurrenceResource, null, null);
        Type localVarReturnType = new TypeToken<AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createActivityOccurrenceAsync(Boolean test, AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings activityOccurrenceResource, final ApiCallback<AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings> callback) throws ApiException {
    ...
    /* Build call for createActivityTemplate */
    private com.squareup.okhttp.Call createActivityTemplateCall(TemplateResource activityTemplateResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createActivityTemplateValidateBeforeCall(TemplateResource activityTemplateResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = createActivityTemplateCall(activityTemplateResource, progressListener, progressRequestListener);
        return call;
    ...
    public TemplateResource createActivityTemplate(TemplateResource activityTemplateResource) throws ApiException {
        ApiResponse<TemplateResource> resp = createActivityTemplateWithHttpInfo(activityTemplateResource);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TemplateResource> createActivityTemplateWithHttpInfo(TemplateResource activityTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = createActivityTemplateValidateBeforeCall(activityTemplateResource, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createActivityTemplateAsync(TemplateResource activityTemplateResource, final ApiCallback<TemplateResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createActivityTemplateValidateBeforeCall(activityTemplateResource, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /* Build call for deleteActivityTemplate */
    private com.squareup.okhttp.Call deleteActivityTemplateCall(String id, String cascade, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteActivityTemplateValidateBeforeCall(String id, String cascade, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteActivityTemplate(Async)");
        }
        
        
        com.squareup.okhttp.Call call = deleteActivityTemplateCall(id, cascade, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteActivityTemplateWithHttpInfo(String id, String cascade) throws ApiException {
        com.squareup.okhttp.Call call = deleteActivityTemplateValidateBeforeCall(id, cascade, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteActivityTemplateAsync(String id, String cascade, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteActivityTemplateValidateBeforeCall(id, cascade, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /* Build call for getActivities */
    private com.squareup.okhttp.Call getActivitiesCall(Boolean filterTemplate, String filterName, Object filterId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getActivitiesValidateBeforeCall(Boolean filterTemplate, String filterName, Object filterId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceBareActivityResource> getActivitiesWithHttpInfo(Boolean filterTemplate, String filterName, Object filterId, Integer size, Integer page, String order) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getActivitiesAsync(Boolean filterTemplate, String filterName, Object filterId, Integer size, Integer page, String order, final ApiCallback<PageResourceBareActivityResource> callback) throws ApiException {
    ...
    public RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc getActivity(Long id) throws ApiException {
        ApiResponse<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> resp = getActivityWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> getActivityWithHttpInfo(Long id) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getActivityAsync(Long id, final ApiCallback<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> callback) throws ApiException {
    ...
    /* Build call for getActivityTemplate */
    private com.squareup.okhttp.Call getActivityTemplateCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getActivityTemplateValidateBeforeCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getActivityTemplate(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getActivityTemplateCall(id, progressListener, progressRequestListener);
        return call;
    ...
    public TemplateResource getActivityTemplate(String id) throws ApiException {
        ApiResponse<TemplateResource> resp = getActivityTemplateWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TemplateResource> getActivityTemplateWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getActivityTemplateValidateBeforeCall(id, null, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getActivityTemplateAsync(String id, final ApiCallback<TemplateResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getActivityTemplateValidateBeforeCall(id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getActivityTemplates */
    private com.squareup.okhttp.Call getActivityTemplatesCall(Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getActivityTemplatesValidateBeforeCall(Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getActivityTemplatesCall(size, page, order, progressListener, progressRequestListener);
        return call;
    ...
    public PageResourceTemplateResource getActivityTemplates(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceTemplateResource> resp = getActivityTemplatesWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceTemplateResource> getActivityTemplatesWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getActivityTemplatesValidateBeforeCall(size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getActivityTemplatesAsync(Integer size, Integer page, String order, final ApiCallback<PageResourceTemplateResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getActivityTemplatesValidateBeforeCall(size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceTemplateResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call updateActivityCall(Long id, RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = activityResource;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateActivityValidateBeforeCall(Long id, RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc updateActivity(Long id, RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource) throws ApiException {
        ApiResponse<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> resp = updateActivityWithHttpInfo(id, activityResource);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> updateActivityWithHttpInfo(Long id, RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateActivityAsync(Long id, RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc activityResource, final ApiCallback<RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc> callback) throws ApiException {
    ...
    /* Build call for updateActivityTemplate */
    private com.squareup.okhttp.Call updateActivityTemplateCall(String id, TemplateResource activityTemplateResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = activityTemplateResource;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateActivityTemplateValidateBeforeCall(String id, TemplateResource activityTemplateResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateActivityTemplate(Async)");
        }
        
        
        com.squareup.okhttp.Call call = updateActivityTemplateCall(id, activityTemplateResource, progressListener, progressRequestListener);
        return call;
    ...
    public TemplateResource updateActivityTemplate(String id, TemplateResource activityTemplateResource) throws ApiException {
        ApiResponse<TemplateResource> resp = updateActivityTemplateWithHttpInfo(id, activityTemplateResource);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TemplateResource> updateActivityTemplateWithHttpInfo(String id, TemplateResource activityTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = updateActivityTemplateValidateBeforeCall(id, activityTemplateResource, null, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateActivityTemplateAsync(String id, TemplateResource activityTemplateResource, final ApiCallback<TemplateResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateActivityTemplateValidateBeforeCall(id, activityTemplateResource, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
