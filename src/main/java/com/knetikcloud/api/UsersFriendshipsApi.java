...
public class UsersFriendshipsApi {
  ...
  */
  public PageResourceSimpleUserResource getFriends (String userId, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'userId' is set
    if (userId == null) {
   ...
   * Get friends list
   * 
   * @param userId The id of the user or &#39;me&#39;   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1
  */
  ...
  * Invites that the specified user received
   ...
   * @return PageResourceSimpleUserResource
  */
  public PageResourceSimpleUserResource getInvites (String userId, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'userId' is set
    if (userId == null) {
