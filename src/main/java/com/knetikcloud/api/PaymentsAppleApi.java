...
@Component("com.knetikcloud.api.PaymentsAppleApi")
public class PaymentsAppleApi {
     ...
     */
    public String verifyAppleReceipt(ApplyPaymentRequest request) throws RestClientException {
        Object postBody = request;
        
        String path = UriComponentsBuilder.fromPath("/payment/provider/apple/receipt").build().toUriString();
