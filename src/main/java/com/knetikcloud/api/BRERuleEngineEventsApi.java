...
public class BRERuleEngineEventsApi {
     ...
     */
    public com.squareup.okhttp.Call sendBREEventCall(BreEvent breEvent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public String sendBREEvent(BreEvent breEvent) throws ApiException {
        ApiResponse<String> resp = sendBREEventWithHttpInfo(breEvent);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> sendBREEventWithHttpInfo(BreEvent breEvent) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call sendBREEventAsync(BreEvent breEvent, final ApiCallback<String> callback) throws ApiException {
