...
public class StoreSubscriptionsApi {
  ...
  public void deleteSubscription(Integer id, String planId) throws ApiException {
    ...
    if (planId == null) {
      throw new ApiException(400, "Missing the required parameter 'planId' when calling deleteSubscription");
    }
  ...
  public void deleteSubscriptionTemplate(String id, String cascade) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteSubscriptionTemplate");
    }
  ...
  public SubscriptionTemplateResource getSubscriptionTemplate(String id) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getSubscriptionTemplate");
    }
  ...
  public PageResourceSubscriptionResource getSubscriptions(Integer size, Integer page, String order) throws ApiException {
    ...
    GenericType<PageResourceSubscriptionResource> localVarReturnType = new GenericType<PageResourceSubscriptionResource>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
  /**
  ...
  public SubscriptionTemplateResource updateSubscriptionTemplate(String id, SubscriptionTemplateResource subscriptionTemplateResource) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateSubscriptionTemplate");
    }
