...
public class DevicesApi {
  ...
  */
  public DeviceResource addDeviceUsers (List<SimpleUserResource> userResources, Integer id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    String path = "/devices/{id}/users".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
   ...
   * Add device users
   * 
   * @param userResources userResources   * @param id id
  */
  ...
  * 
   ...
   * @return void
  */
  public void deleteDeviceUser (Integer id, Integer userId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
    ...
    // create path and map variables
    String path = "/devices/{id}/users/{user_id}".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString())).replaceAll("\\{" + "user_id" + "\\}", apiInvoker.escapeString(userId.toString()));
   ...
   * Delete a device user
   * 
   * @param id The id of the device   * @param userId The user id of the device user
  */
  ...
  * 
   ...
   * @return void
  */
  public void deleteDeviceUsers (Integer id, String filterId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
   ...
   * Delete all device users
   * 
   * @param id The id of the device   * @param filterId Filter for device users to delete with a user id in a given comma separated list of ids
  */
