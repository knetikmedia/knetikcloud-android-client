...
public class GamificationLeaderboardsApi {
     ...
     */
    public com.squareup.okhttp.Call getLeaderboardCall(String contextType, String contextId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getLeaderboardValidateBeforeCall(String contextType, String contextId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getLeaderboardCall(contextType, contextId, size, page, order, progressListener, progressRequestListener);
        return call;
    ...
    public LeaderboardResource getLeaderboard(String contextType, String contextId, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<LeaderboardResource> resp = getLeaderboardWithHttpInfo(contextType, contextId, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LeaderboardResource> getLeaderboardWithHttpInfo(String contextType, String contextId, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getLeaderboardValidateBeforeCall(contextType, contextId, size, page, order, null, null);
     ...
     */
    public com.squareup.okhttp.Call getLeaderboardAsync(String contextType, String contextId, Integer size, Integer page, String order, final ApiCallback<LeaderboardResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getLeaderboardValidateBeforeCall(contextType, contextId, size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LeaderboardResource>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getLeaderboardRankCall(String contextType, String contextId, String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getLeaderboardStrategiesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
