...
public class GamificationAchievementsApi {
  ...
  */
  public PageResourceAchievementDefinitionResource getAchievements (String filterTagset, String filterName, Boolean filterHidden, Integer size, Integer page, String order, Boolean filterDerived) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
   ...
   * Get all achievement definitions in the system
   * 
   * @param filterTagset Filter for achievements with specified tags (separated by comma)   * @param filterName Filter for achievements whose name contains a string   * @param filterHidden Filter for achievements that are hidden or not   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1   * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]   * @param filterDerived Filter for achievements that are derived from other services
  */
  public void getAchievements (String filterTagset, String filterName, Boolean filterHidden, Integer size, Integer page, String order, Boolean filterDerived, final Response.Listener<PageResourceAchievementDefinitionResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
