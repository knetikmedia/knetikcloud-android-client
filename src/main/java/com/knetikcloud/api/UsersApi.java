...
public interface UsersApi {
  ...
  Call<PageResourceUserBaseResource> getUsers(
    @retrofit2.http.Query("filter_displayname") String filterDisplayname, @retrofit2.http.Query("filter_email") String filterEmail, @retrofit2.http.Query("filter_firstname") String filterFirstname, @retrofit2.http.Query("filter_fullname") String filterFullname, @retrofit2.http.Query("filter_lastname") String filterLastname, @retrofit2.http.Query("filter_username") String filterUsername, @retrofit2.http.Query("filter_tag") String filterTag, @retrofit2.http.Query("filter_group") String filterGroup, @retrofit2.http.Query("filter_role") String filterRole, @retrofit2.http.Query("filter_search") String filterSearch, @retrofit2.http.Query("size") Integer size, @retrofit2.http.Query("page") Integer page, @retrofit2.http.Query("order") String order
  );
