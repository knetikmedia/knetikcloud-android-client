...
public class GamificationLevelingApi {
    ...
    private com.squareup.okhttp.Call getUserLevelsCall(Integer userId, String filterName, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
