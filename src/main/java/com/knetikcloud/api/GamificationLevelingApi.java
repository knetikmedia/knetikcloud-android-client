...
public interface GamificationLevelingApi {
  ...
  Call<UserLevelingResource> getUserLevel(
    @retrofit2.http.Path("user_id") Integer userId, @retrofit2.http.Path("name") String name
  );
  ...
  Call<PageResourceUserLevelingResource> getUserLevels(
    @retrofit2.http.Path("user_id") Integer userId, @retrofit2.http.Query("filter_name") String filterName, @retrofit2.http.Query("size") Integer size, @retrofit2.http.Query("page") Integer page, @retrofit2.http.Query("order") String order
  );
