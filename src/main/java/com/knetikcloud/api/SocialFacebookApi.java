...
@Component("com.knetikcloud.api.SocialFacebookApi")
public class SocialFacebookApi {
     ...
     */
    public void linkAccounts(FacebookToken facebookToken) throws RestClientException {
        Object postBody = facebookToken;
        
        String path = UriComponentsBuilder.fromPath("/social/facebook/users").build().toUriString();
