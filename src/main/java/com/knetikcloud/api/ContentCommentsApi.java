...
@Component("com.knetikcloud.api.ContentCommentsApi")
public class ContentCommentsApi {
     ...
     */
    public CommentResource addComment(CommentResource commentResource) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public CommentResource getComment(Long id) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageResourceCommentResource getComments(String context, Integer contextId, Integer size, Integer page) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'context' is set
        if (context == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'context' when calling getComments");
        }
        
        // verify the required parameter 'contextId' is set
        if (contextId == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'contextId' when calling getComments");
        }
        ...
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "context_id", contextId));
     ...
     * <p><b>200</b> - This is not a response, but demonstrates the format of the index object. the actual response will be a Page of comments as seen in the GET endpoint.
     * <p><b>400</b> - Bad Request
     * <p><b>401</b> - Unauthorized
     * <p><b>403</b> - Forbidden
     * <p><b>404</b> - Not Found
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public CommentSearch searchComments(Object query, Integer size, Integer page) throws RestClientException {
        Object postBody = query;
        
        String path = UriComponentsBuilder.fromPath("/comments/search").build().toUriString();
        ...
        ParameterizedTypeReference<CommentSearch> returnType = new ParameterizedTypeReference<CommentSearch>() {};
        return apiClient.invokeAPI(path, HttpMethod.POST, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
    /**
     * Update a comment
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void updateComment(Long id, StringWrapper content) throws RestClientException {
        ...
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/comments/{id}/content").buildAndExpand(uriVariables).toUriString();
