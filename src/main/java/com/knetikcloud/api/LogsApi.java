...
public class LogsApi {
     ...
     */
    public com.squareup.okhttp.Call addUserLogCall(UserActionLog logEntry, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBREEventLogCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBREEventLogsCall(String filterStartDate, String filterEventName, String filterEventId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_event_name", filterEventName));
        if (filterEventId != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_event_id", filterEventId));
        if (size != null)
    ...
    private com.squareup.okhttp.Call getBREEventLogsValidateBeforeCall(String filterStartDate, String filterEventName, String filterEventId, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBREEventLogsCall(filterStartDate, filterEventName, filterEventId, size, page, order, progressListener, progressRequestListener);
        return call;
    ...
    public PageResourceBreEventLog getBREEventLogs(String filterStartDate, String filterEventName, String filterEventId, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceBreEventLog> resp = getBREEventLogsWithHttpInfo(filterStartDate, filterEventName, filterEventId, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceBreEventLog> getBREEventLogsWithHttpInfo(String filterStartDate, String filterEventName, String filterEventId, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getBREEventLogsValidateBeforeCall(filterStartDate, filterEventName, filterEventId, size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBREEventLogsAsync(String filterStartDate, String filterEventName, String filterEventId, Integer size, Integer page, String order, final ApiCallback<PageResourceBreEventLog> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBREEventLogsValidateBeforeCall(filterStartDate, filterEventName, filterEventId, size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceBreEventLog>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getBREForwardLogCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public com.squareup.okhttp.Call getBREForwardLogsCall(String filterStartDate, String filterEndDate, Integer filterStatusCode, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_status_code", filterStatusCode));
        if (size != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("size", size));
        if (page != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("page", page));
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getUserLogCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getUserLogsCall(Integer filterUser, String filterActionName, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_action_name", filterActionName));
        if (size != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("size", size));
        if (page != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("page", page));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getUserLogsValidateBeforeCall(Integer filterUser, String filterActionName, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getUserLogsCall(filterUser, filterActionName, size, page, order, progressListener, progressRequestListener);
        return call;
    ...
    public PageResourceUserActionLog getUserLogs(Integer filterUser, String filterActionName, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceUserActionLog> resp = getUserLogsWithHttpInfo(filterUser, filterActionName, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceUserActionLog> getUserLogsWithHttpInfo(Integer filterUser, String filterActionName, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getUserLogsValidateBeforeCall(filterUser, filterActionName, size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserLogsAsync(Integer filterUser, String filterActionName, Integer size, Integer page, String order, final ApiCallback<PageResourceUserActionLog> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserLogsValidateBeforeCall(filterUser, filterActionName, size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceUserActionLog>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
