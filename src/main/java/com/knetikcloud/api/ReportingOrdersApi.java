...
public class ReportingOrdersApi {
     ...
     */
    public com.squareup.okhttp.Call getInvoiceReportsCall(String currencyCode, String granularity, String filterPaymentStatus, String filterFulfillmentStatus, Long startDate, Long endDate, Integer size, Integer page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getInvoiceReportsValidateBeforeCall(String currencyCode, String granularity, String filterPaymentStatus, String filterFulfillmentStatus, Long startDate, Long endDate, Integer size, Integer page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInvoiceReportsCall(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate, size, page, progressListener, progressRequestListener);
        return call;
    ...
    public PageResourceAggregateInvoiceReportResource getInvoiceReports(String currencyCode, String granularity, String filterPaymentStatus, String filterFulfillmentStatus, Long startDate, Long endDate, Integer size, Integer page) throws ApiException {
        ApiResponse<PageResourceAggregateInvoiceReportResource> resp = getInvoiceReportsWithHttpInfo(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate, size, page);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceAggregateInvoiceReportResource> getInvoiceReportsWithHttpInfo(String currencyCode, String granularity, String filterPaymentStatus, String filterFulfillmentStatus, Long startDate, Long endDate, Integer size, Integer page) throws ApiException {
        com.squareup.okhttp.Call call = getInvoiceReportsValidateBeforeCall(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate, size, page, null, null);
     ...
     */
    public com.squareup.okhttp.Call getInvoiceReportsAsync(String currencyCode, String granularity, String filterPaymentStatus, String filterFulfillmentStatus, Long startDate, Long endDate, Integer size, Integer page, final ApiCallback<PageResourceAggregateInvoiceReportResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInvoiceReportsValidateBeforeCall(currencyCode, granularity, filterPaymentStatus, filterFulfillmentStatus, startDate, endDate, size, page, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceAggregateInvoiceReportResource>(){}.getType();
