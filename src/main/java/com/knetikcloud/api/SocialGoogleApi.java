...
@Component("com.knetikcloud.api.SocialGoogleApi")
public class SocialGoogleApi {
     ...
     */
    public void linkAccounts1(GoogleToken googleToken) throws RestClientException {
        Object postBody = googleToken;
        
        String path = UriComponentsBuilder.fromPath("/social/google/users").build().toUriString();
