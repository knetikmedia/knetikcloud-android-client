...
@Component("com.knetikcloud.api.BRERuleEngineRulesApi")
public class BRERuleEngineRulesApi {
     ...
     */
    public BreRule createBRERule(BreRule breRule) throws RestClientException {
        Object postBody = breRule;
        
        String path = UriComponentsBuilder.fromPath("/bre/rules").build().toUriString();
        ...
        ParameterizedTypeReference<BreRule> returnType = new ParameterizedTypeReference<BreRule>() {};
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void deleteBRERule(String id) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling deleteBRERule");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/bre/rules/{id}").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public String getBREExpressionAsString(Expressionobject expression) throws RestClientException {
        Object postBody = expression;
        
        String path = UriComponentsBuilder.fromPath("/bre/rules/expression-as-string").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public BreRule getBRERule(String id) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling getBRERule");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageResourceBreRule getBRERules(String filterName, Boolean filterEnabled, Boolean filterSystem, String filterTrigger, String filterAction, String filterCondition, Integer size, Integer page) throws RestClientException {
        Object postBody = null;
        ...
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "filter_enabled", filterEnabled));
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "filter_system", filterSystem));
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "filter_trigger", filterTrigger));
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "filter_action", filterAction));
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "filter_condition", filterCondition));
        ...
        ParameterizedTypeReference<PageResourceBreRule> returnType = new ParameterizedTypeReference<PageResourceBreRule>() {};
        return apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
    /**
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void setBRERule(String id, BooleanResource enabled) throws RestClientException {
        Object postBody = enabled;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling setBRERule");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/bre/rules/{id}/enabled").buildAndExpand(uriVariables).toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public BreRule updateBRERule(String id, BreRule breRule) throws RestClientException {
        Object postBody = breRule;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling updateBRERule");
        }
