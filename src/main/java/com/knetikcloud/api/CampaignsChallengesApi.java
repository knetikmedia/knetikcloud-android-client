...
public class CampaignsChallengesApi {
  ...
  public ChallengeActivityResource createChallengeActivity(Long challengeId, ChallengeActivityResource challengeActivityResource, Boolean validateSettings) throws ApiException {
    ...
    if (challengeId == null) {
      throw new ApiException(400, "Missing the required parameter 'challengeId' when calling createChallengeActivity");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public TemplateResource createChallengeActivityTemplate(TemplateResource challengeActivityTemplateResource) throws ApiException {
    Object localVarPostBody = challengeActivityTemplateResource;
    
    // create path and map variables
    String localVarPath = "/challenge-activities/templates".replaceAll("\\{format\\}","json");
  ...
  public void deleteChallenge(Long id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteChallenge");
    }
  ...
  public void deleteChallengeActivity(Long id, Long challengeId) throws ApiException {
    ...
    // verify the required parameter 'challengeId' is set
    if (challengeId == null) {
      throw new ApiException(400, "Missing the required parameter 'challengeId' when calling deleteChallengeActivity");
    }
    
    // create path and map variables
    String localVarPath = "/challenges/{challenge_id}/activities/{id}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()))
      .replaceAll("\\{" + "challenge_id" + "\\}", apiClient.escapeString(challengeId.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteChallengeActivityTemplate(String id, String cascade) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteChallengeActivityTemplate");
    }
    
    // create path and map variables
    String localVarPath = "/challenge-activities/templates/{id}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
  ...
  public void deleteChallengeEvent(Long id) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteChallengeEvent");
    }
  ...
  public void deleteChallengeTemplate(String id, String cascade) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteChallengeTemplate");
    }
  ...
  public ChallengeResource getChallenge(Long id) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getChallenge");
    }
  ...
  public PageResourceBareChallengeActivityResource getChallengeActivities(Long challengeId, Integer size, Integer page, String order) throws ApiException {
    ...
    // verify the required parameter 'challengeId' is set
    if (challengeId == null) {
      throw new ApiException(400, "Missing the required parameter 'challengeId' when calling getChallengeActivities");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public TemplateResource getChallengeActivityTemplate(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getChallengeActivityTemplate");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceTemplateResource getChallengeActivityTemplates(Integer size, Integer page, String order) throws ApiException {
    Object localVarPostBody = null;
  ...
  public ChallengeEventResource getChallengeEvent(Long id) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getChallengeEvent");
    }
  ...
  public TemplateResource getChallengeTemplate(String id) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getChallengeTemplate");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceChallengeResource getChallenges(Boolean filterTemplate, Boolean filterActiveCampaign, String filterStartDate, String filterEndDate, Integer size, Integer page, String order) throws ApiException {
    Object localVarPostBody = null;
  ...
  public ChallengeResource updateChallenge(Long id, ChallengeResource challengeResource) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateChallenge");
    }
  ...
  public ChallengeActivityResource updateChallengeActivity(Long id, Long challengeId, ChallengeActivityResource challengeActivityResource) throws ApiException {
    ...
    // verify the required parameter 'challengeId' is set
    if (challengeId == null) {
      throw new ApiException(400, "Missing the required parameter 'challengeId' when calling updateChallengeActivity");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public TemplateResource updateChallengeActivityTemplate(String id, TemplateResource challengeActivityTemplateResource) throws ApiException {
    Object localVarPostBody = challengeActivityTemplateResource;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateChallengeActivityTemplate");
    }
  ...
  public TemplateResource updateChallengeTemplate(String id, TemplateResource challengeTemplateResource) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateChallengeTemplate");
    }
