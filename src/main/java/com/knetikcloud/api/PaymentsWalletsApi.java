...
public class PaymentsWalletsApi {
     ...
     */
    public com.squareup.okhttp.Call getUserWalletCall(Integer userId, String currencyCode, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public com.squareup.okhttp.Call getUserWalletTransactionsCall(Integer userId, String currencyCode, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_max_date", filterMaxDate));
        if (filterMinDate != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_min_date", filterMinDate));
        if (filterSign != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_sign", filterSign));
        if (size != null)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getUserWalletsCall(Integer userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getWalletBalancesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public com.squareup.okhttp.Call getWalletTransactionsCall(Integer filterInvoice, String filterType, String filterDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_invoice", filterInvoice));
        if (filterType != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_type", filterType));
        if (filterDate != null)
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_user_id", filterUserId));
        if (filterUsername != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_username", filterUsername));
        if (filterDetails != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_details", filterDetails));
        if (filterCurrencyCode != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter_currency_code", filterCurrencyCode));
        if (size != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("size", size));
        if (page != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("page", page));
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getWalletsCall(Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateWalletBalanceCall(Integer userId, String currencyCode, WalletAlterRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
