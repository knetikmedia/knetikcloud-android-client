...
@Component("com.knetikcloud.api.PaymentsOptimalApi")
public class PaymentsOptimalApi {
     ...
     */
    public String silentPostOptimal(OptimalPaymentRequest request) throws RestClientException {
        Object postBody = request;
        
        String path = UriComponentsBuilder.fromPath("/payment/provider/optimal/silent").build().toUriString();
