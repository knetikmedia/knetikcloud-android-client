...
public class ConfigsApi {
  ...
  public void deleteConfig(String name) throws ApiException {
    ...
    if (name == null) {
      throw new ApiException(400, "Missing the required parameter 'name' when calling deleteConfig");
    }
  ...
  public PageResourceConfig getConfigs(String filterSearch, Integer size, Integer page, String order) throws ApiException {
    ...
    GenericType<PageResourceConfig> localVarReturnType = new GenericType<PageResourceConfig>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
  /**
  ...
  public void updateConfig(String name, Config config) throws ApiException {
    ...
    // verify the required parameter 'name' is set
    if (name == null) {
      throw new ApiException(400, "Missing the required parameter 'name' when calling updateConfig");
    }
