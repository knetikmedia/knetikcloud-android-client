...
public interface AccessTokenApi {
  ...
  Call<OAuth2Resource> getOAuthToken(
    @retrofit2.http.Field("grant_type") String grantType, @retrofit2.http.Field("client_id") String clientId, @retrofit2.http.Field("client_secret") String clientSecret, @retrofit2.http.Field("username") String username, @retrofit2.http.Field("password") String password
  );
