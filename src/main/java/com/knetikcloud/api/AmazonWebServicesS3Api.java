...
public class AmazonWebServicesS3Api {
     ...
     */
    public com.squareup.okhttp.Call getDownloadURLCall(String bucket, String path, Integer expiration, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getDownloadURLValidateBeforeCall(String bucket, String path, Integer expiration, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getDownloadURLCall(bucket, path, expiration, progressListener, progressRequestListener);
        return call;
    ...
    public String getDownloadURL(String bucket, String path, Integer expiration) throws ApiException {
        ApiResponse<String> resp = getDownloadURLWithHttpInfo(bucket, path, expiration);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getDownloadURLWithHttpInfo(String bucket, String path, Integer expiration) throws ApiException {
        com.squareup.okhttp.Call call = getDownloadURLValidateBeforeCall(bucket, path, expiration, null, null);
     ...
     */
    public com.squareup.okhttp.Call getDownloadURLAsync(String bucket, String path, Integer expiration, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDownloadURLValidateBeforeCall(bucket, path, expiration, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSignedS3URLCall(String filename, String contentType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
