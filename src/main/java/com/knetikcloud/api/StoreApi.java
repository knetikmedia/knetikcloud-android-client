...
public interface StoreApi {
  ...
  @GET("store")
  Call<PageResourceStoreItem> getStore(
    @retrofit2.http.Query("limit") Integer limit, @retrofit2.http.Query("page") Integer page, @retrofit2.http.Query("use_catalog") Boolean useCatalog, @retrofit2.http.Query("ignore_location") Boolean ignoreLocation, @retrofit2.http.Query("in_stock_only") Boolean inStockOnly
  );
