...
public class ReportingUsersApi {
  ...
  */
  public PageResourceAggregateCountResource getUserRegistrations (String granularity, Long startDate, Long endDate, Integer size, Integer page) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Get user registration info
   * Get user registration counts grouped by time range
   * @param granularity The time duration to aggregate by   * @param startDate The start of the time range to aggregate, unix timestamp in seconds. Default is beginning of time   * @param endDate The end of the time range to aggregate, unix timestamp in seconds. Default is end of time   * @param size The number of objects returned per page   * @param page The number of the page returned, starting with 1
  */
  public void getUserRegistrations (String granularity, Long startDate, Long endDate, Integer size, Integer page, final Response.Listener<PageResourceAggregateCountResource> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
