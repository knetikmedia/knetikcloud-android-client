...
public class PollResponseResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(answeredDate);

    out.writeValue(id);

    out.writeValue(pollId);
  ...
  PollResponseResource(Parcel in) {
    
    answer = (String)in.readValue(null);
    answeredDate = (Long)in.readValue(null);
    id = (String)in.readValue(null);
    pollId = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<PollResponseResource> CREATOR = new Parcelable.Creator<PollResponseResource>() {
    public PollResponseResource createFromParcel(Parcel in) {
      return new PollResponseResource(in);
    }
    public PollResponseResource[] newArray(int size) {
      return new PollResponseResource[size];
    }
  };
}
