...
public class AchievementDefinitionResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(requiredProgress);

    out.writeValue(ruleId);

    out.writeValue(tags);

    out.writeValue(template);

    out.writeValue(triggerEventName);

    out.writeValue(updatedDate);
  }

  public AchievementDefinitionResource() {
    super();
  }

  AchievementDefinitionResource(Parcel in) {
    ...
    requiredProgress = (Integer)in.readValue(null);
    ruleId = (String)in.readValue(null);
    tags = (List<String>)in.readValue(null);
    template = (String)in.readValue(null);
    triggerEventName = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<AchievementDefinitionResource> CREATOR = new Parcelable.Creator<AchievementDefinitionResource>() {
    public AchievementDefinitionResource createFromParcel(Parcel in) {
      return new AchievementDefinitionResource(in);
    }
    public AchievementDefinitionResource[] newArray(int size) {
      return new AchievementDefinitionResource[size];
    }
  };
}
