...
public class InvoicePaymentStatusRequest implements Parcelable {
  ...
  **/
  ...
  public InvoicePaymentStatusRequest() {
    super();
  }

  InvoicePaymentStatusRequest(Parcel in) {
  ...
  public static final Parcelable.Creator<InvoicePaymentStatusRequest> CREATOR = new Parcelable.Creator<InvoicePaymentStatusRequest>() {
    public InvoicePaymentStatusRequest createFromParcel(Parcel in) {
      return new InvoicePaymentStatusRequest(in);
    }
    public InvoicePaymentStatusRequest[] newArray(int size) {
      return new InvoicePaymentStatusRequest[size];
    }
  };
}
