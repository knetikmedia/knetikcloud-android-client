...
public class TypeHintLookupResource implements Parcelable {
  ...
  **/
  ...
  public TypeHintLookupResource() {
    super();
  }

  TypeHintLookupResource(Parcel in) {
  ...
  public static final Parcelable.Creator<TypeHintLookupResource> CREATOR = new Parcelable.Creator<TypeHintLookupResource>() {
    public TypeHintLookupResource createFromParcel(Parcel in) {
      return new TypeHintLookupResource(in);
    }
    public TypeHintLookupResource[] newArray(int size) {
      return new TypeHintLookupResource[size];
    }
  };
}
