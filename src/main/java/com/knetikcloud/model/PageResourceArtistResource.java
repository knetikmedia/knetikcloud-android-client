...
public class PageResourceArtistResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceArtistResource() {
    super();
  }

  PageResourceArtistResource(Parcel in) {
    
    content = (List<ArtistResource>)in.readValue(ArtistResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceArtistResource> CREATOR = new Parcelable.Creator<PageResourceArtistResource>() {
    public PageResourceArtistResource createFromParcel(Parcel in) {
      return new PageResourceArtistResource(in);
    }
    public PageResourceArtistResource[] newArray(int size) {
      return new PageResourceArtistResource[size];
    }
  };
}
