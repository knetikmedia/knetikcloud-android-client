...
public class WalletTransactionResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(isRefunded);

    out.writeValue(response);

    out.writeValue(source);

    out.writeValue(successful);
  ...
  WalletTransactionResource(Parcel in) {
    ...
    isRefunded = (Boolean)in.readValue(null);
    response = (String)in.readValue(null);
    source = (SourceEnum)in.readValue(null);
    successful = (Boolean)in.readValue(null);
    ...
    walletId = (Integer)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<WalletTransactionResource> CREATOR = new Parcelable.Creator<WalletTransactionResource>() {
    public WalletTransactionResource createFromParcel(Parcel in) {
      return new WalletTransactionResource(in);
    }
    public WalletTransactionResource[] newArray(int size) {
      return new WalletTransactionResource[size];
    }
  };
}
