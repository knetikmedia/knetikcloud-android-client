...
public class UserRelationshipReferenceResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(relationshipId);

    out.writeValue(username);
  }

  public UserRelationshipReferenceResource() {
    super();
  }

  UserRelationshipReferenceResource(Parcel in) {
    ...
    relationshipId = (Long)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserRelationshipReferenceResource> CREATOR = new Parcelable.Creator<UserRelationshipReferenceResource>() {
    public UserRelationshipReferenceResource createFromParcel(Parcel in) {
      return new UserRelationshipReferenceResource(in);
    }
    public UserRelationshipReferenceResource[] newArray(int size) {
      return new UserRelationshipReferenceResource[size];
    }
  };
}
