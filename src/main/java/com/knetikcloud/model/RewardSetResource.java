...
public class RewardSetResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(currencyRewards);

    out.writeValue(id);

    out.writeValue(itemRewards);

    out.writeValue(longDescription);

    out.writeValue(maxPlacing);
  ...
  public RewardSetResource() {
    super();
  }

  RewardSetResource(Parcel in) {
    
    createdDate = (Long)in.readValue(null);
    currencyRewards = (List<RewardCurrencyResource>)in.readValue(RewardCurrencyResource.class.getClassLoader());
    id = (Integer)in.readValue(null);
    itemRewards = (List<RewardItemResource>)in.readValue(RewardItemResource.class.getClassLoader());
    longDescription = (String)in.readValue(null);
    maxPlacing = (Integer)in.readValue(null);
  ...
  public static final Parcelable.Creator<RewardSetResource> CREATOR = new Parcelable.Creator<RewardSetResource>() {
    public RewardSetResource createFromParcel(Parcel in) {
      return new RewardSetResource(in);
    }
    public RewardSetResource[] newArray(int size) {
      return new RewardSetResource[size];
    }
  };
}
