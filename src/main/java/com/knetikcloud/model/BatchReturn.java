...
public class BatchReturn implements Parcelable {
  @SerializedName("body")
  ...
  **/
  ...
  BatchReturn(Parcel in) {
    
    body = (Object)in.readValue(null);
  ...
  public static final Parcelable.Creator<BatchReturn> CREATOR = new Parcelable.Creator<BatchReturn>() {
    public BatchReturn createFromParcel(Parcel in) {
      return new BatchReturn(in);
    }
    public BatchReturn[] newArray(int size) {
      return new BatchReturn[size];
    }
  };
}
