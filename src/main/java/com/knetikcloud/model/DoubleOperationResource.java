...
public class DoubleOperationResource implements Parcelable {
  @SerializedName("args")
  ...
  **/
  ...
  DoubleOperationResource(Parcel in) {
  ...
  public static final Parcelable.Creator<DoubleOperationResource> CREATOR = new Parcelable.Creator<DoubleOperationResource>() {
    public DoubleOperationResource createFromParcel(Parcel in) {
      return new DoubleOperationResource(in);
    }
    public DoubleOperationResource[] newArray(int size) {
      return new DoubleOperationResource[size];
    }
  };
}
