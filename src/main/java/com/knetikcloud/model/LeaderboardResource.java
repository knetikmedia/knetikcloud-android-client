...
public class LeaderboardResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(entries);

    out.writeValue(id);

    out.writeValue(strategy);
  }
  ...
  LeaderboardResource(Parcel in) {
    
    entries = (List<LeaderboardEntryResource>)in.readValue(LeaderboardEntryResource.class.getClassLoader());
    id = (Long)in.readValue(null);
    strategy = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<LeaderboardResource> CREATOR = new Parcelable.Creator<LeaderboardResource>() {
    public LeaderboardResource createFromParcel(Parcel in) {
      return new LeaderboardResource(in);
    }
    public LeaderboardResource[] newArray(int size) {
      return new LeaderboardResource[size];
    }
  };
}
