...
public class CartShippingOption implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(originalPrice);

    out.writeValue(price);

    out.writeValue(shippingItemId);

    out.writeValue(sku);

    out.writeValue(taxable);
  ...
  CartShippingOption(Parcel in) {
    
    currencyCode = (String)in.readValue(null);
    description = (String)in.readValue(null);
    name = (String)in.readValue(null);
    originalPrice = (Double)in.readValue(null);
    price = (Double)in.readValue(null);
    shippingItemId = (Integer)in.readValue(null);
    sku = (String)in.readValue(null);
    taxable = (Boolean)in.readValue(null);
  ...
  public static final Parcelable.Creator<CartShippingOption> CREATOR = new Parcelable.Creator<CartShippingOption>() {
    public CartShippingOption createFromParcel(Parcel in) {
      return new CartShippingOption(in);
    }
    public CartShippingOption[] newArray(int size) {
      return new CartShippingOption[size];
    }
  };
}
