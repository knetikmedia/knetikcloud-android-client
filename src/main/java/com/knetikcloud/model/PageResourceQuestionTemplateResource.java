...
public class PageResourceQuestionTemplateResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceQuestionTemplateResource() {
    super();
  }

  PageResourceQuestionTemplateResource(Parcel in) {
    
    content = (List<QuestionTemplateResource>)in.readValue(QuestionTemplateResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceQuestionTemplateResource> CREATOR = new Parcelable.Creator<PageResourceQuestionTemplateResource>() {
    public PageResourceQuestionTemplateResource createFromParcel(Parcel in) {
      return new PageResourceQuestionTemplateResource(in);
    }
    public PageResourceQuestionTemplateResource[] newArray(int size) {
      return new PageResourceQuestionTemplateResource[size];
    }
  };
}
