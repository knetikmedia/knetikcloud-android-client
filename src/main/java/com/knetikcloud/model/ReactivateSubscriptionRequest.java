...
public class ReactivateSubscriptionRequest implements Parcelable {
  ...
  **/
  ...
  ReactivateSubscriptionRequest(Parcel in) {
    
    inventoryId = (Integer)in.readValue(null);
    reactivationFee = (Boolean)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<ReactivateSubscriptionRequest> CREATOR = new Parcelable.Creator<ReactivateSubscriptionRequest>() {
    public ReactivateSubscriptionRequest createFromParcel(Parcel in) {
      return new ReactivateSubscriptionRequest(in);
    }
    public ReactivateSubscriptionRequest[] newArray(int size) {
      return new ReactivateSubscriptionRequest[size];
    }
  };
}
