...
public class FinalizePayPalPaymentRequest implements Parcelable {
  ...
  **/
  ...
  public FinalizePayPalPaymentRequest() {
    super();
  }

  FinalizePayPalPaymentRequest(Parcel in) {
  ...
  public static final Parcelable.Creator<FinalizePayPalPaymentRequest> CREATOR = new Parcelable.Creator<FinalizePayPalPaymentRequest>() {
    public FinalizePayPalPaymentRequest createFromParcel(Parcel in) {
      return new FinalizePayPalPaymentRequest(in);
    }
    public FinalizePayPalPaymentRequest[] newArray(int size) {
      return new FinalizePayPalPaymentRequest[size];
    }
  };
}
