...
public class CouponDefinition implements Parcelable {
  @SerializedName("code")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(discountType);

    out.writeValue(exclusive);

    out.writeValue(maxDiscount);

    out.writeValue(maxQuantity);

    out.writeValue(minCartTotal);

    out.writeValue(name);

    out.writeValue(selfExclusive);

    out.writeValue(targetItemId);

    out.writeValue(type);

    out.writeValue(uniqueKey);

    out.writeValue(validForTags);
  ...
  CouponDefinition(Parcel in) {
    
    code = (String)in.readValue(null);
    description = (String)in.readValue(null);
    discountType = (DiscountTypeEnum)in.readValue(null);
    exclusive = (Boolean)in.readValue(null);
    maxDiscount = (Double)in.readValue(null);
    maxQuantity = (Integer)in.readValue(null);
    minCartTotal = (Double)in.readValue(null);
    name = (String)in.readValue(null);
    selfExclusive = (Boolean)in.readValue(null);
    targetItemId = (Integer)in.readValue(null);
    type = (TypeEnum)in.readValue(null);
    uniqueKey = (String)in.readValue(null);
    validForTags = (List<String>)in.readValue(null);
  ...
  public static final Parcelable.Creator<CouponDefinition> CREATOR = new Parcelable.Creator<CouponDefinition>() {
    public CouponDefinition createFromParcel(Parcel in) {
      return new CouponDefinition(in);
    }
    public CouponDefinition[] newArray(int size) {
      return new CouponDefinition[size];
    }
  };
}
