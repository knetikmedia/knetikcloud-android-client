...
public class SubscriptionCreditResource implements Parcelable {
  ...
  **/
  ...
  public SubscriptionCreditResource() {
    super();
  }

  SubscriptionCreditResource(Parcel in) {
  ...
  public static final Parcelable.Creator<SubscriptionCreditResource> CREATOR = new Parcelable.Creator<SubscriptionCreditResource>() {
    public SubscriptionCreditResource createFromParcel(Parcel in) {
      return new SubscriptionCreditResource(in);
    }
    public SubscriptionCreditResource[] newArray(int size) {
      return new SubscriptionCreditResource[size];
    }
  };
}
