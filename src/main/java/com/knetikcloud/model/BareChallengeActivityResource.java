...
public class BareChallengeActivityResource implements Parcelable {
  ...
  **/
  ...
  public BareChallengeActivityResource() {
    super();
  }

  BareChallengeActivityResource(Parcel in) {
  ...
  public static final Parcelable.Creator<BareChallengeActivityResource> CREATOR = new Parcelable.Creator<BareChallengeActivityResource>() {
    public BareChallengeActivityResource createFromParcel(Parcel in) {
      return new BareChallengeActivityResource(in);
    }
    public BareChallengeActivityResource[] newArray(int size) {
      return new BareChallengeActivityResource[size];
    }
  };
}
