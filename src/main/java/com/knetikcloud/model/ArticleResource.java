...
public class ArticleResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<ArticleResource> CREATOR = new Parcelable.Creator<ArticleResource>() {
    public ArticleResource createFromParcel(Parcel in) {
      return new ArticleResource(in);
    }
    public ArticleResource[] newArray(int size) {
      return new ArticleResource[size];
    }
  };
}
