...
public class SubscriptionResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(consolidationDayOfMonth);

    out.writeValue(createdDate);

    out.writeValue(geoCountryList);

    out.writeValue(geoPolicyType);
    ...
    out.writeValue(storeEnd);

    out.writeValue(storeStart);
  ...
  SubscriptionResource(Parcel in) {
    ...
    consolidationDayOfMonth = (Integer)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    geoCountryList = (List<String>)in.readValue(null);
    geoPolicyType = (GeoPolicyTypeEnum)in.readValue(null);
    id = (Integer)in.readValue(null);
    longDescription = (String)in.readValue(null);
    name = (String)in.readValue(null);
    plans = (List<SubscriptionPlanResource>)in.readValue(SubscriptionPlanResource.class.getClassLoader());
    shortDescription = (String)in.readValue(null);
    sort = (Integer)in.readValue(null);
    storeEnd = (Long)in.readValue(null);
    storeStart = (Long)in.readValue(null);
  ...
  public static final Parcelable.Creator<SubscriptionResource> CREATOR = new Parcelable.Creator<SubscriptionResource>() {
    public SubscriptionResource createFromParcel(Parcel in) {
      return new SubscriptionResource(in);
    }
    public SubscriptionResource[] newArray(int size) {
      return new SubscriptionResource[size];
    }
  };
}
