...
public class RefundRequest implements Parcelable {
  ...
  **/
  ...
  RefundRequest(Parcel in) {
    
    amount = (Double)in.readValue(null);
    notes = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<RefundRequest> CREATOR = new Parcelable.Creator<RefundRequest>() {
    public RefundRequest createFromParcel(Parcel in) {
      return new RefundRequest(in);
    }
