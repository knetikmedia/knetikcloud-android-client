...
public class PaymentMethodResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(_default);

    out.writeValue(disabled);

    out.writeValue(expirationDate);

    out.writeValue(expirationMonth);

    out.writeValue(expirationYear);

    out.writeValue(id);

    out.writeValue(last4);

    out.writeValue(longDescription);

    out.writeValue(name);

    out.writeValue(paymentMethodType);

    out.writeValue(paymentType);
  ...
  PaymentMethodResource(Parcel in) {
    
    createdDate = (Long)in.readValue(null);
    _default = (Boolean)in.readValue(null);
    disabled = (Boolean)in.readValue(null);
    expirationDate = (Long)in.readValue(null);
    expirationMonth = (Integer)in.readValue(null);
    expirationYear = (Integer)in.readValue(null);
    id = (Long)in.readValue(null);
    last4 = (String)in.readValue(null);
    longDescription = (String)in.readValue(null);
    name = (String)in.readValue(null);
    paymentMethodType = (PaymentMethodTypeResource)in.readValue(null);
    paymentType = (PaymentTypeEnum)in.readValue(null);
  ...
  public static final Parcelable.Creator<PaymentMethodResource> CREATOR = new Parcelable.Creator<PaymentMethodResource>() {
    public PaymentMethodResource createFromParcel(Parcel in) {
      return new PaymentMethodResource(in);
    }
    public PaymentMethodResource[] newArray(int size) {
      return new PaymentMethodResource[size];
    }
  };
}
