...
public class CreatePayPalPaymentRequest implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(cancelUrl);

    out.writeValue(invoiceId);

    out.writeValue(returnUrl);
  }
  ...
  CreatePayPalPaymentRequest(Parcel in) {
    
    cancelUrl = (String)in.readValue(null);
    invoiceId = (Integer)in.readValue(null);
    returnUrl = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<CreatePayPalPaymentRequest> CREATOR = new Parcelable.Creator<CreatePayPalPaymentRequest>() {
    public CreatePayPalPaymentRequest createFromParcel(Parcel in) {
      return new CreatePayPalPaymentRequest(in);
    }
    public CreatePayPalPaymentRequest[] newArray(int size) {
      return new CreatePayPalPaymentRequest[size];
    }
  };
}
