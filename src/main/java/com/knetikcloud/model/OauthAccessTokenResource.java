...
public class OauthAccessTokenResource implements Parcelable {
  ...
  **/
  ...
  OauthAccessTokenResource(Parcel in) {
    
    clientId = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<OauthAccessTokenResource> CREATOR = new Parcelable.Creator<OauthAccessTokenResource>() {
    public OauthAccessTokenResource createFromParcel(Parcel in) {
      return new OauthAccessTokenResource(in);
    }
    public OauthAccessTokenResource[] newArray(int size) {
      return new OauthAccessTokenResource[size];
    }
  };
}
