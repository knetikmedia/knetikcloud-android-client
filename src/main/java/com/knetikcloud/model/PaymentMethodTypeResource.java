...
public class PaymentMethodTypeResource {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? paymentMethodTypeResource.id == null : this.id.equals(paymentMethodTypeResource.id)) &&
        (this.name == null ? paymentMethodTypeResource.name == null : this.name.equals(paymentMethodTypeResource.name));
  }
