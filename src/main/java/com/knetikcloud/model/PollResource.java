...
public class PollResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<PollResource> CREATOR = new Parcelable.Creator<PollResource>() {
    public PollResource createFromParcel(Parcel in) {
      return new PollResource(in);
    }
    public PollResource[] newArray(int size) {
      return new PollResource[size];
    }
  };
}
