...
public class BundleItem {
  ...
  private List<BundledSku> bundledSkus = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.additionalProperties == null ? bundleItem.additionalProperties == null : this.additionalProperties.equals(bundleItem.additionalProperties)) &&
        (this.behaviors == null ? bundleItem.behaviors == null : this.behaviors.equals(bundleItem.behaviors)) &&
        (this.bundledSkus == null ? bundleItem.bundledSkus == null : this.bundledSkus.equals(bundleItem.bundledSkus)) &&
        (this.category == null ? bundleItem.category == null : this.category.equals(bundleItem.category)) &&
        (this.createdDate == null ? bundleItem.createdDate == null : this.createdDate.equals(bundleItem.createdDate)) &&
        (this.displayable == null ? bundleItem.displayable == null : this.displayable.equals(bundleItem.displayable)) &&
        (this.geoCountryList == null ? bundleItem.geoCountryList == null : this.geoCountryList.equals(bundleItem.geoCountryList)) &&
        (this.geoPolicyType == null ? bundleItem.geoPolicyType == null : this.geoPolicyType.equals(bundleItem.geoPolicyType)) &&
        (this.id == null ? bundleItem.id == null : this.id.equals(bundleItem.id)) &&
        (this.longDescription == null ? bundleItem.longDescription == null : this.longDescription.equals(bundleItem.longDescription)) &&
        (this.name == null ? bundleItem.name == null : this.name.equals(bundleItem.name)) &&
        (this.shippingTier == null ? bundleItem.shippingTier == null : this.shippingTier.equals(bundleItem.shippingTier)) &&
        (this.shortDescription == null ? bundleItem.shortDescription == null : this.shortDescription.equals(bundleItem.shortDescription)) &&
        (this.skus == null ? bundleItem.skus == null : this.skus.equals(bundleItem.skus)) &&
        (this.sort == null ? bundleItem.sort == null : this.sort.equals(bundleItem.sort)) &&
        (this.storeEnd == null ? bundleItem.storeEnd == null : this.storeEnd.equals(bundleItem.storeEnd)) &&
        (this.storeStart == null ? bundleItem.storeStart == null : this.storeStart.equals(bundleItem.storeStart)) &&
        (this.tags == null ? bundleItem.tags == null : this.tags.equals(bundleItem.tags)) &&
        (this.template == null ? bundleItem.template == null : this.template.equals(bundleItem.template)) &&
        (this.typeHint == null ? bundleItem.typeHint == null : this.typeHint.equals(bundleItem.typeHint)) &&
        (this.uniqueKey == null ? bundleItem.uniqueKey == null : this.uniqueKey.equals(bundleItem.uniqueKey)) &&
        (this.updatedDate == null ? bundleItem.updatedDate == null : this.updatedDate.equals(bundleItem.updatedDate)) &&
        (this.vendorId == null ? bundleItem.vendorId == null : this.vendorId.equals(bundleItem.vendorId));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.bundledSkus == null ? 0: this.bundledSkus.hashCode());
