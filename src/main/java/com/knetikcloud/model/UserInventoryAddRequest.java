...
public class UserInventoryAddRequest implements Parcelable {
  @SerializedName("note")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(overrides);

    out.writeValue(skipInvoice);

    out.writeValue(sku);
  }

  public UserInventoryAddRequest() {
    super();
  }

  UserInventoryAddRequest(Parcel in) {
    
    note = (String)in.readValue(null);
    overrides = (List<String>)in.readValue(null);
    skipInvoice = (Boolean)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserInventoryAddRequest> CREATOR = new Parcelable.Creator<UserInventoryAddRequest>() {
    public UserInventoryAddRequest createFromParcel(Parcel in) {
      return new UserInventoryAddRequest(in);
    }
    public UserInventoryAddRequest[] newArray(int size) {
      return new UserInventoryAddRequest[size];
    }
  };
}
