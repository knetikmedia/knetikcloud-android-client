...
public class ForwardLog implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(errorMsg);

    out.writeValue(httpStatusCode);
  ...
  ForwardLog(Parcel in) {
    
    endDate = (Long)in.readValue(null);
    errorMsg = (String)in.readValue(null);
    httpStatusCode = (Integer)in.readValue(null);
    id = (String)in.readValue(null);
    payload = (Object)in.readValue(null);
    response = (String)in.readValue(null);
    retryCount = (Integer)in.readValue(null);
  ...
  public static final Parcelable.Creator<ForwardLog> CREATOR = new Parcelable.Creator<ForwardLog>() {
    public ForwardLog createFromParcel(Parcel in) {
      return new ForwardLog(in);
    }
    public ForwardLog[] newArray(int size) {
      return new ForwardLog[size];
    }
  };
}
