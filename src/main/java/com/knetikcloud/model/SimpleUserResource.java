...
public class SimpleUserResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<SimpleUserResource> CREATOR = new Parcelable.Creator<SimpleUserResource>() {
    public SimpleUserResource createFromParcel(Parcel in) {
      return new SimpleUserResource(in);
    }
    public SimpleUserResource[] newArray(int size) {
      return new SimpleUserResource[size];
    }
  };
}
