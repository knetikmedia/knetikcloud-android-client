...
public class AddressResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<AddressResource> CREATOR = new Parcelable.Creator<AddressResource>() {
    public AddressResource createFromParcel(Parcel in) {
      return new AddressResource(in);
    }
