...
public class BehaviorDefinitionResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(prerequisiteBehaviors);
  ...
  public BehaviorDefinitionResource() {
    super();
  }

  BehaviorDefinitionResource(Parcel in) {
    
    description = (String)in.readValue(null);
    prerequisiteBehaviors = (List<Behavior>)in.readValue(Behavior.class.getClassLoader());
    properties = (List<PropertyDefinitionResource>)in.readValue(PropertyDefinitionResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<BehaviorDefinitionResource> CREATOR = new Parcelable.Creator<BehaviorDefinitionResource>() {
    public BehaviorDefinitionResource createFromParcel(Parcel in) {
      return new BehaviorDefinitionResource(in);
    }
    public BehaviorDefinitionResource[] newArray(int size) {
      return new BehaviorDefinitionResource[size];
    }
  };
}
