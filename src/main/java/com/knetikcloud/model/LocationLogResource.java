...
public class LocationLogResource implements Parcelable {
  ...
  **/
  ...
  public LocationLogResource() {
    super();
  }

  LocationLogResource(Parcel in) {
  ...
  public static final Parcelable.Creator<LocationLogResource> CREATOR = new Parcelable.Creator<LocationLogResource>() {
    public LocationLogResource createFromParcel(Parcel in) {
      return new LocationLogResource(in);
    }
    public LocationLogResource[] newArray(int size) {
      return new LocationLogResource[size];
    }
  };
}
