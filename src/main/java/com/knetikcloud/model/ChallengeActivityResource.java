...
public class ChallengeActivityResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<ChallengeActivityResource> CREATOR = new Parcelable.Creator<ChallengeActivityResource>() {
    public ChallengeActivityResource createFromParcel(Parcel in) {
      return new ChallengeActivityResource(in);
    }
    public ChallengeActivityResource[] newArray(int size) {
      return new ChallengeActivityResource[size];
    }
  };
}
