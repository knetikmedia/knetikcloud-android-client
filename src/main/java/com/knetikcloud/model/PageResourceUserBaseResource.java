...
public class PageResourceUserBaseResource implements Parcelable {
  @SerializedName("content")
  private List<UserBaseResource> content = new ArrayList<UserBaseResource>();
  ...
  **/
  ...
  public PageResourceUserBaseResource() {
    super();
  }

  PageResourceUserBaseResource(Parcel in) {
    
    content = (List<UserBaseResource>)in.readValue(UserBaseResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceUserBaseResource> CREATOR = new Parcelable.Creator<PageResourceUserBaseResource>() {
    public PageResourceUserBaseResource createFromParcel(Parcel in) {
      return new PageResourceUserBaseResource(in);
    }
    public PageResourceUserBaseResource[] newArray(int size) {
      return new PageResourceUserBaseResource[size];
    }
  };
}
