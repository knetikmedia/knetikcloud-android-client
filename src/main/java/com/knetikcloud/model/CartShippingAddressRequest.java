...
public class CartShippingAddressRequest implements Parcelable {
  @SerializedName("city")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(countryCodeIso3);
    ...
    out.writeValue(postalStateCode);

    out.writeValue(shippingAddressLine1);

    out.writeValue(shippingAddressLine2);

    out.writeValue(zip);
  }

  public CartShippingAddressRequest() {
    super();
  }

  CartShippingAddressRequest(Parcel in) {
    
    city = (String)in.readValue(null);
    countryCodeIso3 = (String)in.readValue(null);
    ...
    postalStateCode = (String)in.readValue(null);
    shippingAddressLine1 = (String)in.readValue(null);
    shippingAddressLine2 = (String)in.readValue(null);
    zip = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<CartShippingAddressRequest> CREATOR = new Parcelable.Creator<CartShippingAddressRequest>() {
    public CartShippingAddressRequest createFromParcel(Parcel in) {
      return new CartShippingAddressRequest(in);
    }
    public CartShippingAddressRequest[] newArray(int size) {
      return new CartShippingAddressRequest[size];
    }
  };
}
