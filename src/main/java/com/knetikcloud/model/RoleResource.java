...
public class RoleResource implements Parcelable {
  ...
  **/
  ...
  RoleResource(Parcel in) {
    
    clientCount = (Integer)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    locked = (Boolean)in.readValue(null);
    name = (String)in.readValue(null);
    role = (String)in.readValue(null);
    rolePermission = (List<PermissionResource>)in.readValue(PermissionResource.class.getClassLoader());
    userCount = (Integer)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<RoleResource> CREATOR = new Parcelable.Creator<RoleResource>() {
    public RoleResource createFromParcel(Parcel in) {
      return new RoleResource(in);
    }
    public RoleResource[] newArray(int size) {
