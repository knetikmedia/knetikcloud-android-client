...
public class DispositionCount implements Parcelable {
  ...
  **/
  ...
  public DispositionCount() {
    super();
  }

  DispositionCount(Parcel in) {
  ...
  public static final Parcelable.Creator<DispositionCount> CREATOR = new Parcelable.Creator<DispositionCount>() {
    public DispositionCount createFromParcel(Parcel in) {
      return new DispositionCount(in);
    }
    public DispositionCount[] newArray(int size) {
      return new DispositionCount[size];
    }
  };
}
