...
public class BooleanPropertyDefinitionResource extends PropertyDefinitionResource {
  ...
  public boolean equals(Object o) {
    ...
    BooleanPropertyDefinitionResource booleanPropertyDefinitionResource = (BooleanPropertyDefinitionResource) o;
    return (this.fieldList == null ? booleanPropertyDefinitionResource.fieldList == null : this.fieldList.equals(booleanPropertyDefinitionResource.fieldList)) &&
        (this.name == null ? booleanPropertyDefinitionResource.name == null : this.name.equals(booleanPropertyDefinitionResource.name)) &&
        (this.required == null ? booleanPropertyDefinitionResource.required == null : this.required.equals(booleanPropertyDefinitionResource.required)) &&
        (this.type == null ? booleanPropertyDefinitionResource.type == null : this.type.equals(booleanPropertyDefinitionResource.type));
  }
