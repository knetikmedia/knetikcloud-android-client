...
public class InvoiceItemResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(affiliateId);

    out.writeValue(bundleSku);

    out.writeValue(currentFulfillmentStatus);

    out.writeValue(id);

    out.writeValue(invoiceId);

    out.writeValue(itemId);

    out.writeValue(itemName);

    out.writeValue(originalTotalPrice);

    out.writeValue(originalUnitPrice);

    out.writeValue(qty);

    out.writeValue(saleName);

    out.writeValue(sku);

    out.writeValue(skuDescription);

    out.writeValue(systemPrice);

    out.writeValue(totalPrice);

    out.writeValue(typeHint);

    out.writeValue(unitPrice);
  }
  ...
  InvoiceItemResource(Parcel in) {
    
    affiliateId = (Integer)in.readValue(null);
    bundleSku = (String)in.readValue(null);
    currentFulfillmentStatus = (String)in.readValue(null);
    id = (Integer)in.readValue(null);
    invoiceId = (Integer)in.readValue(null);
    itemId = (Integer)in.readValue(null);
    itemName = (String)in.readValue(null);
    originalTotalPrice = (Double)in.readValue(null);
    originalUnitPrice = (Double)in.readValue(null);
    qty = (Integer)in.readValue(null);
    saleName = (String)in.readValue(null);
    sku = (String)in.readValue(null);
    skuDescription = (String)in.readValue(null);
    systemPrice = (Double)in.readValue(null);
    totalPrice = (Double)in.readValue(null);
    typeHint = (String)in.readValue(null);
    unitPrice = (Double)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<InvoiceItemResource> CREATOR = new Parcelable.Creator<InvoiceItemResource>() {
    public InvoiceItemResource createFromParcel(Parcel in) {
      return new InvoiceItemResource(in);
    }
    public InvoiceItemResource[] newArray(int size) {
      return new InvoiceItemResource[size];
    }
  };
}
