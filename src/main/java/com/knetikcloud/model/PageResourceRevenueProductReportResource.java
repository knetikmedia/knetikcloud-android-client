...
public class PageResourceRevenueProductReportResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceRevenueProductReportResource() {
    super();
  }

  PageResourceRevenueProductReportResource(Parcel in) {
    
    content = (List<RevenueProductReportResource>)in.readValue(RevenueProductReportResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceRevenueProductReportResource> CREATOR = new Parcelable.Creator<PageResourceRevenueProductReportResource>() {
    public PageResourceRevenueProductReportResource createFromParcel(Parcel in) {
      return new PageResourceRevenueProductReportResource(in);
    }
    public PageResourceRevenueProductReportResource[] newArray(int size) {
      return new PageResourceRevenueProductReportResource[size];
    }
  };
}
