...
public class RewardCurrencyResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(currencyName);

    out.writeValue(maxRank);

    out.writeValue(minRank);
  ...
  public RewardCurrencyResource() {
    super();
  }

  RewardCurrencyResource(Parcel in) {
    
    currencyCode = (String)in.readValue(null);
    currencyName = (String)in.readValue(null);
    maxRank = (Integer)in.readValue(null);
    minRank = (Integer)in.readValue(null);
    percent = (Boolean)in.readValue(null);
  ...
  public static final Parcelable.Creator<RewardCurrencyResource> CREATOR = new Parcelable.Creator<RewardCurrencyResource>() {
    public RewardCurrencyResource createFromParcel(Parcel in) {
      return new RewardCurrencyResource(in);
    }
    public RewardCurrencyResource[] newArray(int size) {
      return new RewardCurrencyResource[size];
    }
  };
}
