...
public class RawEmailResource implements Parcelable {
  @SerializedName("body")
  ...
  **/
  ...
  public RawEmailResource() {
    super();
  }

  RawEmailResource(Parcel in) {
    
    body = (String)in.readValue(null);
    from = (String)in.readValue(null);
    html = (Boolean)in.readValue(null);
  ...
  public static final Parcelable.Creator<RawEmailResource> CREATOR = new Parcelable.Creator<RawEmailResource>() {
    public RawEmailResource createFromParcel(Parcel in) {
      return new RawEmailResource(in);
    }
    public RawEmailResource[] newArray(int size) {
      return new RawEmailResource[size];
    }
  };
}
