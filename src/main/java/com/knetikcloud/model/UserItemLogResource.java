...
public class UserItemLogResource implements Parcelable {
  @SerializedName("id")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(logDate);

    out.writeValue(type);

    out.writeValue(user);

    out.writeValue(userInventory);
  }

  public UserItemLogResource() {
    super();
  }

  UserItemLogResource(Parcel in) {
    
    id = (Integer)in.readValue(null);
    info = (String)in.readValue(null);
    item = (SimpleReferenceResourceint)in.readValue(null);
    logDate = (Long)in.readValue(null);
    type = (String)in.readValue(null);
    user = (SimpleUserResource)in.readValue(null);
    userInventory = (Integer)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<UserItemLogResource> CREATOR = new Parcelable.Creator<UserItemLogResource>() {
    public UserItemLogResource createFromParcel(Parcel in) {
      return new UserItemLogResource(in);
    }
    public UserItemLogResource[] newArray(int size) {
      return new UserItemLogResource[size];
    }
  };
}
