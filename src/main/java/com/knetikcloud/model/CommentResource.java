...
public class CommentResource implements Parcelable {
  ...
  **/
  ...
  CommentResource(Parcel in) {
    ...
    summary = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<CommentResource> CREATOR = new Parcelable.Creator<CommentResource>() {
    public CommentResource createFromParcel(Parcel in) {
      return new CommentResource(in);
    }
    public CommentResource[] newArray(int size) {
      return new CommentResource[size];
    }
  };
}
