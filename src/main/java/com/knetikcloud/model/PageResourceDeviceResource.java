...
public class PageResourceDeviceResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceDeviceResource() {
    super();
  }

  PageResourceDeviceResource(Parcel in) {
    
    content = (List<DeviceResource>)in.readValue(DeviceResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceDeviceResource> CREATOR = new Parcelable.Creator<PageResourceDeviceResource>() {
    public PageResourceDeviceResource createFromParcel(Parcel in) {
      return new PageResourceDeviceResource(in);
    }
    public PageResourceDeviceResource[] newArray(int size) {
      return new PageResourceDeviceResource[size];
    }
  };
}
