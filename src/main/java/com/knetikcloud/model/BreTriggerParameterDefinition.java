...
public class BreTriggerParameterDefinition implements Parcelable {
  @SerializedName("name")
  ...
  **/
  ...
  public BreTriggerParameterDefinition() {
    super();
  }

  BreTriggerParameterDefinition(Parcel in) {
  ...
  public static final Parcelable.Creator<BreTriggerParameterDefinition> CREATOR = new Parcelable.Creator<BreTriggerParameterDefinition>() {
    public BreTriggerParameterDefinition createFromParcel(Parcel in) {
      return new BreTriggerParameterDefinition(in);
    }
    public BreTriggerParameterDefinition[] newArray(int size) {
      return new BreTriggerParameterDefinition[size];
    }
  };
}
