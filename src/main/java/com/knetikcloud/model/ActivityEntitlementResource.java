...
public class ActivityEntitlementResource implements Parcelable {
  ...
  **/
  ...
  public ActivityEntitlementResource() {
    super();
  }

  ActivityEntitlementResource(Parcel in) {
  ...
  public static final Parcelable.Creator<ActivityEntitlementResource> CREATOR = new Parcelable.Creator<ActivityEntitlementResource>() {
    public ActivityEntitlementResource createFromParcel(Parcel in) {
      return new ActivityEntitlementResource(in);
    }
    public ActivityEntitlementResource[] newArray(int size) {
      return new ActivityEntitlementResource[size];
    }
  };
}
