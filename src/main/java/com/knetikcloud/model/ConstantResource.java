...
public class ConstantResource implements Parcelable {
  @SerializedName("type")
  ...
  **/
  ...
  public static final Parcelable.Creator<ConstantResource> CREATOR = new Parcelable.Creator<ConstantResource>() {
    public ConstantResource createFromParcel(Parcel in) {
      return new ConstantResource(in);
    }
    public ConstantResource[] newArray(int size) {
      return new ConstantResource[size];
    }
  };
}
