...
public class ConfigLookupResource implements Parcelable {
  ...
  **/
  ...
  public ConfigLookupResource() {
    super();
  }

  ConfigLookupResource(Parcel in) {
  ...
  public static final Parcelable.Creator<ConfigLookupResource> CREATOR = new Parcelable.Creator<ConfigLookupResource>() {
    public ConfigLookupResource createFromParcel(Parcel in) {
      return new ConfigLookupResource(in);
    }
    public ConfigLookupResource[] newArray(int size) {
      return new ConfigLookupResource[size];
    }
  };
}
