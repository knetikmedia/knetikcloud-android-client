...
public class SimpleWallet implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<SimpleWallet> CREATOR = new Parcelable.Creator<SimpleWallet>() {
    public SimpleWallet createFromParcel(Parcel in) {
      return new SimpleWallet(in);
    }
    public SimpleWallet[] newArray(int size) {
      return new SimpleWallet[size];
    }
  };
}
