...
public class CacheClearEvent extends BroadcastableEvent {
  ...
  public boolean equals(Object o) {
    ...
    return (this.client == null ? cacheClearEvent.client == null : this.client.equals(cacheClearEvent.client)) &&
        (this.customer == null ? cacheClearEvent.customer == null : this.customer.equals(cacheClearEvent.customer)) &&
        (this.doNotBroadcast == null ? cacheClearEvent.doNotBroadcast == null : this.doNotBroadcast.equals(cacheClearEvent.doNotBroadcast)) &&
        (this.section == null ? cacheClearEvent.section == null : this.section.equals(cacheClearEvent.section)) &&
        (this.source == null ? cacheClearEvent.source == null : this.source.equals(cacheClearEvent.source)) &&
