...
public class SimpleReferenceResourcelong implements Parcelable {
  @SerializedName("id")
  ...
  **/
  ...
  public SimpleReferenceResourcelong() {
    super();
  }

  SimpleReferenceResourcelong(Parcel in) {
  ...
  public static final Parcelable.Creator<SimpleReferenceResourcelong> CREATOR = new Parcelable.Creator<SimpleReferenceResourcelong>() {
    public SimpleReferenceResourcelong createFromParcel(Parcel in) {
      return new SimpleReferenceResourcelong(in);
    }
    public SimpleReferenceResourcelong[] newArray(int size) {
      return new SimpleReferenceResourcelong[size];
    }
  };
}
