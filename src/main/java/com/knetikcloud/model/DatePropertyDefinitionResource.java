...
public class DatePropertyDefinitionResource extends PropertyDefinitionResource {
  ...
  public boolean equals(Object o) {
    ...
    return (this.fieldList == null ? datePropertyDefinitionResource.fieldList == null : this.fieldList.equals(datePropertyDefinitionResource.fieldList)) &&
        (this.name == null ? datePropertyDefinitionResource.name == null : this.name.equals(datePropertyDefinitionResource.name)) &&
        (this.required == null ? datePropertyDefinitionResource.required == null : this.required.equals(datePropertyDefinitionResource.required)) &&
        (this.type == null ? datePropertyDefinitionResource.type == null : this.type.equals(datePropertyDefinitionResource.type)) &&
        (this.max == null ? datePropertyDefinitionResource.max == null : this.max.equals(datePropertyDefinitionResource.max)) &&
        (this.min == null ? datePropertyDefinitionResource.min == null : this.min.equals(datePropertyDefinitionResource.min));
  }
