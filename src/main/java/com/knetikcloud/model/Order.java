...
public class Order implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(ascending);

    out.writeValue(direction);

    out.writeValue(ignoreCase);

    out.writeValue(nullHandling);
  ...
  Order(Parcel in) {
    ...
    ascending = (Boolean)in.readValue(null);
    direction = (DirectionEnum)in.readValue(null);
    ignoreCase = (Boolean)in.readValue(null);
    nullHandling = (NullHandlingEnum)in.readValue(null);
