...
public class DeltaResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(mediaType);

    out.writeValue(questionId);
  ...
  DeltaResource(Parcel in) {
    
    categoryId = (String)in.readValue(null);
    mediaType = (String)in.readValue(null);
    questionId = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<DeltaResource> CREATOR = new Parcelable.Creator<DeltaResource>() {
    public DeltaResource createFromParcel(Parcel in) {
      return new DeltaResource(in);
    }
    public DeltaResource[] newArray(int size) {
      return new DeltaResource[size];
    }
  };
}
