...
public class ActivityUserResource implements Parcelable {
  @SerializedName("host")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(joinedDate);

    out.writeValue(leftDate);

    out.writeValue(metric);
  ...
  public ActivityUserResource() {
    super();
  }

  ActivityUserResource(Parcel in) {
    
    host = (Boolean)in.readValue(null);
    id = (Long)in.readValue(null);
    joinedDate = (Long)in.readValue(null);
    leftDate = (Long)in.readValue(null);
    metric = (MetricResource)in.readValue(null);
  ...
  public static final Parcelable.Creator<ActivityUserResource> CREATOR = new Parcelable.Creator<ActivityUserResource>() {
    public ActivityUserResource createFromParcel(Parcel in) {
      return new ActivityUserResource(in);
    }
    public ActivityUserResource[] newArray(int size) {
      return new ActivityUserResource[size];
    }
  };
}
