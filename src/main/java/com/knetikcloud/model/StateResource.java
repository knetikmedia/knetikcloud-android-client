...
public class StateResource implements Parcelable {
  @SerializedName("code")
  ...
  **/
  ...
  public static final Parcelable.Creator<StateResource> CREATOR = new Parcelable.Creator<StateResource>() {
    public StateResource createFromParcel(Parcel in) {
      return new StateResource(in);
    }
    public StateResource[] newArray(int size) {
      return new StateResource[size];
    }
  };
}
