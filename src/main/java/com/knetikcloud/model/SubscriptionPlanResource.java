...
public class SubscriptionPlanResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(billingCycleLength);

    out.writeValue(billingCycleUnit);
    ...
    out.writeValue(firstBillingCycleLength);

    out.writeValue(firstBillingCycleUnit);

    out.writeValue(gracePeriod);

    out.writeValue(id);

    out.writeValue(initialFee);

    out.writeValue(initialSku);

    out.writeValue(latePaymentFee);
    ...
    out.writeValue(maxCycles);

    out.writeValue(migrateToPlan);

    out.writeValue(minCycles);

    out.writeValue(name);

    out.writeValue(published);

    out.writeValue(reactivationFee);

    out.writeValue(reactivationSku);

    out.writeValue(recurringFee);
  ...
  SubscriptionPlanResource(Parcel in) {
    
    additionalProperties = (Map<String, Property>)in.readValue(Property.class.getClassLoader());
    billingCycleLength = (Integer)in.readValue(null);
    billingCycleUnit = (BillingCycleUnitEnum)in.readValue(null);
    consolidated = (Boolean)in.readValue(null);
    currencyCode = (String)in.readValue(null);
    endDate = (Long)in.readValue(null);
    firstBillingCycleLength = (Integer)in.readValue(null);
    firstBillingCycleUnit = (FirstBillingCycleUnitEnum)in.readValue(null);
    gracePeriod = (Integer)in.readValue(null);
    id = (String)in.readValue(null);
    initialFee = (Double)in.readValue(null);
    initialSku = (String)in.readValue(null);
    latePaymentFee = (Double)in.readValue(null);
    latePaymentSku = (String)in.readValue(null);
    locked = (Boolean)in.readValue(null);
    maxBillAttempts = (Integer)in.readValue(null);
    maxCycles = (Integer)in.readValue(null);
    migrateToPlan = (String)in.readValue(null);
    minCycles = (Integer)in.readValue(null);
    name = (String)in.readValue(null);
    published = (Boolean)in.readValue(null);
    reactivationFee = (Double)in.readValue(null);
    reactivationSku = (String)in.readValue(null);
    recurringFee = (Double)in.readValue(null);
    recurringSku = (String)in.readValue(null);
    startDate = (Long)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<SubscriptionPlanResource> CREATOR = new Parcelable.Creator<SubscriptionPlanResource>() {
    public SubscriptionPlanResource createFromParcel(Parcel in) {
      return new SubscriptionPlanResource(in);
    }
    public SubscriptionPlanResource[] newArray(int size) {
      return new SubscriptionPlanResource[size];
    }
  };
}
