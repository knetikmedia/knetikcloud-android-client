...
public class VariableTypeResource {
   ...
   **/
  @ApiModelProperty(value = "Whether the type comes from a set of valid values that the system can provided (such as users)")
  ...
  public boolean equals(Object o) {
    ...
    return (this.base == null ? variableTypeResource.base == null : this.base.equals(variableTypeResource.base)) &&
        (this.enumerable == null ? variableTypeResource.enumerable == null : this.enumerable.equals(variableTypeResource.enumerable)) &&
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.enumerable == null ? 0: this.enumerable.hashCode());
