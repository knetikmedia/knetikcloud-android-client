...
public class VideoResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(authored);

    out.writeValue(banned);
    ...
    out.writeValue(uploader);

    out.writeValue(views);
  ...
  VideoResource(Parcel in) {
    
    active = (Boolean)in.readValue(null);
    author = (SimpleReferenceResourcelong)in.readValue(null);
    authored = (Long)in.readValue(null);
    banned = (Boolean)in.readValue(null);
    category = (SimpleReferenceResourcestring)in.readValue(null);
    comments = (List<CommentResource>)in.readValue(CommentResource.class.getClassLoader());
    contributors = (List<ContributionResource>)in.readValue(ContributionResource.class.getClassLoader());
    createdDate = (Long)in.readValue(null);
    embed = (String)in.readValue(null);
    ...
    privacy = (PrivacyEnum)in.readValue(null);
    ...
    uploader = (SimpleUserResource)in.readValue(null);
    views = (Long)in.readValue(null);
  ...
  public static final Parcelable.Creator<VideoResource> CREATOR = new Parcelable.Creator<VideoResource>() {
    public VideoResource createFromParcel(Parcel in) {
      return new VideoResource(in);
    }
    public VideoResource[] newArray(int size) {
      return new VideoResource[size];
    }
  };
}
