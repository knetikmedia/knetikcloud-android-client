...
public class BundledSku implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<BundledSku> CREATOR = new Parcelable.Creator<BundledSku>() {
    public BundledSku createFromParcel(Parcel in) {
      return new BundledSku(in);
    }
    public BundledSku[] newArray(int size) {
      return new BundledSku[size];
    }
  };
}
