...
public class ImportJobResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(output);

    out.writeValue(recordCount);
  ...
  public ImportJobResource() {
    super();
  }

  ImportJobResource(Parcel in) {
    
    categoryId = (String)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    id = (Long)in.readValue(null);
    name = (String)in.readValue(null);
    output = (List<ImportJobOutputResource>)in.readValue(ImportJobOutputResource.class.getClassLoader());
    recordCount = (Long)in.readValue(null);
  ...
  public static final Parcelable.Creator<ImportJobResource> CREATOR = new Parcelable.Creator<ImportJobResource>() {
    public ImportJobResource createFromParcel(Parcel in) {
      return new ImportJobResource(in);
    }
    public ImportJobResource[] newArray(int size) {
      return new ImportJobResource[size];
    }
  };
}
