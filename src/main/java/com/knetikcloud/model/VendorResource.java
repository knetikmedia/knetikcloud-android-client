...
public class VendorResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(manualApproval);

    out.writeValue(name);

    out.writeValue(primaryContactEmail);

    out.writeValue(primaryContactName);

    out.writeValue(primaryContactPhone);

    out.writeValue(salesEmail);

    out.writeValue(supportEmail);
  ...
  VendorResource(Parcel in) {
    
    active = (Boolean)in.readValue(null);
    additionalProperties = (Map<String, Property>)in.readValue(Property.class.getClassLoader());
    createDate = (Long)in.readValue(null);
    description = (String)in.readValue(null);
    id = (Integer)in.readValue(null);
    imageUrl = (String)in.readValue(null);
    manualApproval = (Boolean)in.readValue(null);
    name = (String)in.readValue(null);
    primaryContactEmail = (String)in.readValue(null);
    primaryContactName = (String)in.readValue(null);
    primaryContactPhone = (String)in.readValue(null);
    salesEmail = (String)in.readValue(null);
    supportEmail = (String)in.readValue(null);
    template = (String)in.readValue(null);
    updateDate = (Long)in.readValue(null);
  ...
  public static final Parcelable.Creator<VendorResource> CREATOR = new Parcelable.Creator<VendorResource>() {
    public VendorResource createFromParcel(Parcel in) {
      return new VendorResource(in);
    }
    public VendorResource[] newArray(int size) {
      return new VendorResource[size];
    }
  };
}
