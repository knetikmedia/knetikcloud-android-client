...
public class AmazonS3Activity implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(filename);

    out.writeValue(id);

    out.writeValue(objectKey);
  ...
  public AmazonS3Activity() {
    super();
  }

  AmazonS3Activity(Parcel in) {
    
    action = (String)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    filename = (String)in.readValue(null);
    id = (Long)in.readValue(null);
    objectKey = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<AmazonS3Activity> CREATOR = new Parcelable.Creator<AmazonS3Activity>() {
    public AmazonS3Activity createFromParcel(Parcel in) {
      return new AmazonS3Activity(in);
    }
    public AmazonS3Activity[] newArray(int size) {
      return new AmazonS3Activity[size];
    }
  };
}
