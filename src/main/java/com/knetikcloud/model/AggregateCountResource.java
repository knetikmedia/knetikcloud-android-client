...
public class AggregateCountResource implements Parcelable {
  ...
  **/
  ...
  public AggregateCountResource() {
    super();
  }

  AggregateCountResource(Parcel in) {
  ...
  public static final Parcelable.Creator<AggregateCountResource> CREATOR = new Parcelable.Creator<AggregateCountResource>() {
    public AggregateCountResource createFromParcel(Parcel in) {
      return new AggregateCountResource(in);
    }
    public AggregateCountResource[] newArray(int size) {
      return new AggregateCountResource[size];
    }
  };
}
