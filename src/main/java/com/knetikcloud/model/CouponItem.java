...
public class CouponItem extends StoreItem implements Parcelable {
  /**
   * The type of coupon
   */
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(couponTypeHint);

    out.writeValue(discountMax);

    out.writeValue(discountMinCartValue);
  ...
  CouponItem(Parcel in) {
     super(in); 
    couponTypeHint = (CouponTypeHintEnum)in.readValue(null);
    discountMax = (Double)in.readValue(null);
    discountMinCartValue = (Double)in.readValue(null);
