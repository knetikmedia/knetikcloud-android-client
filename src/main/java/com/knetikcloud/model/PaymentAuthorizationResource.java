...
public class PaymentAuthorizationResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(invoice);

    out.writeValue(paymentType);
  }

  public PaymentAuthorizationResource() {
    super();
  }

  PaymentAuthorizationResource(Parcel in) {
    
    captured = (Boolean)in.readValue(null);
    created = (Long)in.readValue(null);
    details = (Object)in.readValue(null);
    id = (Integer)in.readValue(null);
    invoice = (Integer)in.readValue(null);
    paymentType = (SimpleReferenceResourceint)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<PaymentAuthorizationResource> CREATOR = new Parcelable.Creator<PaymentAuthorizationResource>() {
    public PaymentAuthorizationResource createFromParcel(Parcel in) {
      return new PaymentAuthorizationResource(in);
    }
    public PaymentAuthorizationResource[] newArray(int size) {
      return new PaymentAuthorizationResource[size];
    }
  };
}
