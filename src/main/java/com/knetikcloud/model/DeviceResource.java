...
public class DeviceResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(authorization);

    out.writeValue(condition);
    ...
    out.writeValue(deviceType);

    out.writeValue(id);

    out.writeValue(location);

    out.writeValue(macAddress);

    out.writeValue(make);

    out.writeValue(model);

    out.writeValue(name);

    out.writeValue(os);

    out.writeValue(serial);
  ...
  DeviceResource(Parcel in) {
    
    authorization = (String)in.readValue(null);
    condition = (ConditionEnum)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    data = (Map<String, String>)in.readValue(null);
    description = (String)in.readValue(null);
    deviceType = (String)in.readValue(null);
    id = (Integer)in.readValue(null);
    location = (String)in.readValue(null);
    macAddress = (String)in.readValue(null);
    make = (String)in.readValue(null);
    model = (String)in.readValue(null);
    name = (String)in.readValue(null);
    os = (String)in.readValue(null);
    serial = (String)in.readValue(null);
    status = (StatusEnum)in.readValue(null);
    updatedDate = (Long)in.readValue(null);
    user = (SimpleUserResource)in.readValue(null);
    users = (List<SimpleUserResource>)in.readValue(SimpleUserResource.class.getClassLoader());
  }
  ...
  public static final Parcelable.Creator<DeviceResource> CREATOR = new Parcelable.Creator<DeviceResource>() {
    public DeviceResource createFromParcel(Parcel in) {
      return new DeviceResource(in);
    }
    public DeviceResource[] newArray(int size) {
      return new DeviceResource[size];
    }
  };
}
