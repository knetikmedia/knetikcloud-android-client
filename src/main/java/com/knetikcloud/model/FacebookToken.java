...
public class FacebookToken implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<FacebookToken> CREATOR = new Parcelable.Creator<FacebookToken>() {
    public FacebookToken createFromParcel(Parcel in) {
      return new FacebookToken(in);
    }
    public FacebookToken[] newArray(int size) {
      return new FacebookToken[size];
    }
  };
}
