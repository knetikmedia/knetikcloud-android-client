...
public class ActionVariableResource implements Parcelable {
  @SerializedName("name")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(optional);

    out.writeValue(type);
  }

  public ActionVariableResource() {
    super();
  }

  ActionVariableResource(Parcel in) {
    
    name = (String)in.readValue(null);
    optional = (Boolean)in.readValue(null);
  ...
  public static final Parcelable.Creator<ActionVariableResource> CREATOR = new Parcelable.Creator<ActionVariableResource>() {
    public ActionVariableResource createFromParcel(Parcel in) {
      return new ActionVariableResource(in);
    }
    public ActionVariableResource[] newArray(int size) {
      return new ActionVariableResource[size];
    }
  };
}
