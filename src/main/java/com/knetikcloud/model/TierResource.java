...
public class TierResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<TierResource> CREATOR = new Parcelable.Creator<TierResource>() {
    public TierResource createFromParcel(Parcel in) {
      return new TierResource(in);
    }
    public TierResource[] newArray(int size) {
      return new TierResource[size];
    }
  };
}
