...
public class Sku implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(inventory);

    out.writeValue(minInventoryThreshold);
