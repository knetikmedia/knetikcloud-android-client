...
public class ActivityOccurrenceJoinResult implements Parcelable {
  ...
  **/
  ...
  public ActivityOccurrenceJoinResult() {
    super();
  }

  ActivityOccurrenceJoinResult(Parcel in) {
  ...
  public static final Parcelable.Creator<ActivityOccurrenceJoinResult> CREATOR = new Parcelable.Creator<ActivityOccurrenceJoinResult>() {
    public ActivityOccurrenceJoinResult createFromParcel(Parcel in) {
      return new ActivityOccurrenceJoinResult(in);
    }
    public ActivityOccurrenceJoinResult[] newArray(int size) {
      return new ActivityOccurrenceJoinResult[size];
    }
  };
}
