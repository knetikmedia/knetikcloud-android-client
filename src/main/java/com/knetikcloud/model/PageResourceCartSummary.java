...
public class PageResourceCartSummary implements Parcelable {
  ...
  **/
  ...
  public PageResourceCartSummary() {
    super();
  }

  PageResourceCartSummary(Parcel in) {
    
    content = (List<CartSummary>)in.readValue(CartSummary.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceCartSummary> CREATOR = new Parcelable.Creator<PageResourceCartSummary>() {
    public PageResourceCartSummary createFromParcel(Parcel in) {
      return new PageResourceCartSummary(in);
    }
    public PageResourceCartSummary[] newArray(int size) {
      return new PageResourceCartSummary[size];
    }
  };
}
