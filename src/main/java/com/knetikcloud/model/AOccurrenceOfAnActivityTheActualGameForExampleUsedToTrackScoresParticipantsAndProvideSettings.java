...
public class AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(activityId);

    out.writeValue(challengeActivityId);

    out.writeValue(createdDate);

    out.writeValue(entitlement);

    out.writeValue(eventId);

    out.writeValue(id);

    out.writeValue(rewardStatus);

    out.writeValue(settings);

    out.writeValue(simulated);
  ...
  public AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings() {
    super();
  }

  AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings(Parcel in) {
    
    activityId = (Long)in.readValue(null);
    challengeActivityId = (Long)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    entitlement = (ActivityEntitlementResource)in.readValue(null);
    eventId = (Long)in.readValue(null);
    id = (Long)in.readValue(null);
    rewardStatus = (RewardStatusEnum)in.readValue(null);
    settings = (List<SelectedSettingResource>)in.readValue(SelectedSettingResource.class.getClassLoader());
    simulated = (Boolean)in.readValue(null);
    startDate = (Long)in.readValue(null);
    status = (StatusEnum)in.readValue(null);
    updatedDate = (Long)in.readValue(null);
    users = (List<ActivityUserResource>)in.readValue(ActivityUserResource.class.getClassLoader());
  }
  ...
  public static final Parcelable.Creator<AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings> CREATOR = new Parcelable.Creator<AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings>() {
    public AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings createFromParcel(Parcel in) {
      return new AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings(in);
    }
    public AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings[] newArray(int size) {
      return new AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings[size];
    }
  };
}
