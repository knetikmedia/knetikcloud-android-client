...
public class RawSMSResource implements Parcelable {
  @SerializedName("from")
  ...
  **/
  ...
  public RawSMSResource() {
    super();
  }

  RawSMSResource(Parcel in) {
  ...
  public static final Parcelable.Creator<RawSMSResource> CREATOR = new Parcelable.Creator<RawSMSResource>() {
    public RawSMSResource createFromParcel(Parcel in) {
      return new RawSMSResource(in);
    }
    public RawSMSResource[] newArray(int size) {
      return new RawSMSResource[size];
    }
  };
}
