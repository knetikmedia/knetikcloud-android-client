...
public class MongoDatabaseConfig implements Parcelable {
  ...
  **/
  ...
  MongoDatabaseConfig(Parcel in) {
    
    dbName = (String)in.readValue(null);
    options = (String)in.readValue(null);
    password = (String)in.readValue(null);
    servers = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<MongoDatabaseConfig> CREATOR = new Parcelable.Creator<MongoDatabaseConfig>() {
    public MongoDatabaseConfig createFromParcel(Parcel in) {
      return new MongoDatabaseConfig(in);
    }
    public MongoDatabaseConfig[] newArray(int size) {
      return new MongoDatabaseConfig[size];
    }
  };
}
