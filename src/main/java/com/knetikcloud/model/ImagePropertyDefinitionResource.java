...
public class ImagePropertyDefinitionResource extends PropertyDefinitionResource implements Parcelable {
  ...
  **/
  ...
  public ImagePropertyDefinitionResource() {
    super();
  }

  ImagePropertyDefinitionResource(Parcel in) {
     super(in); 
  ...
  public static final Parcelable.Creator<ImagePropertyDefinitionResource> CREATOR = new Parcelable.Creator<ImagePropertyDefinitionResource>() {
    public ImagePropertyDefinitionResource createFromParcel(Parcel in) {
      return new ImagePropertyDefinitionResource(in);
    }
    public ImagePropertyDefinitionResource[] newArray(int size) {
      return new ImagePropertyDefinitionResource[size];
    }
  };
}
