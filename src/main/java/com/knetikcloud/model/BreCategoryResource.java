...
public class BreCategoryResource implements Parcelable {
  ...
  **/
  ...
  public BreCategoryResource() {
    super();
  }

  BreCategoryResource(Parcel in) {
  ...
  public static final Parcelable.Creator<BreCategoryResource> CREATOR = new Parcelable.Creator<BreCategoryResource>() {
    public BreCategoryResource createFromParcel(Parcel in) {
      return new BreCategoryResource(in);
    }
    public BreCategoryResource[] newArray(int size) {
      return new BreCategoryResource[size];
    }
  };
}
