...
public class UserActionLog implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(actionDescription);

    out.writeValue(actionName);
  ...
  UserActionLog(Parcel in) {
    
    actionDescription = (String)in.readValue(null);
    actionName = (String)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    details = (Map<String, String>)in.readValue(null);
    id = (String)in.readValue(null);
    requestId = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserActionLog> CREATOR = new Parcelable.Creator<UserActionLog>() {
    public UserActionLog createFromParcel(Parcel in) {
      return new UserActionLog(in);
    }
    public UserActionLog[] newArray(int size) {
      return new UserActionLog[size];
    }
  };
}
