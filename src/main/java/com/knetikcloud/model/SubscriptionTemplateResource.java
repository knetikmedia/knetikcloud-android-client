...
public class SubscriptionTemplateResource implements Parcelable {
  ...
  **/
  ...
  SubscriptionTemplateResource(Parcel in) {
    
    createdDate = (Long)in.readValue(null);
    id = (String)in.readValue(null);
    name = (String)in.readValue(null);
    planTemplate = (TemplateResource)in.readValue(null);
  ...
  public static final Parcelable.Creator<SubscriptionTemplateResource> CREATOR = new Parcelable.Creator<SubscriptionTemplateResource>() {
    public SubscriptionTemplateResource createFromParcel(Parcel in) {
      return new SubscriptionTemplateResource(in);
    }
    public SubscriptionTemplateResource[] newArray(int size) {
      return new SubscriptionTemplateResource[size];
    }
  };
}
