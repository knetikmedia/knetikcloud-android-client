...
public class CartLineItem implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(lineTotal);

    out.writeValue(name);

    out.writeValue(originalLineTotal);
    ...
    out.writeValue(storeItemId);

    out.writeValue(tags);

    out.writeValue(thumbUrl);
  ...
  CartLineItem(Parcel in) {
    
    currencyCode = (String)in.readValue(null);
    description = (String)in.readValue(null);
    discount = (Discount)in.readValue(null);
    lineTotal = (Double)in.readValue(null);
    name = (String)in.readValue(null);
    originalLineTotal = (Double)in.readValue(null);
    ...
    storeItemId = (Integer)in.readValue(null);
    tags = (List<String>)in.readValue(null);
    thumbUrl = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<CartLineItem> CREATOR = new Parcelable.Creator<CartLineItem>() {
