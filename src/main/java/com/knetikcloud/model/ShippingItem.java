...
public class ShippingItem extends StoreItem implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(countries);

    out.writeValue(maxTierTotal);
  ...
  ShippingItem(Parcel in) {
     super(in); 
    countries = (List<String>)in.readValue(null);
    maxTierTotal = (Integer)in.readValue(null);
  ...
  public static final Parcelable.Creator<ShippingItem> CREATOR = new Parcelable.Creator<ShippingItem>() {
