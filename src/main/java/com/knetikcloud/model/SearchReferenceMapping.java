...
public class SearchReferenceMapping implements Parcelable {
  @SerializedName("id")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(refIdField);

    out.writeValue(refType);

    out.writeValue(sourceFieldToDestinationField);

    out.writeValue(type);
  }

  public SearchReferenceMapping() {
    super();
  }

  SearchReferenceMapping(Parcel in) {
    
    id = (String)in.readValue(null);
    refIdField = (String)in.readValue(null);
    refType = (String)in.readValue(null);
    sourceFieldToDestinationField = (Map<String, String>)in.readValue(null);
  ...
  public static final Parcelable.Creator<SearchReferenceMapping> CREATOR = new Parcelable.Creator<SearchReferenceMapping>() {
    public SearchReferenceMapping createFromParcel(Parcel in) {
      return new SearchReferenceMapping(in);
    }
    public SearchReferenceMapping[] newArray(int size) {
      return new SearchReferenceMapping[size];
    }
  };
}
