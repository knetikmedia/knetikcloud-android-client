...
public class LevelingResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(tiers);

    out.writeValue(updatedDate);
  }

  public LevelingResource() {
    super();
  }

  LevelingResource(Parcel in) {
    ...
    tiers = (List<TierResource>)in.readValue(TierResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<LevelingResource> CREATOR = new Parcelable.Creator<LevelingResource>() {
    public LevelingResource createFromParcel(Parcel in) {
      return new LevelingResource(in);
    }
    public LevelingResource[] newArray(int size) {
      return new LevelingResource[size];
    }
  };
}
