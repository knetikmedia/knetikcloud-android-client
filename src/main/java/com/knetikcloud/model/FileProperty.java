...
public class FileProperty extends Property implements Parcelable {
  @SerializedName("crc")
  ...
  **/
  ...
  FileProperty(Parcel in) {
     super(in); 
    crc = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<FileProperty> CREATOR = new Parcelable.Creator<FileProperty>() {
    public FileProperty createFromParcel(Parcel in) {
      return new FileProperty(in);
    }
