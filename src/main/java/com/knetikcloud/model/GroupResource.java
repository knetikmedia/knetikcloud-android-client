...
public class GroupResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(messageOfTheDay);
    ...
    out.writeValue(subMemberCount);

    out.writeValue(template);

    out.writeValue(uniqueName);
  }
  ...
  GroupResource(Parcel in) {
    ...
    messageOfTheDay = (String)in.readValue(null);
    name = (String)in.readValue(null);
    parent = (String)in.readValue(null);
    status = (StatusEnum)in.readValue(null);
    subMemberCount = (Integer)in.readValue(null);
    template = (String)in.readValue(null);
    uniqueName = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<GroupResource> CREATOR = new Parcelable.Creator<GroupResource>() {
    public GroupResource createFromParcel(Parcel in) {
      return new GroupResource(in);
    }
    public GroupResource[] newArray(int size) {
      return new GroupResource[size];
    }
  };
}
