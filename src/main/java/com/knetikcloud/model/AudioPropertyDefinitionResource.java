...
public class AudioPropertyDefinitionResource extends PropertyDefinitionResource implements Parcelable {
   ...
   * @return fileType
  **/
  @ApiModelProperty(example = "null", value = "If provided, a file type the property must match")
   ...
   * @return maxLength
  **/
  @ApiModelProperty(example = "null", value = "If provided, the maximum length of the audio")
   ...
   * @return minLength
  **/
  @ApiModelProperty(example = "null", value = "If provided, the minimum length of the audio")
  ...
  public AudioPropertyDefinitionResource() {
    super();
  }

  AudioPropertyDefinitionResource(Parcel in) {
     super(in); 
  ...
  public static final Parcelable.Creator<AudioPropertyDefinitionResource> CREATOR = new Parcelable.Creator<AudioPropertyDefinitionResource>() {
    public AudioPropertyDefinitionResource createFromParcel(Parcel in) {
      return new AudioPropertyDefinitionResource(in);
    }
    public AudioPropertyDefinitionResource[] newArray(int size) {
      return new AudioPropertyDefinitionResource[size];
    }
  };
}
