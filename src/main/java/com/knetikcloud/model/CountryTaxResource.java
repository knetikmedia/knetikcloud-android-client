...
public class CountryTaxResource implements Parcelable {
  ...
  **/
  ...
  public CountryTaxResource() {
    super();
  }

  CountryTaxResource(Parcel in) {
  ...
  public static final Parcelable.Creator<CountryTaxResource> CREATOR = new Parcelable.Creator<CountryTaxResource>() {
    public CountryTaxResource createFromParcel(Parcel in) {
      return new CountryTaxResource(in);
    }
    public CountryTaxResource[] newArray(int size) {
      return new CountryTaxResource[size];
    }
  };
}
