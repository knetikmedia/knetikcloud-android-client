...
public class TheDefinitionOfAnActivityParametersExDifficultyLevel implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(advancedOption);

    out.writeValue(defaultValue);
  ...
  public TheDefinitionOfAnActivityParametersExDifficultyLevel() {
    super();
  }

  TheDefinitionOfAnActivityParametersExDifficultyLevel(Parcel in) {
    
    advancedOption = (Boolean)in.readValue(null);
    defaultValue = (String)in.readValue(null);
    description = (String)in.readValue(null);
    key = (String)in.readValue(null);
    name = (String)in.readValue(null);
    options = (List<SettingOption>)in.readValue(SettingOption.class.getClassLoader());
  }
  ...
  public static final Parcelable.Creator<TheDefinitionOfAnActivityParametersExDifficultyLevel> CREATOR = new Parcelable.Creator<TheDefinitionOfAnActivityParametersExDifficultyLevel>() {
    public TheDefinitionOfAnActivityParametersExDifficultyLevel createFromParcel(Parcel in) {
      return new TheDefinitionOfAnActivityParametersExDifficultyLevel(in);
    }
    public TheDefinitionOfAnActivityParametersExDifficultyLevel[] newArray(int size) {
      return new TheDefinitionOfAnActivityParametersExDifficultyLevel[size];
    }
  };
}
