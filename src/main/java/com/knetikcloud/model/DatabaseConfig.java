...
public class DatabaseConfig implements Parcelable {
  ...
  **/
  ...
  DatabaseConfig(Parcel in) {
    
    mongo = (MongoDatabaseConfig)in.readValue(null);
    sql = (SqlDatabaseConfig)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<DatabaseConfig> CREATOR = new Parcelable.Creator<DatabaseConfig>() {
    public DatabaseConfig createFromParcel(Parcel in) {
      return new DatabaseConfig(in);
    }
    public DatabaseConfig[] newArray(int size) {
      return new DatabaseConfig[size];
    }
  };
}
