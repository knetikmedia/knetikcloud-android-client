...
public class BreRuleLog implements Parcelable {
  @SerializedName("ran")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(ruleEndDate);

    out.writeValue(ruleId);

    out.writeValue(ruleName);

    out.writeValue(ruleStartDate);
  }
  ...
  BreRuleLog(Parcel in) {
    
    ran = (Boolean)in.readValue(null);
    reason = (String)in.readValue(null);
    ruleEndDate = (Long)in.readValue(null);
    ruleId = (String)in.readValue(null);
    ruleName = (String)in.readValue(null);
    ruleStartDate = (Long)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<BreRuleLog> CREATOR = new Parcelable.Creator<BreRuleLog>() {
    public BreRuleLog createFromParcel(Parcel in) {
      return new BreRuleLog(in);
    }
    public BreRuleLog[] newArray(int size) {
      return new BreRuleLog[size];
    }
  };
}
