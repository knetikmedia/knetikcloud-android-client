...
public class PageResourceGroupResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceGroupResource() {
    super();
  }

  PageResourceGroupResource(Parcel in) {
    
    content = (List<GroupResource>)in.readValue(GroupResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceGroupResource> CREATOR = new Parcelable.Creator<PageResourceGroupResource>() {
    public PageResourceGroupResource createFromParcel(Parcel in) {
      return new PageResourceGroupResource(in);
    }
    public PageResourceGroupResource[] newArray(int size) {
      return new PageResourceGroupResource[size];
    }
  };
}
