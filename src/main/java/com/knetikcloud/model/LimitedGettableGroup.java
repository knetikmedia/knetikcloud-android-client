...
public class LimitedGettableGroup implements Parcelable {
  ...
  **/
   ...
   * @return ownedLimit
  **/
  @ApiModelProperty(example = "null", required = true, value = "The max number of items that can be purchased")
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(activeOnly);

    out.writeValue(name);

    out.writeValue(ownedLimit);
  }

  public LimitedGettableGroup() {
    super();
  }

  LimitedGettableGroup(Parcel in) {
    
    activeOnly = (Boolean)in.readValue(null);
    name = (String)in.readValue(null);
    ownedLimit = (Integer)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<LimitedGettableGroup> CREATOR = new Parcelable.Creator<LimitedGettableGroup>() {
    public LimitedGettableGroup createFromParcel(Parcel in) {
      return new LimitedGettableGroup(in);
    }
    public LimitedGettableGroup[] newArray(int size) {
      return new LimitedGettableGroup[size];
    }
  };
}
