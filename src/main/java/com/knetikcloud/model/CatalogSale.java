...
public class CatalogSale implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(saleEndDate);

    out.writeValue(saleStartDate);
  ...
  public static final Parcelable.Creator<CatalogSale> CREATOR = new Parcelable.Creator<CatalogSale>() {
    public CatalogSale createFromParcel(Parcel in) {
      return new CatalogSale(in);
    }
    public CatalogSale[] newArray(int size) {
      return new CatalogSale[size];
    }
  };
}
