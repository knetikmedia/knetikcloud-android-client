...
public class CartShippableResponse implements Parcelable {
  ...
  **/
  ...
  public CartShippableResponse() {
    super();
  }

  CartShippableResponse(Parcel in) {
    
    cartId = (Integer)in.readValue(null);
  ...
  public static final Parcelable.Creator<CartShippableResponse> CREATOR = new Parcelable.Creator<CartShippableResponse>() {
    public CartShippableResponse createFromParcel(Parcel in) {
      return new CartShippableResponse(in);
    }
    public CartShippableResponse[] newArray(int size) {
      return new CartShippableResponse[size];
    }
  };
}
