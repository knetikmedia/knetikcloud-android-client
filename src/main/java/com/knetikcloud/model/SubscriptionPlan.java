...
public class SubscriptionPlan {
   ...
   */
  @JsonAdapter(FirstBillUnitOfTimeEnum.Adapter.class)
  public enum FirstBillUnitOfTimeEnum {
    ...
    public static class Adapter extends TypeAdapter<FirstBillUnitOfTimeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final FirstBillUnitOfTimeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public FirstBillUnitOfTimeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return FirstBillUnitOfTimeEnum.fromValue(String.valueOf(value));
      }
    }
  }
   ...
   */
  @JsonAdapter(RenewPeriodUnitOfTimeEnum.Adapter.class)
  public enum RenewPeriodUnitOfTimeEnum {
    ...
    public static class Adapter extends TypeAdapter<RenewPeriodUnitOfTimeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RenewPeriodUnitOfTimeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RenewPeriodUnitOfTimeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return RenewPeriodUnitOfTimeEnum.fromValue(String.valueOf(value));
      }
    }
  }
