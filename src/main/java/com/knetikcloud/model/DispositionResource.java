...
public class DispositionResource implements Parcelable {
  ...
  **/
  ...
  public DispositionResource() {
    super();
  }

  DispositionResource(Parcel in) {
  ...
  public static final Parcelable.Creator<DispositionResource> CREATOR = new Parcelable.Creator<DispositionResource>() {
    public DispositionResource createFromParcel(Parcel in) {
      return new DispositionResource(in);
    }
    public DispositionResource[] newArray(int size) {
      return new DispositionResource[size];
    }
  };
}
