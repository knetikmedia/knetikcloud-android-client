...
public class InventorySubscriptionResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(billDate);

    out.writeValue(credit);

    out.writeValue(creditLog);

    out.writeValue(graceEnd);

    out.writeValue(inventoryId);

    out.writeValue(inventoryStatus);

    out.writeValue(itemId);

    out.writeValue(paymentMethod);

    out.writeValue(recurringPrice);

    out.writeValue(sku);

    out.writeValue(startDate);

    out.writeValue(subscriptionStatus);

    out.writeValue(user);
  }

  public InventorySubscriptionResource() {
    super();
  }

  InventorySubscriptionResource(Parcel in) {
    
    billDate = (Long)in.readValue(null);
    credit = (Double)in.readValue(null);
    creditLog = (List<SubscriptionCreditResource>)in.readValue(SubscriptionCreditResource.class.getClassLoader());
    graceEnd = (Long)in.readValue(null);
    inventoryId = (Integer)in.readValue(null);
    inventoryStatus = (InventoryStatusEnum)in.readValue(null);
    itemId = (Integer)in.readValue(null);
    paymentMethod = (PaymentMethodResource)in.readValue(null);
    recurringPrice = (Double)in.readValue(null);
    sku = (String)in.readValue(null);
    startDate = (Long)in.readValue(null);
    subscriptionStatus = (Integer)in.readValue(null);
  ...
  public static final Parcelable.Creator<InventorySubscriptionResource> CREATOR = new Parcelable.Creator<InventorySubscriptionResource>() {
    public InventorySubscriptionResource createFromParcel(Parcel in) {
      return new InventorySubscriptionResource(in);
    }
    public InventorySubscriptionResource[] newArray(int size) {
      return new InventorySubscriptionResource[size];
    }
  };
}
