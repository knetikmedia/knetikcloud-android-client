...
public class RewardItemResource implements Parcelable {
  ...
  **/
  ...
  public RewardItemResource() {
    super();
  }

  RewardItemResource(Parcel in) {
  ...
  public static final Parcelable.Creator<RewardItemResource> CREATOR = new Parcelable.Creator<RewardItemResource>() {
    public RewardItemResource createFromParcel(Parcel in) {
      return new RewardItemResource(in);
    }
    public RewardItemResource[] newArray(int size) {
      return new RewardItemResource[size];
    }
  };
}
