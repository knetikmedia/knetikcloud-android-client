...
public class UsernameLookupResource {
  ...
  public boolean equals(Object o) {
    ...
    return (this.lookupKey == null ? usernameLookupResource.lookupKey == null : this.lookupKey.equals(usernameLookupResource.lookupKey)) &&
        (this.type == null ? usernameLookupResource.type == null : this.type.equals(usernameLookupResource.type)) &&
        (this.valueType == null ? usernameLookupResource.valueType == null : this.valueType.equals(usernameLookupResource.valueType));
  }
