...
public class SavedAddressResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(phone1);

    out.writeValue(phone2);
  ...
  public SavedAddressResource() {
    super();
  }

  SavedAddressResource(Parcel in) {
  ...
  public static final Parcelable.Creator<SavedAddressResource> CREATOR = new Parcelable.Creator<SavedAddressResource>() {
    public SavedAddressResource createFromParcel(Parcel in) {
      return new SavedAddressResource(in);
    }
    public SavedAddressResource[] newArray(int size) {
      return new SavedAddressResource[size];
    }
  };
}
