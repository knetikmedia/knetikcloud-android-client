...
public class SqlDatabaseConfig implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(connectionPoolSize);

    out.writeValue(connectionString);

    out.writeValue(dbName);
  ...
  SqlDatabaseConfig(Parcel in) {
    
    connectionPoolSize = (Integer)in.readValue(null);
    connectionString = (String)in.readValue(null);
    dbName = (String)in.readValue(null);
    hostname = (String)in.readValue(null);
    password = (String)in.readValue(null);
    port = (Integer)in.readValue(null);
  ...
  public static final Parcelable.Creator<SqlDatabaseConfig> CREATOR = new Parcelable.Creator<SqlDatabaseConfig>() {
    public SqlDatabaseConfig createFromParcel(Parcel in) {
      return new SqlDatabaseConfig(in);
    }
    public SqlDatabaseConfig[] newArray(int size) {
      return new SqlDatabaseConfig[size];
    }
  };
}
