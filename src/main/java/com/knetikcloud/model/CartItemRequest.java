...
public class CartItemRequest implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(affiliateKey);

    out.writeValue(catalogSku);

    out.writeValue(priceOverride);
  ...
  CartItemRequest(Parcel in) {
    
    affiliateKey = (String)in.readValue(null);
    catalogSku = (String)in.readValue(null);
    priceOverride = (Double)in.readValue(null);
  ...
  public static final Parcelable.Creator<CartItemRequest> CREATOR = new Parcelable.Creator<CartItemRequest>() {
    public CartItemRequest createFromParcel(Parcel in) {
      return new CartItemRequest(in);
    }
    public CartItemRequest[] newArray(int size) {
      return new CartItemRequest[size];
    }
  };
}
