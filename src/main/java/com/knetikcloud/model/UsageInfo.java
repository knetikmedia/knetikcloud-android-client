...
public class UsageInfo implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<UsageInfo> CREATOR = new Parcelable.Creator<UsageInfo>() {
    public UsageInfo createFromParcel(Parcel in) {
      return new UsageInfo(in);
    }
    public UsageInfo[] newArray(int size) {
      return new UsageInfo[size];
    }
  };
}
