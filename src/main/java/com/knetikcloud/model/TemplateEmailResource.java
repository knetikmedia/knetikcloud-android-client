...
public class TemplateEmailResource implements Parcelable {
  @SerializedName("from")
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(recipients);

    out.writeValue(templateKey);

    out.writeValue(templateVars);
  }

  public TemplateEmailResource() {
    super();
  }

  TemplateEmailResource(Parcel in) {
    
    from = (String)in.readValue(null);
    recipients = (List<Integer>)in.readValue(null);
    templateKey = (String)in.readValue(null);
    templateVars = (List<KeyValuePairstringstring>)in.readValue(KeyValuePairstringstring.class.getClassLoader());
  }
  ...
  public static final Parcelable.Creator<TemplateEmailResource> CREATOR = new Parcelable.Creator<TemplateEmailResource>() {
    public TemplateEmailResource createFromParcel(Parcel in) {
      return new TemplateEmailResource(in);
    }
    public TemplateEmailResource[] newArray(int size) {
      return new TemplateEmailResource[size];
    }
  };
}
