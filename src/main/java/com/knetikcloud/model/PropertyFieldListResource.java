...
public class PropertyFieldListResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(propertyDefinitionFields);

    out.writeValue(propertyFields);

    out.writeValue(propertyType);
  }

  public PropertyFieldListResource() {
    super();
  }

  PropertyFieldListResource(Parcel in) {
    
    propertyDefinitionFields = (List<PropertyFieldResource>)in.readValue(PropertyFieldResource.class.getClassLoader());
    propertyFields = (List<PropertyFieldResource>)in.readValue(PropertyFieldResource.class.getClassLoader());
    propertyType = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<PropertyFieldListResource> CREATOR = new Parcelable.Creator<PropertyFieldListResource>() {
    public PropertyFieldListResource createFromParcel(Parcel in) {
      return new PropertyFieldListResource(in);
    }
    public PropertyFieldListResource[] newArray(int size) {
      return new PropertyFieldListResource[size];
    }
  };
}
