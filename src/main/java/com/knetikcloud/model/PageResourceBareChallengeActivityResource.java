...
public class PageResourceBareChallengeActivityResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceBareChallengeActivityResource() {
    super();
  }

  PageResourceBareChallengeActivityResource(Parcel in) {
    
    content = (List<BareChallengeActivityResource>)in.readValue(BareChallengeActivityResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceBareChallengeActivityResource> CREATOR = new Parcelable.Creator<PageResourceBareChallengeActivityResource>() {
    public PageResourceBareChallengeActivityResource createFromParcel(Parcel in) {
      return new PageResourceBareChallengeActivityResource(in);
    }
    public PageResourceBareChallengeActivityResource[] newArray(int size) {
      return new PageResourceBareChallengeActivityResource[size];
    }
  };
}
