...
public class BatchRequest implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<BatchRequest> CREATOR = new Parcelable.Creator<BatchRequest>() {
    public BatchRequest createFromParcel(Parcel in) {
      return new BatchRequest(in);
    }
