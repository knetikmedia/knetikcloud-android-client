...
public class PageResourceEntitlementItem implements Parcelable {
  ...
  **/
  ...
  public PageResourceEntitlementItem() {
    super();
  }

  PageResourceEntitlementItem(Parcel in) {
    
    content = (List<EntitlementItem>)in.readValue(EntitlementItem.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceEntitlementItem> CREATOR = new Parcelable.Creator<PageResourceEntitlementItem>() {
    public PageResourceEntitlementItem createFromParcel(Parcel in) {
      return new PageResourceEntitlementItem(in);
    }
    public PageResourceEntitlementItem[] newArray(int size) {
      return new PageResourceEntitlementItem[size];
    }
  };
}
