...
public class UserBaseResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<UserBaseResource> CREATOR = new Parcelable.Creator<UserBaseResource>() {
    public UserBaseResource createFromParcel(Parcel in) {
      return new UserBaseResource(in);
    }
    public UserBaseResource[] newArray(int size) {
      return new UserBaseResource[size];
    }
  };
}
