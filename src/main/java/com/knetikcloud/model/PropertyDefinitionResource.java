...
public class PropertyDefinitionResource implements Parcelable {
  ...
  **/
  ...
  PropertyDefinitionResource(Parcel in) {
    
    fieldList = (PropertyFieldListResource)in.readValue(null);
  ...
  public static final Parcelable.Creator<PropertyDefinitionResource> CREATOR = new Parcelable.Creator<PropertyDefinitionResource>() {
    public PropertyDefinitionResource createFromParcel(Parcel in) {
      return new PropertyDefinitionResource(in);
    }
    public PropertyDefinitionResource[] newArray(int size) {
      return new PropertyDefinitionResource[size];
    }
  };
}
