...
public class StoreItemTemplateResource implements Parcelable {
  ...
  **/
  ...
  StoreItemTemplateResource(Parcel in) {
    
    behaviors = (List<ItemBehaviorDefinitionResource>)in.readValue(ItemBehaviorDefinitionResource.class.getClassLoader());
    ...
    skuTemplate = (TemplateResource)in.readValue(null);
  ...
  public static final Parcelable.Creator<StoreItemTemplateResource> CREATOR = new Parcelable.Creator<StoreItemTemplateResource>() {
    public StoreItemTemplateResource createFromParcel(Parcel in) {
      return new StoreItemTemplateResource(in);
    }
    public StoreItemTemplateResource[] newArray(int size) {
      return new StoreItemTemplateResource[size];
    }
  };
}
