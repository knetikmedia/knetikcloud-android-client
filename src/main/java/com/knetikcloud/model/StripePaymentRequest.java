...
public class StripePaymentRequest implements Parcelable {
  ...
  **/
  ...
  StripePaymentRequest(Parcel in) {
  ...
  public static final Parcelable.Creator<StripePaymentRequest> CREATOR = new Parcelable.Creator<StripePaymentRequest>() {
    public StripePaymentRequest createFromParcel(Parcel in) {
      return new StripePaymentRequest(in);
    }
    public StripePaymentRequest[] newArray(int size) {
      return new StripePaymentRequest[size];
    }
  };
}
