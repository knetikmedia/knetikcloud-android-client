...
public class LookupResource {
  ...
  public boolean equals(Object o) {
    ...
    return (this.lookupKey == null ? lookupResource.lookupKey == null : this.lookupKey.equals(lookupResource.lookupKey)) &&
        (this.type == null ? lookupResource.type == null : this.type.equals(lookupResource.type)) &&
        (this.valueType == null ? lookupResource.valueType == null : this.valueType.equals(lookupResource.valueType));
  }
