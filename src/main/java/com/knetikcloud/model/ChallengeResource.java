...
public class ChallengeResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(activities);

    out.writeValue(additionalProperties);

    out.writeValue(campaignId);

    out.writeValue(copyOf);
    ...
    out.writeValue(leaderboardStrategy);

    out.writeValue(longDescription);

    out.writeValue(name);

    out.writeValue(nextEventDate);

    out.writeValue(rewardLagMinutes);

    out.writeValue(rewardSet);

    out.writeValue(schedule);
  ...
  ChallengeResource(Parcel in) {
    
    activities = (Integer)in.readValue(null);
    additionalProperties = (Map<String, Property>)in.readValue(Property.class.getClassLoader());
    campaignId = (Long)in.readValue(null);
    copyOf = (Long)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    endDate = (Long)in.readValue(null);
    id = (Long)in.readValue(null);
    leaderboardStrategy = (String)in.readValue(null);
    longDescription = (String)in.readValue(null);
    name = (String)in.readValue(null);
    nextEventDate = (Long)in.readValue(null);
    rewardLagMinutes = (Integer)in.readValue(null);
    rewardSet = (RewardSetResource)in.readValue(null);
    schedule = (Schedule)in.readValue(null);
  ...
  public static final Parcelable.Creator<ChallengeResource> CREATOR = new Parcelable.Creator<ChallengeResource>() {
    public ChallengeResource createFromParcel(Parcel in) {
      return new ChallengeResource(in);
    }
    public ChallengeResource[] newArray(int size) {
      return new ChallengeResource[size];
    }
  };
}
