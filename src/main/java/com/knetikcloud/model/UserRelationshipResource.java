...
public class UserRelationshipResource implements Parcelable {
  ...
  **/
  ...
  public UserRelationshipResource() {
    super();
  }

  UserRelationshipResource(Parcel in) {
    
    child = (SimpleUserResource)in.readValue(null);
    context = (String)in.readValue(null);
    id = (Long)in.readValue(null);
    parent = (SimpleUserResource)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<UserRelationshipResource> CREATOR = new Parcelable.Creator<UserRelationshipResource>() {
    public UserRelationshipResource createFromParcel(Parcel in) {
      return new UserRelationshipResource(in);
    }
    public UserRelationshipResource[] newArray(int size) {
      return new UserRelationshipResource[size];
    }
  };
}
