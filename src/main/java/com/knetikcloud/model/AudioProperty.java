...
public class AudioProperty extends FileProperty {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? audioProperty.type == null : this.type.equals(audioProperty.type)) &&
        (this.crc == null ? audioProperty.crc == null : this.crc.equals(audioProperty.crc)) &&
        (this.description == null ? audioProperty.description == null : this.description.equals(audioProperty.description)) &&
        (this.fileType == null ? audioProperty.fileType == null : this.fileType.equals(audioProperty.fileType)) &&
        (this.url == null ? audioProperty.url == null : this.url.equals(audioProperty.url));
  }
