...
public class BreEvent implements Parcelable {
  ...
  **/
  ...
  BreEvent(Parcel in) {
    ...
    params = (Object)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<BreEvent> CREATOR = new Parcelable.Creator<BreEvent>() {
    public BreEvent createFromParcel(Parcel in) {
      return new BreEvent(in);
    }
    public BreEvent[] newArray(int size) {
      return new BreEvent[size];
    }
  };
}
