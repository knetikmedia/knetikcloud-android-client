...
public class CampaignResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(nextChallenge);

    out.writeValue(nextChallengeDate);
  ...
  CampaignResource(Parcel in) {
    ...
    nextChallenge = (String)in.readValue(null);
    nextChallengeDate = (Long)in.readValue(null);
  ...
  public static final Parcelable.Creator<CampaignResource> CREATOR = new Parcelable.Creator<CampaignResource>() {
    public CampaignResource createFromParcel(Parcel in) {
      return new CampaignResource(in);
    }
    public CampaignResource[] newArray(int size) {
      return new CampaignResource[size];
    }
  };
}
