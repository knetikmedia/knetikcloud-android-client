...
public class OptimalPaymentRequest implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(onDecline);

    out.writeValue(onError);

    out.writeValue(onSuccess);
  }

  public OptimalPaymentRequest() {
    super();
  }

  OptimalPaymentRequest(Parcel in) {
    ...
    onDecline = (String)in.readValue(null);
    onError = (String)in.readValue(null);
    onSuccess = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<OptimalPaymentRequest> CREATOR = new Parcelable.Creator<OptimalPaymentRequest>() {
    public OptimalPaymentRequest createFromParcel(Parcel in) {
      return new OptimalPaymentRequest(in);
    }
    public OptimalPaymentRequest[] newArray(int size) {
      return new OptimalPaymentRequest[size];
    }
  };
}
