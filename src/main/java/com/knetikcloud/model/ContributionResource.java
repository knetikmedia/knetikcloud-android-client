...
public class ContributionResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(artist);

    out.writeValue(media);
  ...
  ContributionResource(Parcel in) {
    
    artist = (SimpleReferenceResourcelong)in.readValue(null);
    media = (SimpleReferenceResourcelong)in.readValue(null);
  ...
  public static final Parcelable.Creator<ContributionResource> CREATOR = new Parcelable.Creator<ContributionResource>() {
    public ContributionResource createFromParcel(Parcel in) {
      return new ContributionResource(in);
    }
    public ContributionResource[] newArray(int size) {
      return new ContributionResource[size];
    }
  };
}
