...
public class LookupTypeResource implements Parcelable {
  ...
  **/
  ...
  public LookupTypeResource() {
    super();
  }

  LookupTypeResource(Parcel in) {
    
    description = (String)in.readValue(null);
    keyType = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<LookupTypeResource> CREATOR = new Parcelable.Creator<LookupTypeResource>() {
    public LookupTypeResource createFromParcel(Parcel in) {
      return new LookupTypeResource(in);
    }
    public LookupTypeResource[] newArray(int size) {
      return new LookupTypeResource[size];
    }
  };
}
