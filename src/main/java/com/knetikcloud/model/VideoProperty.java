...
public class VideoProperty extends FileProperty {
  ...
  public boolean equals(Object o) {
    ...
    return (this.type == null ? videoProperty.type == null : this.type.equals(videoProperty.type)) &&
        (this.crc == null ? videoProperty.crc == null : this.crc.equals(videoProperty.crc)) &&
        (this.description == null ? videoProperty.description == null : this.description.equals(videoProperty.description)) &&
        (this.fileType == null ? videoProperty.fileType == null : this.fileType.equals(videoProperty.fileType)) &&
        (this.url == null ? videoProperty.url == null : this.url.equals(videoProperty.url));
  }
