...
public class TemplateResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<TemplateResource> CREATOR = new Parcelable.Creator<TemplateResource>() {
    public TemplateResource createFromParcel(Parcel in) {
      return new TemplateResource(in);
    }
    public TemplateResource[] newArray(int size) {
      return new TemplateResource[size];
    }
  };
}
