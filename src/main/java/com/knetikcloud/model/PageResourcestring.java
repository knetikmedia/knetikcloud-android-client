...
public class PageResourcestring implements Parcelable {
  ...
  **/
  ...
  public PageResourcestring() {
    super();
  }

  PageResourcestring(Parcel in) {
    
    content = (List<String>)in.readValue(null);
  ...
  public static final Parcelable.Creator<PageResourcestring> CREATOR = new Parcelable.Creator<PageResourcestring>() {
    public PageResourcestring createFromParcel(Parcel in) {
      return new PageResourcestring(in);
    }
    public PageResourcestring[] newArray(int size) {
      return new PageResourcestring[size];
    }
  };
}
