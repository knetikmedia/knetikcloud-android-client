...
public class PermissionResource implements Parcelable {
  ...
  **/
  ...
  PermissionResource(Parcel in) {
    ...
    permission = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<PermissionResource> CREATOR = new Parcelable.Creator<PermissionResource>() {
    public PermissionResource createFromParcel(Parcel in) {
      return new PermissionResource(in);
    }
    public PermissionResource[] newArray(int size) {
      return new PermissionResource[size];
    }
  };
}
