...
public class SkuRequest implements Parcelable {
  @SerializedName("sku")
  ...
  **/
  ...
  public static final Parcelable.Creator<SkuRequest> CREATOR = new Parcelable.Creator<SkuRequest>() {
    public SkuRequest createFromParcel(Parcel in) {
      return new SkuRequest(in);
    }
    public SkuRequest[] newArray(int size) {
      return new SkuRequest[size];
    }
  };
}
