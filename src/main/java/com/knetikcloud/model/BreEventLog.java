...
public class BreEventLog implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(eventStartDate);

    out.writeValue(id);

    out.writeValue(parameters);

    out.writeValue(rules);
  }
  ...
  BreEventLog(Parcel in) {
    
    customer = (String)in.readValue(null);
    eventId = (String)in.readValue(null);
    eventName = (String)in.readValue(null);
    eventStartDate = (Long)in.readValue(null);
    id = (String)in.readValue(null);
    parameters = (Object)in.readValue(null);
    rules = (List<BreRuleLog>)in.readValue(BreRuleLog.class.getClassLoader());
  }
  ...
  public static final Parcelable.Creator<BreEventLog> CREATOR = new Parcelable.Creator<BreEventLog>() {
    public BreEventLog createFromParcel(Parcel in) {
      return new BreEventLog(in);
    }
    public BreEventLog[] newArray(int size) {
      return new BreEventLog[size];
    }
  };
}
