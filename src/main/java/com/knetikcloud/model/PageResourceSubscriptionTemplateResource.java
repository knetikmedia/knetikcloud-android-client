...
public class PageResourceSubscriptionTemplateResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceSubscriptionTemplateResource() {
    super();
  }

  PageResourceSubscriptionTemplateResource(Parcel in) {
    
    content = (List<SubscriptionTemplateResource>)in.readValue(SubscriptionTemplateResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceSubscriptionTemplateResource> CREATOR = new Parcelable.Creator<PageResourceSubscriptionTemplateResource>() {
    public PageResourceSubscriptionTemplateResource createFromParcel(Parcel in) {
      return new PageResourceSubscriptionTemplateResource(in);
    }
    public PageResourceSubscriptionTemplateResource[] newArray(int size) {
      return new PageResourceSubscriptionTemplateResource[size];
    }
  };
}
