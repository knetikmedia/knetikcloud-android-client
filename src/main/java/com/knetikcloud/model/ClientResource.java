...
public class ClientResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(accessTokenValiditySeconds);

    out.writeValue(clientKey);

    out.writeValue(grantTypes);

    out.writeValue(id);

    out.writeValue(isPublic);

    out.writeValue(locked);

    out.writeValue(name);

    out.writeValue(redirectUris);

    out.writeValue(refreshTokenValiditySeconds);
  ...
  ClientResource(Parcel in) {
    
    accessTokenValiditySeconds = (Integer)in.readValue(null);
    clientKey = (String)in.readValue(null);
    grantTypes = (List<String>)in.readValue(null);
    id = (Integer)in.readValue(null);
    isPublic = (Boolean)in.readValue(null);
    locked = (Boolean)in.readValue(null);
    name = (String)in.readValue(null);
    redirectUris = (List<String>)in.readValue(null);
    refreshTokenValiditySeconds = (Integer)in.readValue(null);
  ...
  public static final Parcelable.Creator<ClientResource> CREATOR = new Parcelable.Creator<ClientResource>() {
    public ClientResource createFromParcel(Parcel in) {
      return new ClientResource(in);
    }
    public ClientResource[] newArray(int size) {
      return new ClientResource[size];
    }
  };
}
