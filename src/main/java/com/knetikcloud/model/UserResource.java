...
public class UserResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(avatarUrl);

    out.writeValue(children);
    ...
    out.writeValue(dateOfBirth);

    out.writeValue(description);

    out.writeValue(displayName);
    ...
    out.writeValue(languageCode);

    out.writeValue(lastName);

    out.writeValue(lastUpdated);

    out.writeValue(memberSince);

    out.writeValue(mobileNumber);

    out.writeValue(parents);

    out.writeValue(password);

    out.writeValue(postalCode);
  ...
  UserResource(Parcel in) {
    ...
    avatarUrl = (String)in.readValue(null);
    children = (List<UserRelationshipReferenceResource>)in.readValue(UserRelationshipReferenceResource.class.getClassLoader());
    city = (String)in.readValue(null);
    countryCode = (String)in.readValue(null);
    currencyCode = (String)in.readValue(null);
    dateOfBirth = (Long)in.readValue(null);
    ...
    languageCode = (String)in.readValue(null);
    lastName = (String)in.readValue(null);
    lastUpdated = (Long)in.readValue(null);
    memberSince = (Long)in.readValue(null);
    mobileNumber = (String)in.readValue(null);
    parents = (List<UserRelationshipReferenceResource>)in.readValue(UserRelationshipReferenceResource.class.getClassLoader());
    password = (String)in.readValue(null);
    postalCode = (String)in.readValue(null);
    state = (String)in.readValue(null);
    tags = (List<String>)in.readValue(null);
    template = (String)in.readValue(null);
    timezoneCode = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserResource> CREATOR = new Parcelable.Creator<UserResource>() {
    public UserResource createFromParcel(Parcel in) {
      return new UserResource(in);
    }
    public UserResource[] newArray(int size) {
      return new UserResource[size];
    }
  };
}
