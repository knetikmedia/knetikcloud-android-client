...
public class VendorEmailLookupResource {
  ...
  public boolean equals(Object o) {
    ...
    return (this.lookupKey == null ? vendorEmailLookupResource.lookupKey == null : this.lookupKey.equals(vendorEmailLookupResource.lookupKey)) &&
        (this.type == null ? vendorEmailLookupResource.type == null : this.type.equals(vendorEmailLookupResource.type)) &&
        (this.valueType == null ? vendorEmailLookupResource.valueType == null : this.valueType.equals(vendorEmailLookupResource.valueType));
  }
