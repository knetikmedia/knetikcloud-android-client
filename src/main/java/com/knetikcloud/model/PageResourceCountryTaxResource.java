...
public class PageResourceCountryTaxResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceCountryTaxResource() {
    super();
  }

  PageResourceCountryTaxResource(Parcel in) {
    
    content = (List<CountryTaxResource>)in.readValue(CountryTaxResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceCountryTaxResource> CREATOR = new Parcelable.Creator<PageResourceCountryTaxResource>() {
    public PageResourceCountryTaxResource createFromParcel(Parcel in) {
      return new PageResourceCountryTaxResource(in);
    }
    public PageResourceCountryTaxResource[] newArray(int size) {
      return new PageResourceCountryTaxResource[size];
    }
  };
}
