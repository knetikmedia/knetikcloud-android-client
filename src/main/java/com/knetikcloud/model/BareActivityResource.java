...
public class BareActivityResource implements Parcelable {
  ...
  **/
  ...
  public BareActivityResource() {
    super();
  }

  BareActivityResource(Parcel in) {
  ...
  public static final Parcelable.Creator<BareActivityResource> CREATOR = new Parcelable.Creator<BareActivityResource>() {
    public BareActivityResource createFromParcel(Parcel in) {
      return new BareActivityResource(in);
    }
    public BareActivityResource[] newArray(int size) {
      return new BareActivityResource[size];
    }
  };
}
