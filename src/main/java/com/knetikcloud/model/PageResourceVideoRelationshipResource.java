...
public class PageResourceVideoRelationshipResource implements Parcelable {
  ...
  **/
  ...
  PageResourceVideoRelationshipResource(Parcel in) {
    
    content = (List<VideoRelationshipResource>)in.readValue(VideoRelationshipResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceVideoRelationshipResource> CREATOR = new Parcelable.Creator<PageResourceVideoRelationshipResource>() {
    public PageResourceVideoRelationshipResource createFromParcel(Parcel in) {
      return new PageResourceVideoRelationshipResource(in);
    }
    public PageResourceVideoRelationshipResource[] newArray(int size) {
      return new PageResourceVideoRelationshipResource[size];
    }
  };
}
