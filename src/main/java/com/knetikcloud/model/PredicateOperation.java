...
public class PredicateOperation implements Parcelable {
  @SerializedName("args")
  ...
  **/
  ...
  PredicateOperation(Parcel in) {
    
    args = (List<Expressionobject>)in.readValue(Expressionobject.class.getClassLoader());
    operator = (Operator)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<PredicateOperation> CREATOR = new Parcelable.Creator<PredicateOperation>() {
    public PredicateOperation createFromParcel(Parcel in) {
      return new PredicateOperation(in);
    }
    public PredicateOperation[] newArray(int size) {
      return new PredicateOperation[size];
    }
  };
}
