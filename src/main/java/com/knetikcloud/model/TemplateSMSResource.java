...
public class TemplateSMSResource implements Parcelable {
  @SerializedName("from")
  ...
  **/
  ...
  public TemplateSMSResource() {
    super();
  }

  TemplateSMSResource(Parcel in) {
    
    from = (String)in.readValue(null);
    localizer = (Localizer)in.readValue(null);
    recipients = (List<Integer>)in.readValue(null);
    templateKey = (String)in.readValue(null);
    templateVars = (List<String>)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<TemplateSMSResource> CREATOR = new Parcelable.Creator<TemplateSMSResource>() {
    public TemplateSMSResource createFromParcel(Parcel in) {
      return new TemplateSMSResource(in);
    }
    public TemplateSMSResource[] newArray(int size) {
      return new TemplateSMSResource[size];
    }
  };
}
