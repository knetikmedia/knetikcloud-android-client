...
public class CommentSearch implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(ownerId);

    out.writeValue(ownerUsername);
  }
  ...
  CommentSearch(Parcel in) {
    
    content = (String)in.readValue(null);
    context = (String)in.readValue(null);
    contextId = (Integer)in.readValue(null);
    id = (Long)in.readValue(null);
    ownerId = (Integer)in.readValue(null);
    ownerUsername = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<CommentSearch> CREATOR = new Parcelable.Creator<CommentSearch>() {
    public CommentSearch createFromParcel(Parcel in) {
      return new CommentSearch(in);
    }
    public CommentSearch[] newArray(int size) {
      return new CommentSearch[size];
    }
  };
}
