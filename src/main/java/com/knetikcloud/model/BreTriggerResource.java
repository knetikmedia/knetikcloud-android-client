...
public class BreTriggerResource implements Parcelable {
  /**
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(systemTrigger);

    out.writeValue(tags);

    out.writeValue(triggerDescription);

    out.writeValue(triggerName);
  }

  public BreTriggerResource() {
    super();
  }

  BreTriggerResource(Parcel in) {
    
    category = (CategoryEnum)in.readValue(null);
    eventName = (String)in.readValue(null);
    parameters = (List<BreTriggerParameterDefinition>)in.readValue(BreTriggerParameterDefinition.class.getClassLoader());
    systemTrigger = (Boolean)in.readValue(null);
    tags = (List<String>)in.readValue(null);
    triggerDescription = (String)in.readValue(null);
    triggerName = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<BreTriggerResource> CREATOR = new Parcelable.Creator<BreTriggerResource>() {
    public BreTriggerResource createFromParcel(Parcel in) {
      return new BreTriggerResource(in);
    }
    public BreTriggerResource[] newArray(int size) {
      return new BreTriggerResource[size];
    }
  };
}
