...
public class FulfillmentType implements Parcelable {
  ...
  **/
  ...
  FulfillmentType(Parcel in) {
    
    core = (Boolean)in.readValue(null);
  ...
  public static final Parcelable.Creator<FulfillmentType> CREATOR = new Parcelable.Creator<FulfillmentType>() {
    public FulfillmentType createFromParcel(Parcel in) {
      return new FulfillmentType(in);
    }
    public FulfillmentType[] newArray(int size) {
      return new FulfillmentType[size];
    }
  };
}
