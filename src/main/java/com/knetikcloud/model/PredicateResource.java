...
public class PredicateResource implements Parcelable {
  @SerializedName("args")
  ...
  **/
  ...
  public static final Parcelable.Creator<PredicateResource> CREATOR = new Parcelable.Creator<PredicateResource>() {
    public PredicateResource createFromParcel(Parcel in) {
      return new PredicateResource(in);
    }
    public PredicateResource[] newArray(int size) {
      return new PredicateResource[size];
    }
  };
}
