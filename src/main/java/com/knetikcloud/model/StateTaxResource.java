...
public class StateTaxResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(countryIso3);

    out.writeValue(federallyExempt);

    out.writeValue(name);

    out.writeValue(rate);

    out.writeValue(stateCode);

    out.writeValue(taxShipping);
  }

  public StateTaxResource() {
    super();
  }

  StateTaxResource(Parcel in) {
    
    countryIso3 = (String)in.readValue(null);
    federallyExempt = (Boolean)in.readValue(null);
    name = (String)in.readValue(null);
    rate = (Double)in.readValue(null);
    stateCode = (String)in.readValue(null);
    taxShipping = (Boolean)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<StateTaxResource> CREATOR = new Parcelable.Creator<StateTaxResource>() {
    public StateTaxResource createFromParcel(Parcel in) {
      return new StateTaxResource(in);
    }
    public StateTaxResource[] newArray(int size) {
      return new StateTaxResource[size];
    }
  };
}
