...
public class UserInventoryResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(behaviorData);

    out.writeValue(createdDate);

    out.writeValue(expires);
  ...
  public UserInventoryResource() {
    super();
  }

  UserInventoryResource(Parcel in) {
    
    behaviorData = (Object)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    expires = (Long)in.readValue(null);
    ...
    itemTypeHint = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserInventoryResource> CREATOR = new Parcelable.Creator<UserInventoryResource>() {
    public UserInventoryResource createFromParcel(Parcel in) {
      return new UserInventoryResource(in);
    }
    public UserInventoryResource[] newArray(int size) {
      return new UserInventoryResource[size];
    }
  };
}
