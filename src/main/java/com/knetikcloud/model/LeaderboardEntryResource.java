...
public class LeaderboardEntryResource implements Parcelable {
  @SerializedName("rank")
  ...
  **/
  ...
  LeaderboardEntryResource(Parcel in) {
  ...
  public static final Parcelable.Creator<LeaderboardEntryResource> CREATOR = new Parcelable.Creator<LeaderboardEntryResource>() {
    public LeaderboardEntryResource createFromParcel(Parcel in) {
      return new LeaderboardEntryResource(in);
    }
    public LeaderboardEntryResource[] newArray(int size) {
      return new LeaderboardEntryResource[size];
    }
  };
}
