...
public class BillingReport implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(lastKnownFailures);

    out.writeValue(statistics);
  }
  ...
  BillingReport(Parcel in) {
    
    created = (Long)in.readValue(null);
    id = (String)in.readValue(null);
    lastKnownFailures = (List<String>)in.readValue(null);
    statistics = (Map<String, Integer>)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<BillingReport> CREATOR = new Parcelable.Creator<BillingReport>() {
    public BillingReport createFromParcel(Parcel in) {
      return new BillingReport(in);
    }
    public BillingReport[] newArray(int size) {
      return new BillingReport[size];
    }
  };
}
