...
public class GroupMemberResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<GroupMemberResource> CREATOR = new Parcelable.Creator<GroupMemberResource>() {
    public GroupMemberResource createFromParcel(Parcel in) {
      return new GroupMemberResource(in);
    }
    public GroupMemberResource[] newArray(int size) {
      return new GroupMemberResource[size];
    }
  };
}
