...
public class UserAchievementGroupResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(achievements);

    out.writeValue(groupName);
  ...
  public UserAchievementGroupResource() {
    super();
  }

  UserAchievementGroupResource(Parcel in) {
    
    achievements = (List<UserAchievementResource>)in.readValue(UserAchievementResource.class.getClassLoader());
    groupName = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserAchievementGroupResource> CREATOR = new Parcelable.Creator<UserAchievementGroupResource>() {
    public UserAchievementGroupResource createFromParcel(Parcel in) {
      return new UserAchievementGroupResource(in);
    }
    public UserAchievementGroupResource[] newArray(int size) {
      return new UserAchievementGroupResource[size];
    }
  };
}
