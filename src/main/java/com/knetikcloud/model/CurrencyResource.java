...
public class CurrencyResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<CurrencyResource> CREATOR = new Parcelable.Creator<CurrencyResource>() {
    public CurrencyResource createFromParcel(Parcel in) {
      return new CurrencyResource(in);
    }
    public CurrencyResource[] newArray(int size) {
      return new CurrencyResource[size];
    }
  };
}
