...
public class UserAchievementResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(achieved);

    out.writeValue(achievementName);

    out.writeValue(createdDate);

    out.writeValue(earnedDate);

    out.writeValue(updatedDate);
  }

  public UserAchievementResource() {
    super();
  }

  UserAchievementResource(Parcel in) {
    
    achieved = (Boolean)in.readValue(null);
    achievementName = (String)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    earnedDate = (Long)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserAchievementResource> CREATOR = new Parcelable.Creator<UserAchievementResource>() {
    public UserAchievementResource createFromParcel(Parcel in) {
      return new UserAchievementResource(in);
    }
    public UserAchievementResource[] newArray(int size) {
      return new UserAchievementResource[size];
    }
  };
}
