...
public class Cart implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(availableShippingOptions);

    out.writeValue(countryTax);

    out.writeValue(coupons);

    out.writeValue(created);

    out.writeValue(currencyCode);

    out.writeValue(discountTotal);

    out.writeValue(errorCode);

    out.writeValue(errorMessage);
    ...
    out.writeValue(selectedShippingOptions);

    out.writeValue(shippable);

    out.writeValue(shippingAddress);

    out.writeValue(shippingCost);
  ...
  Cart(Parcel in) {
    ...
    availableShippingOptions = (List<CartShippingOption>)in.readValue(CartShippingOption.class.getClassLoader());
    countryTax = (Double)in.readValue(null);
    coupons = (List<CouponDefinition>)in.readValue(CouponDefinition.class.getClassLoader());
    created = (Long)in.readValue(null);
    currencyCode = (String)in.readValue(null);
    discountTotal = (Double)in.readValue(null);
    errorCode = (Integer)in.readValue(null);
    errorMessage = (String)in.readValue(null);
    grandTotal = (Double)in.readValue(null);
    id = (String)in.readValue(null);
    invoiceId = (Double)in.readValue(null);
    items = (List<CartLineItem>)in.readValue(CartLineItem.class.getClassLoader());
    owner = (Integer)in.readValue(null);
    selectedShippingOptions = (List<CartShippingOption>)in.readValue(CartShippingOption.class.getClassLoader());
    shippable = (Boolean)in.readValue(null);
    shippingAddress = (CartShippingAddressRequest)in.readValue(null);
    shippingCost = (Double)in.readValue(null);
    stateTax = (Double)in.readValue(null);
    status = (StatusEnum)in.readValue(null);
    subtotal = (Double)in.readValue(null);
    updated = (Long)in.readValue(null);
  }
