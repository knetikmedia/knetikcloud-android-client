...
public class UserActivityResultsResource implements Parcelable {
  ...
  **/
  ...
  public UserActivityResultsResource() {
    super();
  }

  UserActivityResultsResource(Parcel in) {
  ...
  public static final Parcelable.Creator<UserActivityResultsResource> CREATOR = new Parcelable.Creator<UserActivityResultsResource>() {
    public UserActivityResultsResource createFromParcel(Parcel in) {
      return new UserActivityResultsResource(in);
    }
    public UserActivityResultsResource[] newArray(int size) {
      return new UserActivityResultsResource[size];
    }
  };
}
