...
public class CreateBillingAgreementRequest implements Parcelable {
  ...
  **/
  ...
  CreateBillingAgreementRequest(Parcel in) {
  ...
  public static final Parcelable.Creator<CreateBillingAgreementRequest> CREATOR = new Parcelable.Creator<CreateBillingAgreementRequest>() {
    public CreateBillingAgreementRequest createFromParcel(Parcel in) {
      return new CreateBillingAgreementRequest(in);
    }
    public CreateBillingAgreementRequest[] newArray(int size) {
      return new CreateBillingAgreementRequest[size];
    }
  };
}
