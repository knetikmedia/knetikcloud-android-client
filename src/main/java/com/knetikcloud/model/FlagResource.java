...
public class FlagResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<FlagResource> CREATOR = new Parcelable.Creator<FlagResource>() {
    public FlagResource createFromParcel(Parcel in) {
      return new FlagResource(in);
    }
    public FlagResource[] newArray(int size) {
      return new FlagResource[size];
    }
  };
}
