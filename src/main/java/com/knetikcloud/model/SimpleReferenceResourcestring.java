...
public class SimpleReferenceResourcestring {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? simpleReferenceResourcestring.id == null : this.id.equals(simpleReferenceResourcestring.id)) &&
        (this.name == null ? simpleReferenceResourcestring.name == null : this.name.equals(simpleReferenceResourcestring.name));
  }
