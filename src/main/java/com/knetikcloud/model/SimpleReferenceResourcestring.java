...
public class SimpleReferenceResourcestring implements Parcelable {
  @SerializedName("id")
  ...
  **/
  ...
  public SimpleReferenceResourcestring() {
    super();
  }

  SimpleReferenceResourcestring(Parcel in) {
  ...
  public static final Parcelable.Creator<SimpleReferenceResourcestring> CREATOR = new Parcelable.Creator<SimpleReferenceResourcestring>() {
    public SimpleReferenceResourcestring createFromParcel(Parcel in) {
      return new SimpleReferenceResourcestring(in);
    }
    public SimpleReferenceResourcestring[] newArray(int size) {
      return new SimpleReferenceResourcestring[size];
    }
  };
}
