...
public class BreRule implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(conditionText);

    out.writeValue(description);

    out.writeValue(enabled);
  ...
  BreRule(Parcel in) {
    ...
    actions = (ActionResource)in.readValue(null);
    condition = (PredicateOperation)in.readValue(null);
    conditionText = (String)in.readValue(null);
    ...
    systemRule = (Boolean)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<BreRule> CREATOR = new Parcelable.Creator<BreRule>() {
    public BreRule createFromParcel(Parcel in) {
      return new BreRule(in);
    }
    public BreRule[] newArray(int size) {
      return new BreRule[size];
    }
  };
}
