...
public class PageResourceOauthAccessTokenResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceOauthAccessTokenResource() {
    super();
  }

  PageResourceOauthAccessTokenResource(Parcel in) {
    
    content = (List<OauthAccessTokenResource>)in.readValue(OauthAccessTokenResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceOauthAccessTokenResource> CREATOR = new Parcelable.Creator<PageResourceOauthAccessTokenResource>() {
    public PageResourceOauthAccessTokenResource createFromParcel(Parcel in) {
      return new PageResourceOauthAccessTokenResource(in);
    }
    public PageResourceOauthAccessTokenResource[] newArray(int size) {
      return new PageResourceOauthAccessTokenResource[size];
    }
  };
}
