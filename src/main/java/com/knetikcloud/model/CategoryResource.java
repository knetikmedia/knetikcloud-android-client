...
public class CategoryResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<CategoryResource> CREATOR = new Parcelable.Creator<CategoryResource>() {
    public CategoryResource createFromParcel(Parcel in) {
      return new CategoryResource(in);
    }
