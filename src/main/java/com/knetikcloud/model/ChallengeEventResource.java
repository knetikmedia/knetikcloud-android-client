...
public class ChallengeEventResource implements Parcelable {
  ...
  **/
  ...
  public ChallengeEventResource() {
    super();
  }

  ChallengeEventResource(Parcel in) {
  ...
  public static final Parcelable.Creator<ChallengeEventResource> CREATOR = new Parcelable.Creator<ChallengeEventResource>() {
    public ChallengeEventResource createFromParcel(Parcel in) {
      return new ChallengeEventResource(in);
    }
    public ChallengeEventResource[] newArray(int size) {
      return new ChallengeEventResource[size];
    }
  };
}
