...
public class StoreItem extends Item implements Parcelable {
  ...
  **/
  ...
  StoreItem(Parcel in) {
     super(in); 
    displayable = (Boolean)in.readValue(null);
    geoCountryList = (List<String>)in.readValue(null);
    geoPolicyType = (GeoPolicyTypeEnum)in.readValue(null);
    shippingTier = (Integer)in.readValue(null);
    skus = (List<Sku>)in.readValue(Sku.class.getClassLoader());
