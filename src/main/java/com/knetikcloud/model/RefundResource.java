...
public class RefundResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(refundTransactionId);
  ...
  RefundResource(Parcel in) {
    
    amount = (Double)in.readValue(null);
    refundTransactionId = (Integer)in.readValue(null);
    transactionId = (Integer)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<RefundResource> CREATOR = new Parcelable.Creator<RefundResource>() {
    public RefundResource createFromParcel(Parcel in) {
      return new RefundResource(in);
    }
    public RefundResource[] newArray(int size) {
      return new RefundResource[size];
    }
  };
}
