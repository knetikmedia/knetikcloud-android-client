...
public class FinalizeBillingAgreementRequest implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(newDefault);

    out.writeValue(payerId);
  ...
  public FinalizeBillingAgreementRequest() {
    super();
  }

  FinalizeBillingAgreementRequest(Parcel in) {
    
    invoiceId = (Integer)in.readValue(null);
    newDefault = (Boolean)in.readValue(null);
    payerId = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<FinalizeBillingAgreementRequest> CREATOR = new Parcelable.Creator<FinalizeBillingAgreementRequest>() {
    public FinalizeBillingAgreementRequest createFromParcel(Parcel in) {
      return new FinalizeBillingAgreementRequest(in);
    }
    public FinalizeBillingAgreementRequest[] newArray(int size) {
      return new FinalizeBillingAgreementRequest[size];
    }
  };
}
