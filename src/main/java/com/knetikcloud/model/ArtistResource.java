...
public class ArtistResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(contributionCount);

    out.writeValue(contributions);
  ...
  ArtistResource(Parcel in) {
    
    additionalProperties = (Map<String, Property>)in.readValue(Property.class.getClassLoader());
    born = (String)in.readValue(null);
    contributionCount = (Integer)in.readValue(null);
    contributions = (List<ContributionResource>)in.readValue(ContributionResource.class.getClassLoader());
    createdDate = (Long)in.readValue(null);
    died = (String)in.readValue(null);
  ...
  public static final Parcelable.Creator<ArtistResource> CREATOR = new Parcelable.Creator<ArtistResource>() {
    public ArtistResource createFromParcel(Parcel in) {
      return new ArtistResource(in);
    }
    public ArtistResource[] newArray(int size) {
      return new ArtistResource[size];
    }
  };
}
