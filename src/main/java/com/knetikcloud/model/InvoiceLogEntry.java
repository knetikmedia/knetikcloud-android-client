...
public class InvoiceLogEntry implements Parcelable {
  @SerializedName("date")
  ...
  **/
  ...
  public InvoiceLogEntry() {
    super();
  }

  InvoiceLogEntry(Parcel in) {
  ...
  public static final Parcelable.Creator<InvoiceLogEntry> CREATOR = new Parcelable.Creator<InvoiceLogEntry>() {
    public InvoiceLogEntry createFromParcel(Parcel in) {
      return new InvoiceLogEntry(in);
    }
    public InvoiceLogEntry[] newArray(int size) {
      return new InvoiceLogEntry[size];
    }
  };
}
