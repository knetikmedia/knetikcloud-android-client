...
public class PageResourceAggregateInvoiceReportResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceAggregateInvoiceReportResource() {
    super();
  }

  PageResourceAggregateInvoiceReportResource(Parcel in) {
    
    content = (List<AggregateInvoiceReportResource>)in.readValue(AggregateInvoiceReportResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceAggregateInvoiceReportResource> CREATOR = new Parcelable.Creator<PageResourceAggregateInvoiceReportResource>() {
    public PageResourceAggregateInvoiceReportResource createFromParcel(Parcel in) {
      return new PageResourceAggregateInvoiceReportResource(in);
    }
    public PageResourceAggregateInvoiceReportResource[] newArray(int size) {
      return new PageResourceAggregateInvoiceReportResource[size];
    }
  };
}
