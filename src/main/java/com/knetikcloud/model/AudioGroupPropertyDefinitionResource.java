...
public class AudioGroupPropertyDefinitionResource extends FileGroupPropertyDefinitionResource implements Parcelable {
  ...
  **/
  ...
  public AudioGroupPropertyDefinitionResource() {
    super();
  }

  AudioGroupPropertyDefinitionResource(Parcel in) {
     super(in); 
  ...
  public static final Parcelable.Creator<AudioGroupPropertyDefinitionResource> CREATOR = new Parcelable.Creator<AudioGroupPropertyDefinitionResource>() {
    public AudioGroupPropertyDefinitionResource createFromParcel(Parcel in) {
      return new AudioGroupPropertyDefinitionResource(in);
    }
    public AudioGroupPropertyDefinitionResource[] newArray(int size) {
      return new AudioGroupPropertyDefinitionResource[size];
    }
  };
}
