...
public class PageResourceUserLevelingResource implements Parcelable {
  ...
  **/
  ...
  PageResourceUserLevelingResource(Parcel in) {
    
    content = (List<UserLevelingResource>)in.readValue(UserLevelingResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceUserLevelingResource> CREATOR = new Parcelable.Creator<PageResourceUserLevelingResource>() {
    public PageResourceUserLevelingResource createFromParcel(Parcel in) {
      return new PageResourceUserLevelingResource(in);
    }
    public PageResourceUserLevelingResource[] newArray(int size) {
      return new PageResourceUserLevelingResource[size];
    }
  };
}
