...
public class StripeCreatePaymentMethod implements Parcelable {
  ...
  **/
  ...
  public StripeCreatePaymentMethod() {
    super();
  }

  StripeCreatePaymentMethod(Parcel in) {
  ...
  public static final Parcelable.Creator<StripeCreatePaymentMethod> CREATOR = new Parcelable.Creator<StripeCreatePaymentMethod>() {
    public StripeCreatePaymentMethod createFromParcel(Parcel in) {
      return new StripeCreatePaymentMethod(in);
    }
    public StripeCreatePaymentMethod[] newArray(int size) {
      return new StripeCreatePaymentMethod[size];
    }
  };
}
