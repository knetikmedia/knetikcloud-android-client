...
public class BreGlobalScopeDefinition implements Parcelable {
  @SerializedName("name")
  ...
  **/
  ...
  public BreGlobalScopeDefinition() {
    super();
  }

  BreGlobalScopeDefinition(Parcel in) {
  ...
  public static final Parcelable.Creator<BreGlobalScopeDefinition> CREATOR = new Parcelable.Creator<BreGlobalScopeDefinition>() {
    public BreGlobalScopeDefinition createFromParcel(Parcel in) {
      return new BreGlobalScopeDefinition(in);
    }
    public BreGlobalScopeDefinition[] newArray(int size) {
      return new BreGlobalScopeDefinition[size];
    }
  };
}
