...
public class Fulfillable extends Behavior implements Parcelable {
  ...
  **/
  ...
  Fulfillable(Parcel in) {
     super(in); 
    typeName = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<Fulfillable> CREATOR = new Parcelable.Creator<Fulfillable>() {
    public Fulfillable createFromParcel(Parcel in) {
      return new Fulfillable(in);
    }
    public Fulfillable[] newArray(int size) {
      return new Fulfillable[size];
    }
  };
}
