...
public class BreGlobalResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(systemGlobal);

    out.writeValue(type);
  }

  public BreGlobalResource() {
    super();
  }

  BreGlobalResource(Parcel in) {
    
    description = (String)in.readValue(null);
    id = (String)in.readValue(null);
    key = (String)in.readValue(null);
    name = (String)in.readValue(null);
    scopes = (List<BreGlobalScopeDefinition>)in.readValue(BreGlobalScopeDefinition.class.getClassLoader());
    systemGlobal = (Boolean)in.readValue(null);
  ...
  public static final Parcelable.Creator<BreGlobalResource> CREATOR = new Parcelable.Creator<BreGlobalResource>() {
    public BreGlobalResource createFromParcel(Parcel in) {
      return new BreGlobalResource(in);
    }
    public BreGlobalResource[] newArray(int size) {
      return new BreGlobalResource[size];
    }
  };
}
