...
public class UserActivityResults {
  ...
  public boolean equals(Object o) {
    ...
    return (this.currencyRewards == null ? userActivityResults.currencyRewards == null : this.currencyRewards.equals(userActivityResults.currencyRewards)) &&
        (this.itemRewards == null ? userActivityResults.itemRewards == null : this.itemRewards.equals(userActivityResults.itemRewards)) &&
        (this.rank == null ? userActivityResults.rank == null : this.rank.equals(userActivityResults.rank)) &&
        (this.score == null ? userActivityResults.score == null : this.score.equals(userActivityResults.score)) &&
        (this.tags == null ? userActivityResults.tags == null : this.tags.equals(userActivityResults.tags)) &&
        (this.ties == null ? userActivityResults.ties == null : this.ties.equals(userActivityResults.ties)) &&
        (this.updatedDate == null ? userActivityResults.updatedDate == null : this.updatedDate.equals(userActivityResults.updatedDate)) &&
        (this.user == null ? userActivityResults.user == null : this.user.equals(userActivityResults.user));
  }
