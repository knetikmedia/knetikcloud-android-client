...
public class ItemTemplateResource implements Parcelable {
  ...
  **/
  ...
  ItemTemplateResource(Parcel in) {
  ...
  public static final Parcelable.Creator<ItemTemplateResource> CREATOR = new Parcelable.Creator<ItemTemplateResource>() {
    public ItemTemplateResource createFromParcel(Parcel in) {
      return new ItemTemplateResource(in);
    }
    public ItemTemplateResource[] newArray(int size) {
      return new ItemTemplateResource[size];
    }
  };
}
