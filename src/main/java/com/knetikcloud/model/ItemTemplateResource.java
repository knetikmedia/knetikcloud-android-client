...
public class ItemTemplateResource {
  ...
  public boolean equals(Object o) {
    ...
    return (this.behaviors == null ? itemTemplateResource.behaviors == null : this.behaviors.equals(itemTemplateResource.behaviors)) &&
        (this.createdDate == null ? itemTemplateResource.createdDate == null : this.createdDate.equals(itemTemplateResource.createdDate)) &&
        (this.id == null ? itemTemplateResource.id == null : this.id.equals(itemTemplateResource.id)) &&
        (this.name == null ? itemTemplateResource.name == null : this.name.equals(itemTemplateResource.name)) &&
        (this.properties == null ? itemTemplateResource.properties == null : this.properties.equals(itemTemplateResource.properties)) &&
        (this.updatedDate == null ? itemTemplateResource.updatedDate == null : this.updatedDate.equals(itemTemplateResource.updatedDate));
  }
