...
public class TransactionResource implements Parcelable {
  ...
  **/
  ...
  public static final Parcelable.Creator<TransactionResource> CREATOR = new Parcelable.Creator<TransactionResource>() {
    public TransactionResource createFromParcel(Parcel in) {
      return new TransactionResource(in);
    }
    public TransactionResource[] newArray(int size) {
      return new TransactionResource[size];
    }
  };
}
