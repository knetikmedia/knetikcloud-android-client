...
public class PageResourceWalletTransactionResource implements Parcelable {
  ...
  **/
  ...
  public PageResourceWalletTransactionResource() {
    super();
  }

  PageResourceWalletTransactionResource(Parcel in) {
    
    content = (List<WalletTransactionResource>)in.readValue(WalletTransactionResource.class.getClassLoader());
  ...
  public static final Parcelable.Creator<PageResourceWalletTransactionResource> CREATOR = new Parcelable.Creator<PageResourceWalletTransactionResource>() {
    public PageResourceWalletTransactionResource createFromParcel(Parcel in) {
      return new PageResourceWalletTransactionResource(in);
    }
    public PageResourceWalletTransactionResource[] newArray(int size) {
      return new PageResourceWalletTransactionResource[size];
    }
  };
}
