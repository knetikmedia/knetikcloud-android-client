...
public class QuestionResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(importId);

    out.writeValue(publishedDate);

    out.writeValue(question);

    out.writeValue(source1);

    out.writeValue(source2);
  ...
  QuestionResource(Parcel in) {
    
    additionalProperties = (Map<String, Property>)in.readValue(Property.class.getClassLoader());
    answers = (List<AnswerResource>)in.readValue(AnswerResource.class.getClassLoader());
    category = (NestedCategory)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    difficulty = (Integer)in.readValue(null);
    id = (String)in.readValue(null);
    importId = (Long)in.readValue(null);
    publishedDate = (Long)in.readValue(null);
    question = (Property)in.readValue(null);
    source1 = (String)in.readValue(null);
    source2 = (String)in.readValue(null);
    tags = (List<String>)in.readValue(null);
    template = (String)in.readValue(null);
    updatedDate = (Long)in.readValue(null);
    vendor = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<QuestionResource> CREATOR = new Parcelable.Creator<QuestionResource>() {
    public QuestionResource createFromParcel(Parcel in) {
      return new QuestionResource(in);
    }
    public QuestionResource[] newArray(int size) {
      return new QuestionResource[size];
    }
  };
}
