...
public class FormattedTextPropertyDefinitionResource extends PropertyDefinitionResource implements Parcelable {
   ...
   * @return maxLength
  **/
  @ApiModelProperty(example = "null", value = "If provided, the maximum length of the text")
  ...
  public FormattedTextPropertyDefinitionResource() {
    super();
  }

  FormattedTextPropertyDefinitionResource(Parcel in) {
     super(in); 
  ...
  public static final Parcelable.Creator<FormattedTextPropertyDefinitionResource> CREATOR = new Parcelable.Creator<FormattedTextPropertyDefinitionResource>() {
    public FormattedTextPropertyDefinitionResource createFromParcel(Parcel in) {
      return new FormattedTextPropertyDefinitionResource(in);
    }
    public FormattedTextPropertyDefinitionResource[] newArray(int size) {
      return new FormattedTextPropertyDefinitionResource[size];
    }
  };
}
