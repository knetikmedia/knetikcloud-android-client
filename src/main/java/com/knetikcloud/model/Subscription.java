...
public class Subscription extends StoreItem implements Parcelable {
  /**
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(subscriptionPlans);
  }
  ...
  Subscription(Parcel in) {
    ...
    subscriptionPlans = (List<SubscriptionPlan>)in.readValue(SubscriptionPlan.class.getClassLoader());
  }
