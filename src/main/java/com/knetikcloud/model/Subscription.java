...
public class Subscription extends StoreItem {
  ...
  public boolean equals(Object o) {
    ...
    return (this.additionalProperties == null ? subscription.additionalProperties == null : this.additionalProperties.equals(subscription.additionalProperties)) &&
        (this.behaviors == null ? subscription.behaviors == null : this.behaviors.equals(subscription.behaviors)) &&
        (this.category == null ? subscription.category == null : this.category.equals(subscription.category)) &&
        (this.createdDate == null ? subscription.createdDate == null : this.createdDate.equals(subscription.createdDate)) &&
        (this.id == null ? subscription.id == null : this.id.equals(subscription.id)) &&
        (this.longDescription == null ? subscription.longDescription == null : this.longDescription.equals(subscription.longDescription)) &&
        (this.name == null ? subscription.name == null : this.name.equals(subscription.name)) &&
        (this.shortDescription == null ? subscription.shortDescription == null : this.shortDescription.equals(subscription.shortDescription)) &&
        (this.sort == null ? subscription.sort == null : this.sort.equals(subscription.sort)) &&
        (this.tags == null ? subscription.tags == null : this.tags.equals(subscription.tags)) &&
        (this.template == null ? subscription.template == null : this.template.equals(subscription.template)) &&
        (this.typeHint == null ? subscription.typeHint == null : this.typeHint.equals(subscription.typeHint)) &&
        (this.uniqueKey == null ? subscription.uniqueKey == null : this.uniqueKey.equals(subscription.uniqueKey)) &&
        (this.updatedDate == null ? subscription.updatedDate == null : this.updatedDate.equals(subscription.updatedDate)) &&
        (this.displayable == null ? subscription.displayable == null : this.displayable.equals(subscription.displayable)) &&
        (this.geoCountryList == null ? subscription.geoCountryList == null : this.geoCountryList.equals(subscription.geoCountryList)) &&
        (this.geoPolicyType == null ? subscription.geoPolicyType == null : this.geoPolicyType.equals(subscription.geoPolicyType)) &&
        (this.shippingTier == null ? subscription.shippingTier == null : this.shippingTier.equals(subscription.shippingTier)) &&
        (this.skus == null ? subscription.skus == null : this.skus.equals(subscription.skus)) &&
        (this.storeEnd == null ? subscription.storeEnd == null : this.storeEnd.equals(subscription.storeEnd)) &&
        (this.storeStart == null ? subscription.storeStart == null : this.storeStart.equals(subscription.storeStart)) &&
        (this.vendorId == null ? subscription.vendorId == null : this.vendorId.equals(subscription.vendorId)) &&
        (this.availability == null ? subscription.availability == null : this.availability.equals(subscription.availability)) &&
        (this.consolidationDayOfMonth == null ? subscription.consolidationDayOfMonth == null : this.consolidationDayOfMonth.equals(subscription.consolidationDayOfMonth)) &&
        (this.subscriptionPlans == null ? subscription.subscriptionPlans == null : this.subscriptionPlans.equals(subscription.subscriptionPlans));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.subscriptionPlans == null ? 0: this.subscriptionPlans.hashCode());
    return result;
  }
