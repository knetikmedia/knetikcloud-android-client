...
public class InvoiceResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(billingAddress1);

    out.writeValue(billingAddress2);

    out.writeValue(billingCityName);

    out.writeValue(billingCountryName);

    out.writeValue(billingFullName);

    out.writeValue(billingPostalCode);

    out.writeValue(billingStateName);

    out.writeValue(cartId);

    out.writeValue(createdDate);

    out.writeValue(currency);

    out.writeValue(currentFulfillmentStatus);

    out.writeValue(currentPaymentStatus);

    out.writeValue(discount);

    out.writeValue(email);

    out.writeValue(externalRef);

    out.writeValue(fedTax);

    out.writeValue(grandTotal);

    out.writeValue(id);

    out.writeValue(invoiceNumber);

    out.writeValue(items);

    out.writeValue(namePrefix);

    out.writeValue(orderNotes);

    out.writeValue(parentInvoiceId);

    out.writeValue(paymentMethodId);
    ...
    out.writeValue(shippingAddress1);

    out.writeValue(shippingAddress2);

    out.writeValue(shippingCityName);

    out.writeValue(shippingCountryName);

    out.writeValue(shippingFullName);

    out.writeValue(shippingPostalCode);

    out.writeValue(shippingStateName);

    out.writeValue(sort);

    out.writeValue(stateTax);

    out.writeValue(subtotal);

    out.writeValue(updatedDate);

    out.writeValue(user);

    out.writeValue(vendorId);

    out.writeValue(vendorName);
  }
  ...
  InvoiceResource(Parcel in) {
    
    billingAddress1 = (String)in.readValue(null);
    billingAddress2 = (String)in.readValue(null);
    billingCityName = (String)in.readValue(null);
    billingCountryName = (String)in.readValue(null);
    billingFullName = (String)in.readValue(null);
    billingPostalCode = (String)in.readValue(null);
    billingStateName = (String)in.readValue(null);
    cartId = (String)in.readValue(null);
    createdDate = (Long)in.readValue(null);
    currency = (String)in.readValue(null);
    currentFulfillmentStatus = (String)in.readValue(null);
    currentPaymentStatus = (String)in.readValue(null);
    discount = (Double)in.readValue(null);
    email = (String)in.readValue(null);
    externalRef = (String)in.readValue(null);
    fedTax = (Double)in.readValue(null);
    grandTotal = (Double)in.readValue(null);
    id = (Integer)in.readValue(null);
    invoiceNumber = (String)in.readValue(null);
    items = (List<InvoiceItemResource>)in.readValue(InvoiceItemResource.class.getClassLoader());
    namePrefix = (String)in.readValue(null);
    orderNotes = (String)in.readValue(null);
    parentInvoiceId = (Integer)in.readValue(null);
    paymentMethodId = (Integer)in.readValue(null);
    phone = (String)in.readValue(null);
    phoneNumber = (String)in.readValue(null);
    shipping = (Double)in.readValue(null);
    shippingAddress1 = (String)in.readValue(null);
    shippingAddress2 = (String)in.readValue(null);
    shippingCityName = (String)in.readValue(null);
    shippingCountryName = (String)in.readValue(null);
    shippingFullName = (String)in.readValue(null);
    shippingPostalCode = (String)in.readValue(null);
    shippingStateName = (String)in.readValue(null);
    sort = (Integer)in.readValue(null);
    stateTax = (Double)in.readValue(null);
    subtotal = (Double)in.readValue(null);
    updatedDate = (Long)in.readValue(null);
    user = (SimpleUserResource)in.readValue(null);
    vendorId = (Integer)in.readValue(null);
    vendorName = (String)in.readValue(null);
  }
  ...
  public static final Parcelable.Creator<InvoiceResource> CREATOR = new Parcelable.Creator<InvoiceResource>() {
    public InvoiceResource createFromParcel(Parcel in) {
      return new InvoiceResource(in);
    }
    public InvoiceResource[] newArray(int size) {
      return new InvoiceResource[size];
    }
  };
}
