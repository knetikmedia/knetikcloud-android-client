...
public class UserLevelingResource implements Parcelable {
  ...
  **/
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(lastTierName);

    out.writeValue(lastTierProgress);

    out.writeValue(levelName);

    out.writeValue(nextTierName);

    out.writeValue(nextTierProgress);

    out.writeValue(progress);

    out.writeValue(tierNames);

    out.writeValue(userId);
  }

  public UserLevelingResource() {
    super();
  }

  UserLevelingResource(Parcel in) {
    
    lastTierName = (String)in.readValue(null);
    lastTierProgress = (Integer)in.readValue(null);
    levelName = (String)in.readValue(null);
    nextTierName = (String)in.readValue(null);
    nextTierProgress = (Integer)in.readValue(null);
    progress = (Integer)in.readValue(null);
    tierNames = (List<String>)in.readValue(null);
  ...
  public static final Parcelable.Creator<UserLevelingResource> CREATOR = new Parcelable.Creator<UserLevelingResource>() {
    public UserLevelingResource createFromParcel(Parcel in) {
      return new UserLevelingResource(in);
    }
    public UserLevelingResource[] newArray(int size) {
      return new UserLevelingResource[size];
    }
  };
}
