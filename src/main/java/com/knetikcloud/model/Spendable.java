...
public class Spendable extends Behavior implements Parcelable {
   ...
   * @return currencyCode
  **/
  @ApiModelProperty(example = "null", value = "The code of the currency")
   ...
   * @return value
  **/
  @ApiModelProperty(example = "null", value = "The spendable value")
  ...
  public static final Parcelable.Creator<Spendable> CREATOR = new Parcelable.Creator<Spendable>() {
    public Spendable createFromParcel(Parcel in) {
      return new Spendable(in);
    }
    public Spendable[] newArray(int size) {
      return new Spendable[size];
    }
  };
}
