...
> PageResourceUserAchievementGroupResource getUserAchievementsProgress(userId, filterAchievementDerived, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page)
...
Integer page = 1; // Integer | The number of the page returned, starting with 1
try {
    PageResourceUserAchievementGroupResource result = apiInstance.getUserAchievementsProgress(userId, filterAchievementDerived, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page);
    System.out.println(result);
} catch (ApiException e) {
...
> PageResourceUserAchievementGroupResource getUsersAchievementProgress(achievementName, filterAchievementDerived, filterAchievementTagset, filterAchievementHidden, size, page)
...
Integer page = 1; // Integer | The number of the page returned, starting with 1
try {
    PageResourceUserAchievementGroupResource result = apiInstance.getUsersAchievementProgress(achievementName, filterAchievementDerived, filterAchievementTagset, filterAchievementHidden, size, page);
    System.out.println(result);
} catch (ApiException e) {
...
> PageResourceUserAchievementGroupResource getUsersAchievementsProgress(filterAchievementDerived, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page)
...
Integer page = 1; // Integer | The number of the page returned, starting with 1
try {
    PageResourceUserAchievementGroupResource result = apiInstance.getUsersAchievementsProgress(filterAchievementDerived, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page);
    System.out.println(result);
} catch (ApiException e) {
...
# **updateAchievement**
> updateAchievement(name, achievement)
...
AchievementDefinitionResource achievement = new AchievementDefinitionResource(); // AchievementDefinitionResource | The achievement definition
try {
    apiInstance.updateAchievement(name, achievement);
} catch (ApiException e) {
...
> updateAchievementTemplate(id, template)
...
try {
    apiInstance.updateAchievementTemplate(id, template);
} catch (ApiException e) {
