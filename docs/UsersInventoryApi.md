...
> PageItemTemplateResource getEntitlementTemplatesUsingGET(size, page, order)
...
> PageUserInventoryResource getInventoryListUsingGET(inactive, size, page, filterItemName, filterUsername, filterGroup, filterDate)
