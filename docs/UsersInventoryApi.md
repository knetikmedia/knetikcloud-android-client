...
try {
    EntitlementItem result = apiInstance.createEntitlementItem(entitlementItem);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="getUserInventory1"></a>
# **getUserInventory1**
> PageResourceUserInventoryResource getUserInventory1(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate)
...
try {
    PageResourceUserInventoryResource result = apiInstance.getUserInventory1(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling UsersInventoryApi#getUserInventory1");
    e.printStackTrace();
}
```
...
try {
    apiInstance.getUserInventoryLog1(userId, id, timestamp);
} catch (ApiException e) {
    System.err.println("Exception when calling UsersInventoryApi#getUserInventoryLog1");
    e.printStackTrace();
}
```
...
try {
    PageResourceUserInventoryResource result = apiInstance.getUsersInventory(inactive, size, page, filterItemName, filterUsername, filterGroup, filterDate);
    System.out.println(result);
} catch (ApiException e) {
...
EntitlementItem entitlementItem = new EntitlementItem(); // EntitlementItem | The entitlement item object
try {
    apiInstance.updateEntitlementItem(entitlementId, entitlementItem);
} catch (ApiException e) {
...
try {
    apiInstance.updateEntitlementTemplate(id, template);
} catch (ApiException e) {
