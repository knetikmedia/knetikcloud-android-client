...
# **getUsingGET2**
> PageResourceStoreItem getUsingGET2(limit, page, useCatalog, ignoreLocation, inStockOnly)
...
try {
    PageResourceStoreItem result = apiInstance.getUsingGET2(limit, page, useCatalog, ignoreLocation, inStockOnly);
    System.out.println(result);
} catch (ApiException e) {
