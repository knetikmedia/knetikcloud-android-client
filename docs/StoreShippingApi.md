...
# **createShippingItem**
> ShippingItem createShippingItem(shippingItem)
...
try {
    ShippingItem result = apiInstance.createShippingItem(shippingItem);
...
# **updateShippingItem**
> updateShippingItem(id, shippingItem)
...
ShippingItem shippingItem = new ShippingItem(); // ShippingItem | The shipping item object
try {
    apiInstance.updateShippingItem(id, shippingItem);
} catch (ApiException e) {
...
> updateShippingTemplate(id, shippingTemplateResource)
...
try {
    apiInstance.updateShippingTemplate(id, shippingTemplateResource);
} catch (ApiException e) {
