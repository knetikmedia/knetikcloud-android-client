...
# **updateArticle**
> updateArticle(id, articleResource)
...
try {
    apiInstance.updateArticle(id, articleResource);
} catch (ApiException e) {
...
> updateArticleTemplate(id, articleTemplateResource)
...
TemplateResource articleTemplateResource = new TemplateResource(); // TemplateResource | The article template resource object
try {
    apiInstance.updateArticleTemplate(id, articleTemplateResource);
} catch (ApiException e) {
