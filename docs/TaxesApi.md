...
try {
    PageStateTaxResource result = apiInstance.getAllTaxesUsingGET(size, page, order);
...
String order = "name:ASC"; // String | A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
try {
    PageCountryTaxResource result = apiInstance.getTaxesUsingGET(size, page, order);
    System.out.println(result);
} catch (ApiException e) {
...
String order = "name:ASC"; // String | A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
try {
    PageStateTaxResource result = apiInstance.getTaxesUsingGET1(countryCodeIso3, size, page, order);
    System.out.println(result);
} catch (ApiException e) {
