...
# **createStateTax**
> createStateTax(countryCodeIso3, taxResource)
...
# **updateCountryTax**
> updateCountryTax(countryCodeIso3, taxResource)
...
# **updateStateTax**
> updateStateTax(countryCodeIso3, stateCode, taxResource)
