...
# **createBundleItem**
> BundleItem createBundleItem(bundleItem)
...
try {
    BundleItem result = apiInstance.createBundleItem(bundleItem);
...
# **updateBundleItem**
> updateBundleItem(id, bundleItem)
...
BundleItem bundleItem = new BundleItem(); // BundleItem | The bundle item object
try {
    apiInstance.updateBundleItem(id, bundleItem);
} catch (ApiException e) {
...
> updateBundleTemplate(id, bundleTemplateResource)
...
try {
    apiInstance.updateBundleTemplate(id, bundleTemplateResource);
} catch (ApiException e) {
