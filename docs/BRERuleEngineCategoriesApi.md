...
> PageResourceBreCategoryResource getCategoriesUsingGET(size, page)
...
try {
    PageResourceBreCategoryResource result = apiInstance.getCategoriesUsingGET(size, page);
    System.out.println(result);
} catch (ApiException e) {
...
> PageResourceTemplateResource getTemplatesUsingGET(size, page, order)
...
try {
    PageResourceTemplateResource result = apiInstance.getTemplatesUsingGET(size, page, order);
    System.out.println(result);
} catch (ApiException e) {
