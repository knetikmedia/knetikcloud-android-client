...
ModelObject filterVendorIds = new ModelObject(); // ModelObject | Filters invoices for ones from one of the vendors whose id is in the given comma separated list
 ...
 **filterVendorIds** | [**ModelObject**](.md)| Filters invoices for ones from one of the vendors whose id is in the given comma separated list | [optional]
