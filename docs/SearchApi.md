...
> externalAddUsingPOST(type, id, _object)
...
# **searchUsingPOST**
> PageMapstringobject searchUsingPOST(type, query, size, page)
...
try {
    PageMapstringobject result = apiInstance.searchUsingPOST(type, query, size, page);
