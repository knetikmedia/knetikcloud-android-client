...
try {
    CouponItem result = apiInstance.createCouponItem(couponItem);
...
CouponItem couponItem = new CouponItem(); // CouponItem | The coupon item object
try {
    apiInstance.updateCouponItem(id, couponItem);
} catch (ApiException e) {
...
try {
    apiInstance.updateCouponTemplate(id, couponTemplateResource);
} catch (ApiException e) {
